    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Modules\Production\Services\ProductionFgQuantityPolicyService' => \Modules\Production\Services\ProductionFgQuantityPolicyService::class,
            'Modules\Production\Services\ProductionOrderMaterialReservationService' => \Modules\Production\Services\ProductionOrderMaterialReservationService::class,
            'Modules\Production\Services\ProductionPostingService' => \Modules\Production\Services\ProductionPostingService::class,
            'Modules\Warehouse\Contracts\SalesReturnInboundGateInterface' => \Modules\Warehouse\Services\AllowAllSalesReturnInboundGate::class,
            'Modules\Warehouse\Services\CreditNoteWarehouseStockService' => \Modules\Warehouse\Services\CreditNoteWarehouseStockService::class,
            'Modules\Warehouse\Services\EnsureDefaultWarehouseService' => \Modules\Warehouse\Services\EnsureDefaultWarehouseService::class,
            'Modules\Warehouse\Services\InvoiceWarehouseStockService' => \Modules\Warehouse\Services\InvoiceWarehouseStockService::class,
            'Modules\Warehouse\Services\ProductSellableUnitsService' => \Modules\Warehouse\Services\ProductSellableUnitsService::class,
            'Modules\Warehouse\Services\ProductUnitConversionSyncService' => \Modules\Warehouse\Services\ProductUnitConversionSyncService::class,
            'Modules\Warehouse\Services\ProductUnitPriceResolver' => \Modules\Warehouse\Services\ProductUnitPriceResolver::class,
            'Modules\Warehouse\Services\ProductUnitQuantityHintService' => \Modules\Warehouse\Services\ProductUnitQuantityHintService::class,
            'Modules\Warehouse\Services\StockMovementService' => \Modules\Warehouse\Services\StockMovementService::class,
            'Modules\Warehouse\Services\StockReservationService' => \Modules\Warehouse\Services\StockReservationService::class,
            'Modules\Warehouse\Services\VendorCreditWarehouseStockService' => \Modules\Warehouse\Services\VendorCreditWarehouseStockService::class,
            'Modules\Warehouse\Services\WarehouseAvailabilityService' => \Modules\Warehouse\Services\WarehouseAvailabilityService::class,
            'Modules\Warehouse\Services\WarehouseFlowConfigService' => \Modules\Warehouse\Services\WarehouseFlowConfigService::class,
            'Modules\Warehouse\Services\WarehouseFlowPolicyService' => \Modules\Warehouse\Services\WarehouseFlowPolicyService::class,
            'Modules\Warehouse\Services\WarehouseQueryService' => \Modules\Warehouse\Services\WarehouseQueryService::class,
            'Modules\Warehouse\Services\WarehouseReconciliationService' => \Modules\Warehouse\Services\WarehouseReconciliationService::class,
            'Modules\Warehouse\Services\WarehouseUnitConversionService' => \Modules\Warehouse\Services\WarehouseUnitConversionService::class,
