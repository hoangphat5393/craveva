# Import khách hàng — lỗi thường gặp

**Sổ lỗi:** [SO_LOI.md](SO_LOI.md) (mã `IMPORT-CLIENT`)  
**Flow:** `FUNC_LOGIC/CLIENT_BUSINESS.md` · `FUNC_IMPROVE/IMPORT_CHUNK_BULK_QUEUE.md`
...
**Runbook quyền/worker:** `docs/SERVER_RUNBOOK.md`

---

## 5) Gợi ý “canonical” để tránh trùng lặp tài liệu

- Flow: `FUNC_LOGIC/CLIENT_BUSINESS.md` · runbook: `docs/SERVER_RUNBOOK.md`
