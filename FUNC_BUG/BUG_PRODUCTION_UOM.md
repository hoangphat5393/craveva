# Sản xuất — trừ kho nguyên liệu sai đơn vị tính

**Sổ lỗi:** [`SO_LOI.md`](SO_LOI.md) (mã `PROD-UOM-001`)
...
- Gap (living doc, Fixed): [`../FUNC_LOGIC/PRODUCTION_BUSINESS.md`](../FUNC_LOGIC/PRODUCTION_BUSINESS.md) §3
