# FUNC_BUG — Product import (chi tiết phân tích)

> Gộp `PRODUCT_IMPORT_CUSTOM_FIELDS_AND_SLOW_ANALYSIS.md` + `PRODUCT_IMPORT_1000_SLOW_CAUSES_AND_SOLUTIONS.md` (2026-05-12). **Hub:** `PRODUCT_IMPORT_MASTER.md`.
