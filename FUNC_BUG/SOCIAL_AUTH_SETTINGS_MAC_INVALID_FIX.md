# Social Auth Settings — `The MAC is invalid`

**Mã:** `AUTH-SOCIAL-001` · **Registry:** [`REGISTRY.md`](REGISTRY.md)
...
- Sau import DB staging: đồng bộ key — `scripts/download_staging_env.ps1 -SyncAppKey` (xem `backup/README.md`).
