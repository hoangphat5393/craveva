...
- Đối chiếu nhanh code hiện tại:
    ...
    - Đã có một phần: `SEC-06` (đã check permission trong `PricingTierController::changeStatus`, còn thiếu scope company chặt ở truy vấn tier).
    - Chưa hoàn tất: `SEC-02`, `SEC-03`, `SEC-04`, `SEC-05`, `LOG-01`, `LOG-02`, `LOG-04`, `LOG-05`, `LOG-06`, `LOG-07` và phần lớn PERF/REF.
- Kết luận: giữ file này trong `FUNC_IMPROVE` là đúng; không xóa.

Derived from: `FUNC_LOGIC/FLOW_Pricing_Module.md`  
...
| PERF-03 | Cache finds | Performance | Low |
