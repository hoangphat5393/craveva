...
| --------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **POST inbound (canonical)**                                    | `routes/api.php` → **`POST /api/integrations/orders`**                                 | [`docs/AI_ORDER_REST.md`](../docs/AI_ORDER_REST.md), [`AI_ORDER_REST_RUNBOOK.md`](../FUNC_LOGIC/AI_ORDER_REST_RUNBOOK.md) |
...
Biến môi trường liên quan inbound AI: [`../docs/WAREHOUSE_PURCHASE_ENV_REFERENCE.md`](../docs/WAREHOUSE_PURCHASE_ENV_REFERENCE.md). Legacy `POST /ai-order-webhook/{hash}` đã gỡ khỏi runtime; dùng REST docs canonical ở bảng trên.
...
- Runbook PM (curl, payload, response): [`../FUNC_LOGIC/AI_ORDER_REST_RUNBOOK.md`](../FUNC_LOGIC/AI_ORDER_REST_RUNBOOK.md)
- Inbound/outbound & module Webhooks: [`../FUNC_LOGIC/WAREHOUSE_INDEX.md`](../FUNC_LOGIC/WAREHOUSE_INDEX.md), [`../docs/AI_ORDER_REST.md`](../docs/AI_ORDER_REST.md)
- Runbook kho + webhook AI (sellable): [`04_WH_RUNBOOK_UPGRADE.md`](04_WH_RUNBOOK_UPGRADE.md)
