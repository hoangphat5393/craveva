...
**Liên quan:** `PRODUCTION_OPERATIONS_LIVE_VI.md` §2, [`WAREHOUSE_MASTER_GUIDE.md`](../FUNC_LOGIC/WAREHOUSE_MASTER_GUIDE.md).
...
**Chi tiết / FAQ kho & batch:** `PRODUCTION_OPERATIONS_LIVE_VI.md` §2.
...
| P1c FG → Inventory ledger | **Done**     | `ProductionFgInventoryLedgerSync`; `PRODUCTION_OPERATIONS_LIVE_VI.md` §2           |
| P2 inventory_mode         | **Deferred** |                                                                                    |

**Backlog UX:** `UX_MENU_AND_SETTINGS_VI.md` Phần D — **UX-005 Done**.
