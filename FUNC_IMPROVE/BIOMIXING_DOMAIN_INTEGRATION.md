...
**Tham chiếu:** `BIOMIXING_DEV_PLAN.md` (kiến trúc module Production), `BIOMIXING_FLOW_CRACEVA_GAP.md` (flow khách hàng), **`BIOMIXING_BASELINE_PREP_2026_VI.md`** (nền SO/PO/DO/kho 2026), `BIOMIXING_DOC_AUDIT_2026_VI.md`, `FUNC_LOGIC/WAREHOUSE_INDEX.md`.
