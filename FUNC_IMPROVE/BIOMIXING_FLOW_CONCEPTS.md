...
**Mục đích:** Tóm các **khái niệm** và **lưu ý vận hành/kho** thường gây nhầm giữa B2B, PO và Production — bổ sung cho living docs; **không** thay thế `FUNC_LOGIC` hay spec kỹ thuật chi tiết.

**Đọc cùng:** **`BIOMIXING_BUSINESS_FLOW_LIVE.md`** (luồng bước chuẩn — LIVE) · `BIOMIXING_GAP_STATUS.md` · `FUNC_LOGIC/PRODUCTION_BUSINESS.md`.
...
| **Production Order (Release)** | **Reserve RM**                           | Đã triển khai: giữ tồn tại Release qua `StockReservationService`; chặn release nếu thiếu available; tham chiếu vận hành: `FUNC_LOGIC/PRODUCTION_BUSINESS.md`. |
...
- Baseline kho/DO: `FUNC_LOGIC/SALES_FULFILLMENT_QA_CHECKLIST.md`, `BIOMIXING_PREP_INDEX_EN.md`.
- Guardrails triển khai MVP: `BIOMIXING_GAP_STATUS.md`.
- Trạng thái & backlog: `BIOMIXING_GAP_STATUS.md`.
