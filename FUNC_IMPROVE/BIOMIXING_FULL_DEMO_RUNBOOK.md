...
Đọc thêm khái niệm RM/FG: `BIOMIXING_FLOW_CONCEPTS.md`. Checklist ERP 3 luồng cơ bản: `P0_MINI_UAT_CHECKLIST_BIOMIXING.md`.
...
Áp **`P0_MINI_UAT_CHECKLIST_BIOMIXING.md`** (Estimate→SO; SO→DO→Invoice với shipment/invoice mode; PO→GRN→Bill).
...
**Living doc:** `FUNC_LOGIC/PRODUCTION_BUSINESS.md` §3 · UAT: `P0_MINI_UAT_CHECKLIST_BIOMIXING.md` **Luồng E**.

### Phần F — Tuỳ chọn Phase 2 (chỉ khi chủ động bật)

- **`production.phase2.enforce_variance_approval`**: FG vượt ngưỡng cần **Approve variance** trước khi post receipt (badge UX: `UX_MENU_AND_SETTINGS.md` Phần A/C, UX-008 Done).
...
| FG có trên Stock batches nhưng không thấy Inventory | Đã vá P1c — chạy backfill; tìm SP theo tên/SKU không phải mã lô; xem `PRODUCTION_BUSINESS.md` §3. |

---

## 4. Liên kết nhanh trong repo

- **Doc hub Biomixing:** `BIOMIXING_DOC_HUB.md`
- **Trạng thái phase:** `BIOMIXING_GAP_STATUS.md`
- Trạng thái/guardrails Phase 0–2: `BIOMIXING_GAP_STATUS.md` + `FUNC_LOGIC/PRODUCTION_BUSINESS.md`
- P0 hàng đợi: `P0_BIOMIXING_NEXT_STEPS.md`
