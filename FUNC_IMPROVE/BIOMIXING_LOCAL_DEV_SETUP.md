...
**Liên quan:** `BIOMIXING_UAT_AND_TEST_GUIDE.md` (lệnh test), `P0_BIOMIXING_NEXT_STEPS.md` (thứ tự P0).
...
Nếu dùng tenant/plugin đa công ty: bật đúng company pilot và gói có module **Production** + **Warehouse** (theo `docs/SYSTEM_MODULE_LANGUAGEPACK_CUSTOM_FIELDS.md`).
...
Gói rộng hơn: xem mục 1 trong `BIOMIXING_UAT_AND_TEST_GUIDE.md`.
