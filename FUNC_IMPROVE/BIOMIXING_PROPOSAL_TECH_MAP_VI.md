...
- Playbook triển khai nội bộ: `FUNC_IMPROVE/BIOMIXING_PLAYBOOK_P0P1_VI.md`
- **Phase 1 + 2 (chốt vận hành):** dùng **`planned_quantity`** từ BOM snapshot (định mức × số TP kế hoạch). Chi tiết trạng thái: `FUNC_TEST/01_BIOMIXING_TEST_MATRIX_VI.md`.
