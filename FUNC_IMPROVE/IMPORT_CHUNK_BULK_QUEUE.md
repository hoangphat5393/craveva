...
**Tài liệu tham chiếu:** FUNC_LOGIC/PRODUCT_BUSINESS.md, FUNC_IMPROVE/IMPORT_POLL_TRACKERS.md

### 6.1. Các phương án trong ../FUNC_IMPROVE/IMPORT_CHUNK_BULK_QUEUE.md (mục 1–5)

| Đề xuất / Phương án                        | Áp dụng cho Product?              | Trạng thái Product import | Ghi chú                                                                                                                                                                  |
| ------------------------------------------ | --------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Chunk 10** (mục 1)                       | Không áp dụng                     | ❌ Không dùng             | Product dùng **chunk 100** để giảm số job và overhead queue.                                               |
...
- Giữ trang import mở để poll progress (hoặc chạy worker `queue:work` riêng nếu cần)
  ...
  Đang cập nhật PRODUCT_CREATE_FLOW và import tracker.
