# Import — Đặc tả map cột (Maolin / Craveva)
...
Chi tiết triển khai: `FUNC_IMPROVE/IMPORT_SPECS.md` · `IMPORT_POLL_TRACKERS.md`.
...
**Tài liệu liên quan:** `FUNC_LOGIC/MAOLIN_BUSINESS.md` (báo giá = tham chiếu / adapter, không nằm chuỗi import chuẩn PO/DO/Invoice).
...
| **Bảng staging / JSON / model riêng**                                                                            | **Phù hợp “lưu tham chiếu”** | Đúng tinh thần `MAOLIN_BUSINESS.md`: báo giá có thể chỉ **adapter + lưu raw** phục vụ đối soát, AI, báo cáo — **không** đẩy vào PO/DO/Invoice.                                                                                                                                                                                                                                                                      |
...
_Cập nhật: 2026-04-03 — migration core quotation fields + UI + import processor; cập nhật bảng mapping mục 4–5–6._
