...
| 2026-05-14 | P0-05   | Dev + BA       | In progress |         97 | Code 2 chieu + checklist EN/VI + **Pest wiring** `tests/Feature/P0BiomixingAutomatedEvidenceTest.php` (trace.blade.php ↔ product-batches/show.blade.php) + route smoke `BiomixingDemoRoutesReadinessTest.php`                                                                                                                                                             | Chua bien ban UAT + screenshot                          | QA chay checklist A/B; attach evidence                                    |
...
| 2026-05-14 | P0-08   | QA + BA        | In progress |         60 | `FUNC_IMPROVE/P0_MINI_UAT_CHECKLIST_BIOMIXING_VI.md` + **Pest route smoke** `P0BiomixingAutomatedEvidenceTest.php` (Estimate/SO/DO/Invoice/PO/GRN/Bill). **2026-05-14:** them `OrderCompletionShippedSalesDoGateTest.php` trong cum smoke; **82 tests** regression Production+Warehouse+SalesDo (298 assertions) pass.                                                    | Chua co ket qua Pass/Fail thuc te (UI)                  | Chon ngay chay 3 luong + attach bien ban                                  |
