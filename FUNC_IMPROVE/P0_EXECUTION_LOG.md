...
| 2026-05-09 | P0-08   | QA + BA        | In progress |         55 | `FUNC_IMPROVE/P0_MINI_UAT_CHECKLIST_BIOMIXING_VI.md` + **Pest route smoke** `tests/Feature/P0BiomixingAutomatedEvidenceTest.php` (Estimate/SO/DO/Invoice/PO/GRN/Bill route names)                                                                                                                                                                                         | Chua co ket qua Pass/Fail thuc te (UI)                  | Chon ngay chay 3 luong + attach bien ban                                  |
