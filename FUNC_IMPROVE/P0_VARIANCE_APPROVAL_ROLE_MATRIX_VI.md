...
- **Bằng chứng tự động (P0-02):** `tests/Feature/ProductionVarianceApprovalPermissionTest.php` — cấm khi đã gỡ quyền `edit_production_orders` trên cùng user pilot; cho phép khi giữ quyền.
