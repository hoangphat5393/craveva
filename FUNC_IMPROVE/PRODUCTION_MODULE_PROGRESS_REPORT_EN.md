...
| **Material shortage summary**     | Done (code)   | Cross-order RM shortage DataTable + drill-down; operational behavior documented in `FUNC_LOGIC/PRODUCTION_OPERATIONS_LIVE_VI.md`                                                                                                             |
| **RM reserve at Release**         | Done (core)   | Reserve on **Release**, release on **Cancel**, consume after all batches post RM; block Release if insufficient available — see `FUNC_LOGIC/PRODUCTION_OPERATIONS_LIVE_VI.md` + UAT `19_PRODUCTION_RM_RESERVE_AT_RELEASE_TEST_CASES_VI.md`   |
...
| `FUNC_LOGIC/PRODUCTION_OPERATIONS_LIVE_VI.md`                | Production operations SSOT (reserve, lifecycle)                   |
| `FUNC_IMPROVE/BIOMIXING_GAP_STATUS_VI.md`                    | Phase status vs code                                              |
