...
| OpenAPI / log DB / rate limit riêng | Chưa                           | Xem `docs/AI_ORDER_INTEGRATION_REST.md`.                                                                                       |
...
- Góc nhìn **REST / OpenAPI / rate limit**: [`docs/AI_ORDER_INTEGRATION_REST.md`](../docs/AI_ORDER_INTEGRATION_REST.md)
