...
**Biến `.env`:** [`WH_PURCHASE_ENV_REFERENCE_VI.md`](WH_PURCHASE_ENV_REFERENCE_VI.md)  
**Danh sách issue QA chi tiết (bảng A–O):** [`ERP_SO_PO_DO_INV_WH_QA_VI.md`](ERP_SO_PO_DO_INV_WH_QA_VI.md)  
...
WUP-01…07: `warehouse_type`, availability, reserve/outbound, canonical inbound/outbound, unit conversion, idempotency — chi tiết [`WAREHOUSE_RUNBOOK_AND_UPGRADE_PLAN_VI.md`](../FUNC_IMPROVE/04_WH_RUNBOOK_UPGRADE_VI.md) §6.

### 7.7 Rủi ro mở rộng

Nhiều invoice trên một SO; `default_warehouse_id` khách; job không có `user()` — xem [`ERP_SO_PO_DO_INV_WH_QA_VI.md`](ERP_SO_PO_DO_INV_WH_QA_VI.md).
