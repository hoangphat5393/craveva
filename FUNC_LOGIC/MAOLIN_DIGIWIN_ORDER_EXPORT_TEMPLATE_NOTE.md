...
From `MAOLIN_MASTER_GUIDE.md` and `customer do.txt`:
...
This template defines the **evening sales order export** shape. Other domains (product, inventory, pricing) use different DigiWin files — see `MAOLIN_IMPORT_MAPPING.md` / `API_DATA_TYPE_LIST_VI.md`.

Related PM/customer SOP: `FUNC_LOGIC/SOP_CUSTOMER_API_REQUIREMENTS_NON_TECHNICAL_EN.md`.
