...
**Đa đơn vị (P2-UOM):** Màn **Purchase → Products** có `product_unit_conversions` — xem [`FUNC_IMPROVE/P2_PRODUCT_UOM_KIOTVIET_PLAN.md`](../FUNC_IMPROVE/P2_PRODUCT_UOM_KIOTVIET_PLAN.md).
...
## 8. Đối chiếu kế hoạch (../FUNC_IMPROVE/IMPORT_CHUNK_BULK_QUEUE.md) – đã triển khai
