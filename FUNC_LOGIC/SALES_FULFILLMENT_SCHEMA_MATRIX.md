...
**Quy trình vận hành (PO/SO/invoice):** [`SALES_BUSINESS.md`](SALES_BUSINESS.md)  
**Biến `.env`:** [`../docs/WAREHOUSE_PURCHASE_ENV_REFERENCE.md`](../docs/WAREHOUSE_PURCHASE_ENV_REFERENCE.md)  
**Danh sách issue QA chi tiết (bảng A–O):** [`SALES_FULFILLMENT_QA_CHECKLIST.md`](SALES_FULFILLMENT_QA_CHECKLIST.md)  
**Lịch sử refactor / tracker:** [`SO_DO_PO_GRN_REFACTOR.md`](../FUNC_IMPROVE/05_SO_DO_PO_GRN_REFACTOR.md)
...
| ----------------------------- | ---------------------------------------------- | ------------------------------------------------------------ |
| `grns`, `grn_items`           | `2000_01_01_000149_create_grns_baseline.php`, `2000_01_01_000148_create_grn_items_baseline.php` | `legacy_delivery_order_id` / `legacy_delivery_order_item_id` |
| `sales_dos`, `sales_do_items` | `2000_01_01_000403_create_sales_dos_baseline.php`, `2000_01_01_000402_create_sales_do_items_baseline.php` | `legacy_sales_shipment_id` / `legacy_sales_shipment_item_id` |
...
WUP-01…07: `warehouse_type`, availability, reserve/outbound, canonical inbound/outbound, unit conversion, idempotency — chi tiết [`WAREHOUSE_RUNBOOK_AND_UPGRADE_PLAN.md`](../FUNC_IMPROVE/04_WH_RUNBOOK_UPGRADE.md) §6.

### 7.7 Rủi ro mở rộng

Nhiều invoice trên một SO; `default_warehouse_id` khách; job không có `user()` — xem [`SALES_FULFILLMENT_QA_CHECKLIST.md`](SALES_FULFILLMENT_QA_CHECKLIST.md).
...
| [`MODULE_WAREHOUSE.md`](MODULE_WAREHOUSE.md)                                                                                    | Module hub — trỏ file này                                     |
| [`SALES_PURCHASE_WAREHOUSE_UAT_CHECKLIST.md`](SALES_PURCHASE_WAREHOUSE_UAT_CHECKLIST.md)                                                  | Checklist UAT E2E canonical                                |
| [`SALES_FULFILLMENT_QA_CHECKLIST.md`](SALES_FULFILLMENT_QA_CHECKLIST.md)                                                                | Bảng issue QA chi tiết                                     |
| [`SALES_BUSINESS.md`](SALES_BUSINESS.md)                                    | Hướng dẫn vận hành                                         |
| [`SALES_BUSINESS.md`](SALES_BUSINESS.md)                                                                            | Quy trình nghiệp vụ + mental model kỹ thuật                |
| [`SO_DO_PO_GRN_REFACTOR.md`](../FUNC_IMPROVE/05_SO_DO_PO_GRN_REFACTOR.md)                                               | Lịch sử quyết định refactor                                |
