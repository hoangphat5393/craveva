...
**Vị trí trong quy trình tổng:** [`QUY_TRINH_PO_DO_SO_INVOICE_WAREHOUSE_VI.md`](QUY_TRINH_PO_DO_SO_INVOICE_WAREHOUSE_VI.md) §4.5 · Chi tiết SO/PO/GRN đầy đủ: [`SALES_PURCHASE_FLOW.md`](SALES_PURCHASE_FLOW.md). Trả hàng mua (Vendor Credit → xuất kho): [`PURCHASE_RETURN_VENDOR_CREDIT_STOCK_VI.md`](PURCHASE_RETURN_VENDOR_CREDIT_STOCK_VI.md).
