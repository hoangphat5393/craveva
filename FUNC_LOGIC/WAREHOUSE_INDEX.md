...
| **Sales DO** (remaining, confirm, đổi kho)                                      | [`SALES_FULFILLMENT_DOCS_INDEX.md`](SALES_FULFILLMENT_DOCS_INDEX.md), [`ERP_SO_PO_DO_INV_WH_QA_VI.md`](ERP_SO_PO_DO_INV_WH_QA_VI.md)                                                                                                                                                                   |
...
| Audit **code** (retired pass 6)                                                 | `WAREHOUSE_MASTER_GUIDE.md`, `ERP_SO_PO_DO_INV_WH_QA_VI.md`                                                                                                                                                                                                                                            |
...
| Audit đa kho (retired pass 6)                                                   | `WAREHOUSE_MASTER_GUIDE.md`                                                                                                                                                                                                                                                                            |
...
| Định hướng inventory / opening stock                                            | [`13_OPENING_STOCK_VS_WAREHOUSE_STOCK_VI.md`](../FUNC_IMPROVE/13_OPENING_STOCK_VS_WAREHOUSE_STOCK_VI.md) · [`WAREHOUSE_MASTER_GUIDE.md`](WAREHOUSE_MASTER_GUIDE.md)                                                                                                                                    |
...
- Huong nghiep vu + UX/UI: `../FUNC_IMPROVE/13_OPENING_STOCK_VS_WAREHOUSE_STOCK_VI.md`, `UX_MENU_AND_SETTINGS_VI.md`
