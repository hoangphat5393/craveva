...
| **Tồn theo lô (batch) — UI, trace Production, đối soát**                        | Routes `warehouse.product-batches.*`, widget **Stock** (snapshot vs batch, WUP-07); chi tiết + test trong [`04_WAREHOUSE_RUNBOOK_AND_UPGRADE_PLAN_VI.md`](../FUNC_IMPROVE/04_WAREHOUSE_RUNBOOK_AND_UPGRADE_PLAN_VI.md) §6 · `WarehouseProductBatchRoutesTest.php` |
| **Runbook vận hành + kế hoạch nâng cấp (WUP)**                                  | [`WAREHOUSE_RUNBOOK_AND_UPGRADE_PLAN_VI.md`](../FUNC_IMPROVE/04_WAREHOUSE_RUNBOOK_AND_UPGRADE_PLAN_VI.md)                                                                                                                                                         |
...
- Checklist UAT cũ và audit E2E cũ đã hợp nhất vào:
    ...
    - [`ERP_SO_PO_DO_INVOICE_WAREHOUSE_QA_VERIFICATION_VI.md`](ERP_SO_PO_DO_INVOICE_WAREHOUSE_QA_VERIFICATION_VI.md)

**Gộp 2026-04-06:**

- `WAREHOUSE_OPERATION_RUNBOOK_VI.md` + `WAREHOUSE_UPGRADE_PLANE.MD` → [`WAREHOUSE_RUNBOOK_AND_UPGRADE_PLAN_VI.md`](../FUNC_IMPROVE/04_WAREHOUSE_RUNBOOK_AND_UPGRADE_PLAN_VI.md)
...
Chi tiết PO/DO/invoice vs `PurchaseBill`: [`ERP_SO_PO_DO_INVOICE_WAREHOUSE_QA_VERIFICATION_VI.md`](ERP_SO_PO_DO_INVOICE_WAREHOUSE_QA_VERIFICATION_VI.md) (mục 2).
