                ...
                <div class="s-b-n-header" id="tabs">
                    <h2 class="mb-0 p-20 f-21 font-weight-normal border-bottom-grey">
                        @php
                            ...
                            if (is_array($pageTitleKey)) {
                                $pageTitleKey = $pageTitleKey['title'] ?? ($pageTitleKey[0] ?? '');
                            }
                            $pageTitleKey = is_string($pageTitleKey) ? $pageTitleKey : (is_scalar($pageTitleKey) ? (string) $pageTitleKey : '');
                            $pageTitleText = $pageTitleKey !== '' ? __($pageTitleKey) : '';
                            if (is_array($pageTitleText)) {
                                $pageTitleText = $pageTitleKey;
                            }
                        @endphp
                        {{ $pageTitleText }}
                    </h2>
