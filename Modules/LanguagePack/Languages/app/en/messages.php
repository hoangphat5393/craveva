...
return [
    ...
    'salesDoShipQuantityOpenEdit' => 'Set ship quantities in the Ship form, then submit Ship.',
    'salesDoShipQtyExceedsRemaining' => 'Ship quantity cannot exceed remaining quantity (remaining: :remaining, requested: :requested).',
    ...
    'salesDoSaveRequiresOrder' => 'Please select a sales order first, then wait for the line items to load.',
    'salesDoSaveRequiresWarehouse' => 'Please select a warehouse before saving.',
    'salesDoSaveRequiresShipmentLines' => 'No shipment lines are loaded yet. Pick a sales order (and warehouse if needed) so quantities appear, then save.',
    'salesDoBatchRequiredForItem' => 'Please select batch for ":item" before shipping.',
    'salesDoBatchQtyExceedsAvailableForItem' => 'Ship qty for ":item" exceeds selected batch available (:available).',
    'salesDoBatchRequired' => 'Please select a valid batch before shipping.',
    'salesDoBatchNotFoundForCompany' => 'Selected batch was not found in the current company.',
    'salesDoBatchWrongWarehouse' => 'Selected batch does not belong to the selected warehouse.',
    'salesDoBatchWrongProduct' => 'Selected batch does not belong to the selected product.',
    'salesDoBatchQtyExceedsAvailable' => 'Ship quantity cannot exceed selected batch available quantity (available: :available, requested: :requested).',
    ...
    'orderCompleteRequiresShippedDo' => 'Cannot complete this sales order because items are not fully shipped yet. Please complete the Sales Delivery Order (DO) first.',
