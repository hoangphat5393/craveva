...
return [
    ...
    'estimates' => [
        ...
        'internalReviewHeading' => 'Internal approval',
        'internalReviewLegacy' => 'This quotation was created before internal review tracking; both approvals are treated as satisfied.',
        'internalReviewPresident' => 'Managing Director',
        'internalReviewVpPricing' => 'Pricing director',
        'internalReviewReviewedBy' => 'Reviewed by',
        'internalReviewReviewedAt' => 'Reviewed at',
        'internalReview_pending' => 'Pending',
        'internalReview_approved' => 'Approved',
        'internalReview_rejected' => 'Rejected',
        'bomLinesHeading' => 'Recipe material lines (per finished product)',
        'bomLinesHelp' => 'Raw materials and packaging needed to make one sellable finished product. Unit of measure follows the product catalog. Separate from commercial product lines below.',
        'bomLinesEmpty' => 'No material lines on this quotation yet.',
        'bomMaterial' => 'Material',
        'bomQuantity' => 'Quantity (per finished product)',
        'bomUnitCost' => 'Unit cost',
        'bomLineTotal' => 'Line cost',
        'bomMaterialTotal' => 'Total material cost',
        'bomSelectProduct' => 'Select product (optional)',
        'bomMaterialNamePlaceholder' => 'Material name (if not from catalog)',
        'bomAddRow' => 'Add material line',
        'workflowStageLabel' => 'Approval stage',
        'workflowStage_standard' => 'Standard quotation',
        'workflowStage_legacy' => 'No review tracking',
        'workflowStage_pending_president' => 'Awaiting Managing Director',
        'workflowStage_pending_vp' => 'Awaiting pricing director',
        'workflowStage_president_rejected' => 'Managing Director rejected',
        'workflowStage_vp_rejected' => 'Pricing director rejected',
        'workflowStage_ready_for_so' => 'Ready to convert to sales order',
        'workflowStage_revision_required' => 'Return to sales (revision)',
        'workspaceZoneRecipe' => 'Recipe & materials',
        'workspaceZoneApproval' => 'Approval',
        'workspaceZoneFinancial' => 'Cost & margin',
        'similarRecipesTitle' => 'Similar quotations / recipes',
        'similarRecipesHint' => 'Past quotations that share ingredients with this recipe (manual search, no AI).',
        'similarMatch' => 'Match',
        'grossMarginPercent' => 'Gross margin',
        'revision_required' => 'Revision required',
        'revisionRequiredAlert' => 'An approver returned this quotation for revision. Update the recipe or pricing, then use Submit for review again.',
        'recipeHeaderSection' => 'Recipe and contract-manufacturing product',
        'recipeHeaderSectionHelp' => 'Minimum order quantity, packaging, and customer product code for manufacturing quotations. Only shown when contract-manufacturing review is enabled for this company.',
        'recipeMoq' => 'Minimum order quantity',
        'recipePackaging' => 'Packaging',
        'recipeOemSku' => 'Customer product code',
        'recipeTargetUnitPrice' => 'Target unit price',
        'marginSummaryHeading' => 'Cost & margin (indicative)',
        'marginSummaryHelp' => 'Compares material cost (per finished product × order quantity) to the commercial subtotal on product lines. Pricing director rules are not enforced automatically yet.',
        'marginUnitBomCost' => 'Material cost per finished product',
        'marginOrderQuantity' => 'Order quantity used',
        'marginExtendedBomCost' => 'Total material cost for order quantity',
        'marginCommercialSubtotal' => 'Commercial subtotal',
        'marginGrossPercent' => 'Gross margin',
        'marginMinimumVpRule' => 'Pricing director approval requires gross margin of at least :percent% (when material lines exist).',
        'vpMarginBelowMinimum' => 'Cannot approve: gross margin is :margin% but the minimum is :minimum%. Adjust pricing or material costs, then resubmit.',
        'copyProductionBomHeading' => 'Copy from production bill of materials',
        'copyProductionBomHelp' => 'Load material lines from a master production recipe (unit costs from Purchasing → Products when available).',
        'copyProductionBomSelect' => 'Select production bill of materials',
        'copyProductionBomButton' => 'Load material lines',
        'productionBomModuleUnavailable' => 'Production module is not available.',
        'productionBomNoLines' => 'This production bill of materials has no component lines to copy.',
        'timelineEvent_submitted' => 'Submitted for internal review',
        'timelineEvent_president_approved' => 'Managing Director approved',
        'timelineEvent_president_rejected' => 'Managing Director rejected',
        'timelineEvent_vp_approved' => 'Pricing director approved',
        'timelineEvent_vp_rejected' => 'Pricing director rejected',
        'convertSoBlocked' => 'Cannot convert to sales order until the Managing Director and pricing director have both approved this quotation.',
        'submitForReview' => 'Submit for review',
        'submitForReviewConfirm' => 'Send this quotation to the Managing Director and pricing director for internal approval?',
        'submitReviewSuccess' => 'Quotation submitted for internal review.',
        'submitReviewNotAllowed' => 'This quotation cannot be submitted for review in its current state.',
        'presidentReviewApprove' => 'Managing Director approve',
        'presidentReviewReject' => 'Managing Director reject',
        'vpPricingReviewApprove' => 'Pricing director approve',
        'vpPricingReviewReject' => 'Pricing director reject',
        'vpReviewRequiresPresident' => 'The Managing Director must approve the recipe before pricing director review.',
        'internalReviewNotePlaceholder' => 'Review note (optional)',
        'approvalTimelineHeading' => 'Approval history',
        'approvalTimelineEmpty' => 'No approval actions recorded yet.',
        'timelinePresident_approved' => 'Managing Director approved',
        'timelinePresident_rejected' => 'Managing Director rejected',
        'timelinePresident_pending' => 'Managing Director review',
        'timelineVp_approved' => 'Pricing director approved',
        'timelineVp_rejected' => 'Pricing director rejected',
        'timelineVp_pending' => 'Pricing director review',
        'bomNoComponents' => 'No products with type Raw material, Semi-finished, or Packaging in this company. Go to Purchasing → Products and set the product type on each item (finished goods will not appear here). You can still type material names manually below.',
        'bomMaterialRequired' => 'Each material line needs a product or material name.',
        'bomQuantityRequired' => 'Material line quantity must be greater than zero.',
        'bomUnitCostRequired' => 'Material line unit cost must be zero or greater.',
    ],
    'credit-notes' => [
        'total' => 'Total',
    ...
    'orders' => [
        ...
        'apiTab' => 'API',
        'orderSettingsTab' => 'Sales Order Settings',
        'apiBeginnerRestTitle' => 'First time with REST? Quick read',
        'apiBeginnerRestLead' => 'On this page, REST simply means: you call different URLs with different HTTP verbs (POST creates an order, GET reads it, PATCH updates, DELETE cancels). Every call uses the same secret header shown as “HTTP header”.',
        'apiBeginnerRestStep1' => 'Confirm you see Base URL, Company ID, and the secret header below. Those three values must match what you paste into Postman or your script.',
        'apiBeginnerRestStep2' => 'Start with POST “create order”: open the POST panel (open by default), click Copy cURL, then in Postman choose Import → Raw text, paste, adjust YOUR_CLIENT_CODE and the product line if needed, and Send.',
        'apiBeginnerRestStep3' => 'If you get HTTP 201, open the JSON response and copy data.order_id — that number replaces YOUR_ORDER_ID in the GET / PATCH / PUT / DELETE examples.',
        'apiBeginnerRestStep4' => 'Open another verb’s panel, copy its cURL the same way. If the response is 403 with INTEGRATION_METHOD_DISABLED, enable that verb under “Allowed HTTP methods” and click Save.',
        'apiIntegrationIntro' => 'Copy the values below to your integration partner or software. You can turn connection types on or off further down; ask your partner which lines they need.',
        'apiBaseUrl' => 'Base URL (for your client’s “Base URL” field)',
        ...
        'apiWebhookPathSpellingNote' => 'Path segment is **ai-order-webhook** (letters “ai” as in AI), not “api-order-webhook”. If you type the URL by hand, copy it from the field above.',
        ...
        'apiNoWebhookSecret' => 'No per-company integration secret yet. Click “Generate new webhook secret” below to enable REST order APIs (header X-AI-Webhook-Secret or Authorization: Bearer). The server-wide AI_ORDER_WEBHOOK_SECRET in .env is not accepted on REST routes.',
        'apiGlobalSecretIgnoredForRestHint' => 'AI_ORDER_WEBHOOK_SECRET is set in .env, but POST /api/integrations/orders requires the per-company secret from “Generate new webhook secret” below. Generate one to copy REST examples.',
        'apiIntegrationRestOnlyFooter' => 'The legacy URL POST …/ai-order-webhook/{secret} has been removed. Use POST {Base URL}/api/integrations/orders with the same JSON body and authentication headers (see the REST panels below).',
        'apiSecretRegenerated' => 'A new integration secret was generated for this company. Update every external system (REST URL and X-AI-Webhook-Secret / Bearer).',
        'apiRegenerateWebhookButton' => 'Generate new webhook secret',
        'apiRegenerateWebhookHelp' => 'Rotating the secret invalidates the previous URL and header everywhere they were configured.',
        'apiExternalEventIdHint' => 'Send external_event_id so safe retries are recognized (duplicates are ignored).',
        'apiDocHint' => 'Full JSON payload and fields: docs/AI_ORDER_INTEGRATION_REST.md and docs/AI_ORDER_INTEGRATION_REST_SETUP_VI.md.',
        'apiFillAiTitle' => 'How to configure your HTTP client (integrations)',
        'apiFillAiStep1' => 'Base URL: paste the “Base URL” value above into your client’s Base URL field (must be your real ERP domain, HTTPS).',
        'apiFillAiStep2' => 'Create orders with POST {Base URL}/api/integrations/orders (same JSON body rules as before).',
        'apiFillAiStep3' => 'Authentication: add header X-AI-Webhook-Secret with exactly the value shown under “HTTP header”.',
        'apiFillAiStep4' => 'JSON body: include company_id, **client_code** (recommended — from Client Details; the server resolves it to the client user id on the order), optional **client_id** instead, and items. Exact field names and examples: documentation links at the bottom.',
        'apiBaseUrlVersionPathHint' => 'If your client has an “API Version Path” (e.g. /v1): leave it empty or “/” unless it maps to this exact POST URL. This ERP endpoint is not generic REST /v1/orders.',
        'apiCompanyIdSelected' => 'Selected ERP company: :name',
        'apiCompanyIdHelp' => 'Must appear as company_id in the JSON body. With a company-specific secret, a mismatch is rejected. For another company: switch workspace in the ERP header, reload this page, then copy again.',
        'apiRingfenceTitle' => 'One external integration = one ERP company',
        'apiRingfenceIntro' => 'This company’s integration secret ties REST traffic to this company. Generate it on this page; .env AI_ORDER_WEBHOOK_SECRET is not used for REST.',
        'apiRingfenceBullet1' => 'Use one external integration profile per ERP company so secrets, company_id, and copied URLs are never mixed between companies.',
        'apiRingfenceBullet2' => 'Confirm the correct workspace is selected in the ERP header before copying; switch company and refresh this page when needed.',
        'apiPayloadMinimumTitle' => 'Create request: key JSON fields',
        'apiPayloadFieldCompanyId' => 'company_id — must match the number shown above.',
        'apiPayloadFieldClientCode' => 'client_code **or** client_id — send at least one (if both, they must be the same client). client_code = `client_details.client_code`; client_id = `users.id` of an active user in this company_id.',
        'apiWebhookClientCodeRequired' => 'client_code is required when client_id is not sent.',
        'apiWebhookClientCodeInvalid' => 'client_code must match an existing Client code for this company_id (see client_details). Open CRM → Clients and use the Client code field, or query client_details where company_id matches.',
        'apiWebhookClientUserInactive' => 'The resolved client user is not active for this company, or client_id does not belong to this company_id.',
        'apiWebhookClientIdOrCodeRequired' => 'Send client_code and/or client_id: at least one is required. When both are sent, they must refer to the same active client in this company.',
        'apiWebhookClientIdInvalid' => 'client_id must be users.id of an active user belonging to this company_id.',
        'apiWebhookClientIdCodeMismatch' => 'client_id and client_code refer to different clients; use only one or align them to the same client.',
        'apiWebhookProductNotFound' => 'No catalog product found for this line: item_name does not match a product name and sku (if sent) does not match a product SKU for this company_id.',
        'apiWebhookProductIdWrongCompany' => 'product_id does not belong to this company_id.',
        'apiWebhookItemInvalid' => 'Each items[] entry must be an object with item_name, quantity, and unit_price.',
        'apiPayloadFieldExternalEventId' => 'external_event_id — unique per event (recommended for retries).',
        'apiPayloadFieldItems' => 'items[0][item_name], items[0][quantity], items[0][unit_price] — at least one line; optional items[0][sku]. Each line must match a catalog product by exact name or by sku for this company.',
        'apiAcceptHeaderBody' => 'Also send header Accept: application/json (recommended).',
        'apiCurlExampleTitle' => 'Example curl (after a secret is available)',
        'apiCurlCopyHint' => 'Copy the block below (**JSON** body, application/json). Prefer **client_code** for create. You may send **client_id** (users.id) instead when you already have it. If both are sent, they must match the same client.',
        'apiCurlExampleMissingSecret' => 'Generate a per-company secret below to unlock REST Postman/cURL examples.',
        'apiHttpCodesHint' => 'Typical responses: 201 success, 401 wrong secret/header, 403 INTEGRATION_METHOD_DISABLED when a verb is turned off in settings, 422 validation or stock error (including company_id mismatch for a company-specific secret), duplicate: true when external_event_id was already processed.',
        'apiRestUrlLabel' => 'REST collection URL (POST create, same auth header)',
        'apiRestUrlHelp' => 'Use header X-AI-Webhook-Secret or Authorization: Bearer with the same secret as shown above. Per-company secret only (global .env secret is rejected on REST routes).',
        'apiRestMethodsTitle' => 'REST URLs for Postman (copy per row)',
        'apiRestMethodsIntro' => 'Replace YOUR_ORDER_ID with a real order id from the create response (or from the ERP Orders screen). Same auth headers as the POST URL above.',
        'apiRestMethodPanelsHint' => 'Tap a method header to show or hide URL, Postman template, and cURL. Create (POST) is open by default.',
        'apiRestPostmanManualNote' => 'If **Copy cURL** works in Postman but recreating the request from the template fails: set **Body → raw → JSON** (not form-data, not “none”), paste only the JSON under “Body (raw JSON)”, and use the same POST URL as **Copy URL**. Easiest: Postman **Import → Raw text** and paste the cURL block.',
        'apiRestMethodsTableMethod' => 'Method',
        'apiRestMethodsTableUrl' => 'URL (path only after your domain)',
        'apiRestMethodsTablePostmanExample' => 'Postman template (method + headers + body)',
        'apiRestPostmanHint' => 'Use “Copy template” for a block you can mirror in Postman: request line, Headers tab, and Body → raw → JSON (when shown). The POST example uses **client_code** (Client Details code; the API maps it to the order’s client user id). Replace YOUR_CLIENT_CODE or use a real code from this company; align item_name / optional sku with a catalog product.',
        'apiRestPostmanSectionHeaders' => 'Headers',
        'apiRestPostmanSectionBody' => 'Body (raw JSON)',
        'apiRestCopyUrl' => 'Copy URL',
        'apiRestCopyTemplate' => 'Copy template',
        'apiRestMethodsTableCurlExample' => 'Example curl (Postman import)',
        'apiRestCurlHint' => 'Postman: Import → Raw text, then paste the cURL block. POST / PATCH / PUT use valid JSON after -d (single line, bash-style single quotes; Content-Type: application/json).',
        'apiRestCopyCurl' => 'Copy cURL',
        'apiRestMethodPostRow' => 'Create order (same as field above)',
        'apiRestMethodGetRow' => 'Read order summary',
        'apiRestMethodPatchRow' => 'Update order (status / note JSON body)',
        'apiRestMethodPutRow' => 'Update order (same JSON body as PATCH)',
        'apiRestMethodDeleteRow' => 'Cancel order (sets status to canceled)',
        'apiCrudPermissionsTitle' => 'Allowed HTTP methods (AI / integration)',
        'apiCrudPermissionsIntro' => 'Uncheck a verb to block it with HTTP 403 and code INTEGRATION_METHOD_DISABLED. These flags apply to REST /api/integrations/orders.',
        'apiCrudCreate' => 'Create (POST)',
        'apiCrudRead' => 'Read (GET)',
        'apiCrudUpdate' => 'Update (PUT/PATCH)',
        'apiCrudDelete' => 'Delete (DELETE — cancels order)',
        'apiCrudSave' => 'Save method permissions',
        'apiCrudSaved' => 'Integration method permissions were updated.',
    ],
    ...
    'accountSettings' => [
        ...
        'aiWorkspaceEmbedHelp' => 'Paste the embed snippet from Craveva AI (usually a <script> block). Leave empty to hide the AI Workspace menu item.',
        'aiWorkspaceEmbedCode' => 'Embed JavaScript',
        'aiWorkspaceEmbedPlaceholder' => 'Paste your AI Workspace integration script here…',
        'aiWorkspaceEmbedHint' => 'Example: copy the script tag from your agent deployment page and paste it unchanged.',
        'aiAssistantWidgetEmbedHelp' => 'Paste the embed snippet for the floating chat widget. Leave empty to hide the Assistant submenu.',
        'aiAssistantWidgetEmbedCode' => 'Embed JavaScript',
        'aiAssistantWidgetEmbedPlaceholder' => 'Paste your AI Assistant widget script here…',
        'aiAssistantWidgetEmbedHint' => 'Example: paste the full <script> block that loads the chat button and window.',
    ],
    ...
    'module' => [
        ...
        'estimates_phase1_review' => 'Contract-manufacturing quotation review (2-step approval)',
    ...
    'invoiceSettings' => [
        ...
        'phase1MinGrossMarginPercent' => 'Minimum gross margin for pricing director approval (contract manufacturing)',
        'phase1MinGrossMarginPercentHelp' => 'When contract-manufacturing quotation review is enabled, the pricing director cannot approve if gross margin from material lines is below this percent. Leave empty to use the server default.',
        ...
        'orderTerms' => 'Sale order — Terms and Conditions',
        'documentTermsSection' => 'Document terms (Sale order & Sales delivery order)',
        'documentTermsSectionHelp' => 'Company-wide terms shown on sale orders and sales delivery orders. Per-document notes are entered on each form.',
        'saleOrderAndDeliveryOrderTerms' => 'Sale order & Sales delivery order — Terms and Conditions',
        'saleOrderAndDeliveryOrderTermsHelp' => 'If empty, invoice terms are used on documents.',
        'orderAndSalesDoTerms' => 'Sale order & Sales delivery order — Terms and Conditions',
        'orderAndSalesDoTermsHelp' => 'If empty, invoice terms are used on documents.',
