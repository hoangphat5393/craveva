...
return [
    ...
    'estimates' => [
        ...
        'internalReviewPresident' => 'President',
        'internalReviewVpPricing' => 'VP pricing',
        ...
        'bomLinesHeading' => 'Recipe BOM lines (per finished unit)',
        'bomLinesHelp' => 'Raw materials and packaging to make one sellable unit. Unit of measure follows the product catalog (Unit Type). Separate from commercial product lines below.',
        'bomLinesEmpty' => 'No BOM lines on this quotation yet.',
        'bomMaterial' => 'Material',
        'bomQuantity' => 'Qty (per FG unit)',
        'bomUnitCost' => 'Unit cost',
        'bomLineTotal' => 'Line cost',
        'bomMaterialTotal' => 'Material cost total',
        'bomSelectProduct' => 'Select product (optional)',
        'bomMaterialNamePlaceholder' => 'Material name (if not from catalog)',
        'bomAddRow' => 'Add BOM line',
        ...
        'workflowStage_pending_vp' => 'Awaiting VP pricing',
        'workflowStage_president_rejected' => 'Managing Director rejected',
        'workflowStage_vp_rejected' => 'VP pricing rejected',
        'workflowStage_ready_for_so' => 'Ready for Sales Order',
        ...
        'recipeHeaderSection' => 'Recipe & product (OEM)',
        'recipeHeaderSectionHelp' => 'MOQ, packaging, and OEM SKU for manufacturing quotations. Only shown when OEM review is enabled for this company.',
        'recipeMoq' => 'MOQ (minimum order qty)',
        'recipePackaging' => 'Packaging',
        'recipeOemSku' => 'OEM SKU / code',
        'recipeTargetUnitPrice' => 'Target unit price',
        'marginSummaryHeading' => 'Cost & margin (indicative)',
        'marginSummaryHelp' => 'Compares BOM material cost (per unit × order quantity) to the commercial subtotal on product lines. VP rules are not enforced automatically yet.',
        'marginUnitBomCost' => 'BOM cost per finished unit',
        'marginOrderQuantity' => 'Order quantity used',
        'marginExtendedBomCost' => 'Extended material cost',
        'marginCommercialSubtotal' => 'Commercial subtotal',
        'marginGrossPercent' => 'Gross margin',
        'marginMinimumVpRule' => 'VP approval requires gross margin of at least :percent% (when BOM lines exist).',
        'vpMarginBelowMinimum' => 'Cannot approve: gross margin is :margin% but the minimum is :minimum%. Adjust pricing or BOM costs, then resubmit.',
        'copyProductionBomHeading' => 'Copy from Production BOM',
        'copyProductionBomHelp' => 'Load material lines from a master BOM (Purchase → Products unit costs used when available).',
        'copyProductionBomSelect' => 'Select Production BOM',
        'copyProductionBomButton' => 'Load BOM lines',
        'productionBomModuleUnavailable' => 'Production module is not available.',
        'productionBomNoLines' => 'This Production BOM has no component lines to copy.',
        'timelineEvent_submitted' => 'Submitted for internal review',
        'timelineEvent_president_approved' => 'President approved',
        'timelineEvent_president_rejected' => 'President rejected',
        'timelineEvent_vp_approved' => 'VP pricing approved',
        'timelineEvent_vp_rejected' => 'VP pricing rejected',
        'convertSoBlocked' => 'Cannot convert to Sales Order until President and VP pricing have both approved this quotation.',
        'submitForReview' => 'Submit for review',
        'submitForReviewConfirm' => 'Send this quotation to President and VP pricing for internal approval?',
        ...
        'presidentReviewApprove' => 'President approve',
        'presidentReviewReject' => 'President reject',
        'vpPricingReviewApprove' => 'VP pricing approve',
        'vpPricingReviewReject' => 'VP pricing reject',
        'vpReviewRequiresPresident' => 'President must approve the recipe before VP pricing review.',
        ...
        'timelinePresident_approved' => 'President approved',
        'timelinePresident_rejected' => 'President rejected',
        'timelinePresident_pending' => 'President review',
        'timelineVp_approved' => 'VP pricing approved',
        'timelineVp_rejected' => 'VP pricing rejected',
        'timelineVp_pending' => 'VP pricing review',
        'bomNoComponents' => 'No products with type Raw material, Semi-finished, or Packaging in this company. Purchase → Products: set Product type on each item (Finished goods will not appear here). You can still type material names manually below.',
        'bomMaterialRequired' => 'Each BOM line needs a product or material name.',
        'bomQuantityRequired' => 'BOM line quantity must be greater than zero.',
        'bomUnitCostRequired' => 'BOM line unit cost must be zero or greater.',
    ],
    'credit-notes' => [
        'total' => 'Total',
    ...
    'accountSettings' => [
        ...
        'aiWorkspacePageHelp' => 'Configure the AI Workspace page opened from the sidebar. Leave both Agent ID and API base empty to hide the AI Workspace menu item.',
        ...
        'aiAssistantWidgetHelp' => 'Configure the floating AI Assistant chat widget for all company admins and super admins. Leave both Agent ID and API base empty to hide the AI Assistant Widget menu (same visibility rules as AI Workspace).',
        'aiAssistantWidgetAgentId' => 'AI agent ID',
        'aiAssistantWidgetApiBase' => 'AI API base URL',
        'aiAssistantWidgetApiBasePlaceholder' => 'https://ai.example.com',
        'aiAssistantWidgetApiKey' => 'AI API key (optional)',
        'aiAssistantWidgetApiKeyPlaceholder' => 'Leave blank to keep the current key',
        'aiAssistantWidgetApiKeyHelp' => 'Optional. Only enter a new key when you want to replace the stored key.',
        'aiAssistantWidgetRemoveApiKey' => 'Remove stored API key',
    ],
    ...
    'module' => [
        ...
        'estimates_phase1_review' => 'OEM quotation review (2-step approval)',
    ...
    'invoiceSettings' => [
        ...
        'phase1MinGrossMarginPercent' => 'Minimum gross margin for VP approval (OEM)',
        'phase1MinGrossMarginPercentHelp' => 'When OEM quotation review is enabled, VP cannot approve if gross margin from BOM is below this percent. Leave empty to use the server default.',
