    ...
    <x-form id="updateSalary" method="POST">
        ...
        <div class="form-body">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <x-forms.number fieldId="amount" class="annualIncrementAmount" :fieldLabel="__('payroll::modules.payroll.annualIncrementAmount')" :fieldValue="$employeeSalary->annual_salary" fieldName="annual_salary" fieldRequired="true">
                    </x-forms.number>
                </div>

                <div class="col-lg-4">
                    <x-forms.datepicker fieldId="date" fieldRequired="true" :fieldLabel="__('payroll::modules.payroll.incrementDate')" fieldName="date" :fieldValue="$employeeSalary->date->timezone(company()->timezone)->format(company()->date_format)" :fieldPlaceholder="__('placeholders.date')" />
                </div>
...
<script>
    ...
    $('#update-salary').click(function() {
        ...
        window.apiHttp.postUrlEncoded(url, $('#updateSalary').serialize())
