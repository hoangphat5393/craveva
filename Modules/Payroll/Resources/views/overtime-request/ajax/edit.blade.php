    ...
    <x-form id="overtimeHoursUpdateForm" method="POST">
        ...
        <div class="form-body">
            ...
            <div class="pt-20 pr-20 row">
                <div class="col-lg-3">
                    <x-forms.text class="date-picker" :fieldLabel="__('app.date')" fieldName="date" fieldId="dateField" :fieldPlaceholder="__('app.date')" fieldValue="{{ $overtimeRequest->date->format(company()->date_format) }}" fieldRequired="true" />
                </div>
                <!-- Overtime Type Field -->
                <div class="col-md-3">
                ...
                <div class="col-md-3 col-lg-3" id="set-time-estimate-fields">
                    <div class="form-group mt-5">
                        <input type="number" min="0" class="w-25 border rounded p-2 height-35 f-14" name="overtime_hours" value="{{ $overtimeRequest->hours }}">
                        @lang('app.hrs')
                        &nbsp;&nbsp;
                        <input type="number" min="0" name="minutes" value="{{ $overtimeRequest->minutes }}" class="w-25 height-35 f-14 border rounded p-2">
                        @lang('app.mins')
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="my-3 form-group">
                        <x-forms.text :fieldLabel="__('app.reason')" fieldName="overtime_reasons" fieldId="overtime_reasons" :fieldPlaceholder="__('app.reason')" fieldValue="{{ $overtimeRequest->overtime_reason }}" fieldRequired="false" />
                    </div>
                </div>
...
<script>
    ...
    $('#save-request').click(function(e) {
        ...
        window.apiHttp.postUrlEncoded(url, $('#overtimeHoursUpdateForm').serialize())
