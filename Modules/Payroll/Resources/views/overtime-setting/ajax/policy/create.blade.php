            ...
            <div class="form-body">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select-picker" name="pay_code" id="pay_code" data-live-search="true" data-size="8">
                                @foreach ($payCodes as $payCode)
                                    <option value="{{ $payCode->id }}">{{ $payCode->name }} ({{ $payCode->code }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 my-2">
                        <x-forms.checkbox :fieldLabel="__('payroll::modules.payroll.policyWorkingDays')" fieldName="working_days" fieldId="working_days" fieldRequired="true" fieldValue="yes" />

                        <x-forms.checkbox :fieldLabel="__('payroll::modules.payroll.policyWeekOffDays')" fieldName="week_end" fieldId="week_end" fieldRequired="true" fieldValue="yes" />

                        <x-forms.checkbox :fieldLabel="__('payroll::modules.payroll.policyHolidayDays')" fieldName="holiday" fieldId="holiday" fieldValue="yes" />
                    </div>
                    ...
                    <div class="col-lg-12 my-2">
                        <x-forms.checkbox :fieldLabel="__('payroll::modules.payroll.allowReportingManager')" fieldName="allow_reporting_manager" fieldId="allow_reporting_manager" fieldValue="yes" />
                    </div>
...
<script>
    ...
    $('#savePolicy').click(function(e) {
        ...
        window.apiHttp.postUrlEncoded("{{ route('overtime-policies.store') }}", $('#addOvertimePolicy').serialize())
