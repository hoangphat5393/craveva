    ...
    <div class="portlet-body">
        <x-form id="updateOvertimePolicy" method="POST" class="ajax-form">
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <x-forms.text fieldId="name" :fieldLabel="__('app.name')" :fieldValue="$policy->name" fieldName="name" fieldRequired="true">
                        </x-forms.text>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select-picker" name="pay_code" id="pay_code" data-live-search="true" data-size="8">
                    ...
                    <div class="col-lg-12 my-2">
                        <x-forms.checkbox :fieldLabel="__('payroll::modules.payroll.policyWorkingDays')" fieldName="working_days" fieldValue="yes" fieldId="working_days" fieldRequired="true" :checked="$policy ? $policy->working_days : ''" />

                        <x-forms.checkbox :fieldLabel="__('payroll::modules.payroll.policyWeekOffDays')" fieldName="week_end" fieldValue="yes" fieldId="week_end" fieldRequired="true" :checked="$policy ? $policy->week_end : ''" />

                        <x-forms.checkbox :fieldLabel="__('payroll::modules.payroll.policyHolidayDays')" fieldName="holiday" fieldValue="yes" fieldId="holiday" :checked="$policy ? $policy->holiday : ''" />
                    </div>
                    ...
                    <div class="col-lg-12 my-2">
                        <x-forms.checkbox :fieldLabel="__('payroll::modules.payroll.allowReportingManager')" fieldName="allow_reporting_manager" fieldValue="yes" fieldId="allow_reporting_manager" :checked="$policy ? $policy->allow_reporting_manager : ''" />
                    </div>
...
<script>
    ...
    $('#updatePolicy').click(function(e) {
        ...
        window.apiHttp.postUrlEncoded("{{ route('overtime-policies.update', $policy->id) }}", $('#updateOvertimePolicy').serialize())
