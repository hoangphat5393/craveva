                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 active pay-code" href="{{ route('payroll.overtime_settings') }}?tab=pay-code" role="tab" aria-controls="nav-salaryGroups" aria-selected="true" ajax="false">@lang('payroll::app.menu.payCode')
                            </a>
                            <a class="nav-item nav-link f-15  overtime-policy" href="{{ route('payroll.overtime_settings') }}?tab=overtime-policy" role="tab" aria-controls="nav-salaryComponents" aria-selected="true" ajax="false">@lang('payroll::app.menu.overtimePolicy')
                            </a>
                            <a class="nav-item nav-link f-15 overtime-policy-employee" href="{{ route('payroll.overtime_settings') }}?tab=overtime-policy-employee" role="tab" aria-controls="nav-salaryTds" aria-selected="true" ajax="false">@lang('payroll::app.menu.overtimePolicyEmployee')
                            </a>
                            <a class="nav-item nav-link f-15 employee-hourly-rate" href="{{ route('payroll.overtime_settings') }}?tab=employee-hourly-rate" role="tab" aria-controls="nav-paymentMethods" aria-selected="true" ajax="false">
            ...
            <x-slot name="buttons">
                ...
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <x-forms.button-primary icon="plus" id="addPolicy" class="overtime-policy-btn mb-2 d-none actionBtn">
                            @lang('app.addNew') @lang('payroll::app.menu.overtimePolicy')
                        </x-forms.button-primary>

                        <x-forms.button-primary icon="plus" id="payCode" class="pay-code-btn mb-2 d-none actionBtn">
                            @lang('app.addNew') @lang('payroll::app.menu.payCode')
                        </x-forms.button-primary>

                        <x-forms.button-primary icon="plus" id="overtimeRequest" class="overtime-request-btn mb-2 d-none actionBtn mr-3">
