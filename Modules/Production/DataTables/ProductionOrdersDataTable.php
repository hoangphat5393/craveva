...
class ProductionOrdersDataTable extends BaseDataTable
{
    ...
    public function dataTable($query): DataTableAbstract
    {
        ...
        $datatables->addColumn('action', function (ProductionOrder $row): string {
            ...
            if ($canEdit) {
                $action .= '<a class="dropdown-item openRightModal" href="' . route('production.orders.edit', [$row->id]) . '" data-redirect-url="' . e(route('production.orders.index')) . '"><i class="fa fa-edit mr-2 text-dark-grey"></i>' . e(__('app.edit')) . '</a>';
            }
