...
class PurchaseProductsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $datatables->editColumn('stock_on_hand', function ($row) {
            return $this->formatStockOnHand($row);
        });
    ...
    protected function formatStockOnHand(object $row): float|string
    {
        if ($row->stock_on_hand !== null) {
            return (float) $row->stock_on_hand;
        }
    ...
    protected function getColumns()
    {
        ...
        $data = [
            ...
            __('purchase::modules.product.dataTableImage') => ['data' => 'default_image', 'name' => 'default_image', 'title' => __('purchase::modules.product.dataTableImage'), 'exportable' => false],
            ...
            __('purchase::modules.product.dataTablePriceInclusiveTax') => ['data' => 'price', 'name' => 'price', 'title' => __('purchase::modules.product.dataTablePriceInclusiveTax')],
        ...
        $customFieldMerge = $this->customFieldColumns();
    ...
    protected function customFieldColumns(): array
    {
        ...
        return array_diff_key($customFieldMerge, array_flip($excludeKeys));
    }
}
