        ...
        <div class="px-3 pt-3 row px-lg-4 px-md-4">
            ...
            <div class="col-md-4">
                <div class="mb-4 form-group mb-lg-0 mb-md-0">
                    ...
                    <x-forms.input-group>
                        <x-slot name="prepend">
                            <span class="input-group-text">{{ $purchaseSetting->bill_prefix }}{{ $purchaseSetting->bill_number_separator }}{{ $zero }}</span>
                        </x-slot>
                        <input type="number" name="bill_number" id="bill_number" class="form-control height-35 f-15" value="{{ is_null($lastBill) ? 1 : $lastBill }}">
                    </x-forms.input-group>
                </div>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="rounded select-others height-35">
                    ...
                    @endif
                    <select @if ($vendorID) disabled @endif class="form-control select-picker" id="vendor-id" name ="vendor_id" data-live-search="true" data-size="8">
            ...
            <div class="col-md-4">
                <div class="mb-4 form-group mb-lg-0 mb-md-0">
                    ...
                    <div class="input-group">
                        <input type="text" id="bill_date" name="issue_date" class="p-0 px-6 text-left rounded position-relative text-dark font-weight-normal form-control height-35 f-15" placeholder="@lang('placeholders.date')" value="{{ now(company()->timezone)->translatedFormat(company()->date_format) }}">
                    </div>
                </div>
            </div>
            <!-- BILL DATE END -->
        ...
        <div class="px-3 py-3 row px-lg-4 px-md-4">
            <div class="col-md-3">
                <div class="mb-2 form-group c-inv-select">
                    <x-forms.select fieldId="purchase-order" :fieldLabel="__('purchase::app.purchaseOrder.purchaseOrder')" fieldName="purchase_order_id" search="true">
                        @if (isset($type) && $type == 'order')
...
<script>
    $(document).ready(function() {
        ...
        $('.save-form').click(function() {
            ...
            $.easyBlockUI('#save-bill-data-form');
            window.apiHttp.postUrlEncoded("{{ route('bills.store') }}" + "?type=" + type, $('#save-bill-data-form').serialize())
                .then(function(response) {
