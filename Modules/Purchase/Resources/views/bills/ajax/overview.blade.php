                ...
                <tr class="inv-unpaid">
                    <td class="f-14 text-dark">
                        <p class="mb-0 text-left">
                            ...
                            @if ($purchaseBill->purchaseVendor && $purchaseBill->purchaseVendor->billing_address)
                    ...
                    @if ($purchaseBill->purchaseVendor && $purchaseBill->purchaseVendor->shipping_address)
                        <td align="right" class="f-14 text-black">
                            <p>
                                <span class="text-dark-grey ">@lang('app.shippingAddress')</span><br>
                                {!! nl2br($purchaseBill->purchaseVendor->shipping_address) !!}
                            </p>
                        </td>
                    @endif
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <table class="inv-detail f-14 table-responsive-sm" width="100%">
                                ...
                                @if ($item->type == 'item')
                                    ...
                                    @if ($item->item_summary || $item->purchaseItemImage)
                                        <tr class="text-dark f-12">
                                            <td colspan="{{ invoice_setting()->hsn_sac_code_show ? '6' : '5' }}" class="border-bottom-0">
                            ...
                            <td colspan="4" class="blank-td border-bottom-0 border-left-0 border-right-0"></td>
        ...
        <div class="d-flex">
            <div class="inv-action mr-3 mr-lg-3 mr-md-3 dropup">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" tabindex="0">
                    ...
                    @if (($editBillPermission == 'all' || ($editBillPermission == 'added' && user()->id == $purchaseBill->added_by)) && $purchaseBill->status != 'paid')
                        <li>
                            <a class="dropdown-item f-14 text-dark" href="{{ route('bills.edit', [$purchaseBill->id]) }}">
                    ...
                    <li>
                        <a class="dropdown-item f-14 text-dark" href="{{ route('bills.download', [$purchaseBill->id]) }}">
