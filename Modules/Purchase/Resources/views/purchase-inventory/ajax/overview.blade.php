        ...
        <x-cards.data :title="__('purchase::modules.inventory.inventoryInfo')">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <x-forms.custom-field-show :fields="$fields" :model="$inventory"></x-forms.custom-field-show>
                </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0" aria-labelledby="dropdownMenuLink" tabindex="0">
                                    ...
                                    @if ($viewPermission == 'all' || $viewPermission == 'added')
                                        <a class="dropdown-item f-14 text-dark" href="{{ route('purchase_inventory.download', [$inventory->id]) }}">
                                    ...
                                    @if ($deletePermission == 'all' || $deletePermission == 'added')
                                        <a class="dropdown-item delete-table-row" href="javascript:;" data-id="{{ $inventory->id }}"><i class="fa fa-trash f-w-500  mr-2 f-12"></i>
                                            @lang('app.delete')
                                        </a>
                                    @endif
                                </div>
