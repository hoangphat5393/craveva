...
<body class="content-wrapper">
    <table class="bg-white" border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
        <tbody>
            <!-- Table Row Start -->
            <tr>
                <td><img src="{{ $invoiceSetting->logo_url }}" alt="{{ mb_ucwords($company->company_name) }}" id="logo" /></td>
    ...
    <table width="100%" class="f-14 b-collapse">
        ...
        <tr class="main-table-heading text-grey">
            <td width="60%">@lang('purchase::app.itemName')</td>
            @if ($inventory->type == 'quantity')
                <td align="right">@lang('purchase::modules.product.quantityOnHand')</td>
                <td align="right">@lang('purchase::modules.product.quantityAdjusted')</td>
            @else
