...
<div class="tab-pane fade show active mt-5" role="tabpanel" aria-labelledby="nav-email-tab">
    ...
    <x-cards.data :title="__('modules.projects.files')">
        ...
        <div class="row" id="add-btn">
            <div class="col-md-12">
                <a class="f-15 f-w-500" href="javascript:;" id="add-order-file"><i class="icons icon-plus font-weight-bold mr-1"></i>@lang('modules.projects.uploadFile')</a>
            </div>
        </div>
                    ...
                    <x-slot name="action">
                        <div class="dropdown ml-auto file-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0" aria-labelledby="dropdownMenuLink" tabindex="0">
                                ...
                                <a class="cursor-pointer d-block text-dark-grey f-13 py-3 px-3 " href="{{ route('purchase_order_file.download', md5($file->id)) }}">@lang('app.download')</a>
                                {{-- @endif --}}
