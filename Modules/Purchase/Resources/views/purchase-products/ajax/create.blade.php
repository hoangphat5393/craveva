                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6" id="sku_id">
                                <x-forms.text fieldId="sku" :fieldLabel="__('purchase::app.sku')" fieldName="sku" fieldRequired="true" :fieldValue="$product ? $product->sku : ''" :fieldPlaceholder="__('placeholders.hsnSac')">
                                </x-forms.text>
                            </div>
