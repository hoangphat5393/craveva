        ...
        <x-form id="import-purchase-product-data-form">
            <div class="bg-white rounded">
                ...
                <div class="row py-20">
                    ...
                    <div class="col-md-12">
                        <x-forms.toggle-switch class="mr-0 mr-lg-12" :fieldLabel="__('modules.import.containsHeadings')" fieldName="heading"
                            fieldId="heading" />
                    </div>
                </div>
                <x-form-actions>
                    <x-forms.button-primary id="import-purchase-product-form" class="mr-3"
