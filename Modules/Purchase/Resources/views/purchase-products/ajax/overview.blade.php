            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    @if ($product->downloadable && !in_array('client', user_roles()))
                        <x-cards.data-row :label="__('app.downloadableFile')" :value="'<a href='.$product->download_file_url.' download><span class=\'badge badge-success\'>' . __('app.view') . '</span></a>'" />
                    @endif
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0" aria-labelledby="dropdownMenuLink" tabindex="0">
                                @if (($product->type == 'goods' && $editInventoryPermission == 'all') || $editInventoryPermission == 'added')
                                    <a class="dropdown-item" id="stock-adjustment">@lang('purchase::app.adjustStock')</a>
                                @endif
                                <a class="dropdown-item openRightModal" href="{{ route('purchase-products.edit', $product->id) }}">@lang('app.edit')</a>
