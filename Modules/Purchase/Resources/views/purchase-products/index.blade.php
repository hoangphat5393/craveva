...
@section('filter-section')
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status d-flex">
                <x-filters.select name="product_type" id="product_type">
                    <option value="all">@lang('app.all')</option>
        ...
        <div class="d-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addProductPermission == 'all' || $addProductPermission == 'added')
                    <x-forms.link-primary :link="route('purchase-products.create')" class="mr-3 openRightModal float-left" icon="plus">
                        @lang('app.add')
                        @lang('app.product')
                    </x-forms.link-primary>
                    <x-forms.link-secondary :link="route('purchase-products.import')" class="mr-3 openRightModal float-left" icon="file-upload">
