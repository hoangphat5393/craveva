<div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-4 ">
    ...
    <div class="row">
        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.purchaseOrderPrefix')" :fieldPlaceholder="__('purchase::modules.purchaseSettings.purchaseOrderPrefix')" fieldName="purchase_order_prefix" fieldId="purchase_order_prefix" :fieldValue="$purchaseSetting->purchase_order_prefix" fieldRequired="true" />
        </div>

        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.purchaseOrderNumberSeprator')" :fieldPlaceholder="__('purchase::modules.purchaseSettings.purchaseOrderNumberSeprator')" fieldName="purchase_order_number_seprator" fieldId="purchase_order_number_seprator" :fieldValue="$purchaseSetting->purchase_order_number_separator" />
        </div>

        <div class="col-lg-3">
            <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.purchaseOrderDigits')" fieldName="purchase_order_digit" fieldId="purchase_order_digit" :fieldValue="$purchaseSetting->purchase_order_number_digit" minValue="2" />
        </div>

        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.purchaseOrderExample')" fieldId="purchase_order_look_like" fieldName="purchase_order_look_like" fieldReadOnly="true" />
        </div>

        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.billOrderPrefix')" :fieldPlaceholder="__('purchase::modules.purchaseSettings.billOrderPrefix')" fieldName="bill_prefix" fieldRequired="true" fieldId="bill_prefix" :fieldValue="$purchaseSetting->bill_prefix" />
        </div>

        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.billOrderNumberSeprator')" :fieldPlaceholder="__('purchase::modules.purchaseSettings.billOrderNumberSeprator')" fieldName="bill_number_seprator" fieldId="bill_number_seprator" :fieldValue="$purchaseSetting->bill_number_separator" />
        </div>

        <div class="col-lg-3">
            <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.billOrderDigits')" fieldName="bill_digit" fieldId="bill_digit" :fieldValue="$purchaseSetting->bill_number_digit" minValue="2" />
        </div>

        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.billOrderExample')" fieldName="bill_look_like" fieldId="bill_look_like" fieldValue="" fieldReadOnly="true" />
        </div>

        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.venodrCreditPrefix')" :fieldPlaceholder="__('purchase::modules.purchaseSettings.venodrCreditPrefix')" fieldName="vendor_credit_prefix" fieldRequired="true" fieldId="vendor_credit_prefix" :fieldValue="$purchaseSetting->vendor_credit_prefix" />
        </div>
        <div class="col-lg-3">
            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.venodrCreditNumberSeprator')" :fieldPlaceholder="__('purchase::modules.purchaseSettings.venodrCreditNumberSeprator')" fieldName="vendor_credit_number_seprator" fieldId="vendor_credit_number_seprator" :fieldValue="$purchaseSetting->vendor_credit_number_seprator" />
        </div>
        <div class="col-lg-3">
            <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('purchase::modules.purchaseSettings.vendorCreditDigits')" fieldName="vendor_credit_digit" fieldId="vendor_credit_digit" :fieldValue="$purchaseSetting->vendor_credit_number_digit" minValue="2" />
        </div>
        <div class="col-lg-3">
