        ...
        <div class="col-md-4">
            <div class="form-group mb-lg-0 mb-md-0 mb-4 mt-3">
                ...
                <x-forms.input-group>
                    ...
                    <input type="number" name="payment_made" id="payment_made" onkeyup="updateAmountPaid(this.value)" class="form-control height-35 f-15" value="">
                </x-forms.input-group>
            </div>
        </div>
        <div class="col-md-4">
            <x-forms.datepicker fieldId="payment_date" :fieldLabel="__('purchase::modules.vendorPayment.paymentDate')" fieldName="payment_date" :fieldValue="now($company->timezone)->format($company->date_format)" :fieldPlaceholder="__('placeholders.date')" />
        </div>
        <div class="col-md-4">
