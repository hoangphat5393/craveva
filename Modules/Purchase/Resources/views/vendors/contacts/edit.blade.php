        ...
        <x-form id="save-contact-data-form" method="PUT">
            <div class="add-contact bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-4">
                        <x-forms.text fieldId="contact_name" :fieldLabel="__('modules.contacts.contactName')" fieldName="contact_name" fieldRequired="true" :fieldPlaceholder="__('placeholders.name')" :fieldValue="$contact->contact_name">
                        </x-forms.text>
                    </div>
                    <div class="col-md-4">
                        <x-forms.email fieldId="email" :fieldLabel="__('app.email')" fieldName="email" fieldRequired="true" :fieldPlaceholder="__('placeholders.email')" :fieldValue="$contact->email"></x-forms.email>
                    </div>
                    <div class="col-md-4">
                        <x-forms.text fieldId="phone" :fieldLabel="__('app.phone')" fieldName="phone" :fieldPlaceholder="__('placeholders.mobile')" :fieldValue="$contact->phone">
                        </x-forms.text>
                    </div>
                </div>
