...
trait QrTypes
{
    ...
    public static function paypal($email, $itemName, $amount, $itemId, $type = '_xclick', $currencyCode = 'USD', $shipping = null, $tax = null)
    {
    ...
    public static function upi(string $upiId, int|float|null $amount = null, ?string $name = null, ?string $description = null, string $currency = 'INR')
    {
