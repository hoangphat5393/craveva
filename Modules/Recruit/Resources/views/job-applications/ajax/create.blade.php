                ...
                <div class="row p-20">
                    <div id="firstDiv" class="col-lg-9 col-xl-10">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <select @if ($jobId) disabled @endif name="job_id" id="job_id" class="form-control select-picker" data-size="8">
                                        <option value="">--</option>
                                        @foreach ($jobs as $job)
                                            <option @if ($jobId && $job->id == $jobId) selected @endif value="{{ $job->id }}">{{ $job->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <x-forms.text fieldId="name" :fieldLabel="__('recruit::modules.jobApplication.name')" fieldName="full_name" fieldRequired="true" :fieldPlaceholder="__('placeholders.name')">
                                </x-forms.text>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <x-forms.tel fieldId="phone" :fieldLabel="__('app.phone')" fieldName="phone" fieldPlaceholder="e.g. 987654321" fieldRequired="true"></x-forms.tel>
                            </div>
                            <div class="col-md-3" id="gender-div">
                                <x-forms.select fieldId="gender" fieldRequired="true" :fieldLabel="__('recruit::modules.jobApplication.gender')" fieldName="gender">
                                    <option value="">--</option>
                            ...
                            <div class="col-md-3">
                                <x-forms.select fieldId="location_id" fieldRequired="true" fieldName="location_id" :fieldLabel="__('recruit::modules.jobApplication.location')">
                                    <option value="">--</option>
                                    @if ($jobId)
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="mb-4">
                                    <select name="total_experience" class="form-control select-picker" id="total_experience" data-live-search="true" data-container="body" data-size="8">
                                        <option value="">--</option>
                            ...
                            <div class="col-md-3 current">
                                <x-forms.label class="my-3" fieldId="current" :fieldLabel="__('recruit::modules.jobApplication.currentCtc')"></x-forms.label>
                                <span class="f-14 text-dark-grey" id="currency-symbol"></span>
                                <x-forms.input-group>
                                    <input type="number" min="0" class="form-control height-35 f-14" name="current_ctc" placeholder="@lang('recruit::modules.jobApplication.currentCtcPlaceHolder')">
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-md-3 expected">
                                <x-forms.label class="my-3" fieldId="expected" :fieldLabel="__('recruit::modules.jobApplication.expectedCtc')"></x-forms.label>
                                <span class="f-14 text-dark-grey" id="currency-symbol-1"></span>
                                <x-forms.input-group>
                                    <input type="number" min="0" class="form-control height-35 f-14" name="expected_ctc" placeholder="@lang('recruit::modules.jobApplication.expectedCtcPlaceHolder')">
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-md-3">
                                <x-forms.text fieldId="current_location" :fieldLabel="__('recruit::modules.jobApplication.currentLocation')" fieldName="current_location" :fieldPlaceholder="__('recruit::modules.jobApplication.currentLocationPlaceholder')">
                                </x-forms.text>
                            </div>
                            ...
                            <div class="col-md-3">
                                <x-forms.select fieldId="status_id" fieldName="status_id" :fieldLabel="__('recruit::modules.jobApplication.status')">
                                    @foreach ($applicationStatus as $status)
                                        <option @if ($status->id == $statusId) selected @endif value="{{ $status->id }}" data-content="<i class='fa fa-circle mr-2' style='color: {{ $status->color }}'></i> {{ $status->status }}"></option>
                                    @endforeach
                                </x-forms.select>
                            </div>

                            <div class="col-md-3" id="dob">
                                <x-forms.text class="date-picker" :fieldRequired="true" :fieldLabel="__('recruit::modules.jobApplication.dateOfBirth')" fieldName="date_of_birth" fieldId="date_of_birth-1" :fieldPlaceholder="__('placeholders.date')" fieldValue="" />
                            </div>
                    ...
                    <div class="col-lg-3 col-xl-2" id="photo">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.profile.profilePicture')" fieldName="photo" :fieldRequired="true" fieldId="photo" fieldHeight="119" />
                    </div>

                    <div class="col-md-12">
                        <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('recruit::modules.jobApplication.coverLetter')" fieldName="cover_letter" fieldId="cover_letter" :fieldPlaceholder="__('recruit::modules.jobApplication.coverLetter')">
                        </x-forms.textarea>
                    </div>
                    <div class="col-md-12" id="resume1">
                        <div class="form-group my-3">
                            <x-forms.label fieldId="resume" fieldRequired="true" :fieldLabel="__('recruit::app.menu.add') . ' ' . __('recruit::app.jobApplication.resume')" class="mt-3"></x-forms.label>
                            <input type="file" class="dropify" name="resume" data-allowed-file-extensions="txt pdf doc xls xlsx docx rtf png jpg jpeg svg" data-messages-default="test" data-height="150" />
