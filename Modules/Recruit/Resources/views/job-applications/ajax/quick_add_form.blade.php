        ...
        <div class="table-responsive">
            <x-table>
                ...
                <tr>
                    ...
                    <td>
                        <x-forms.input-group>
                            <input type="text" min="0" class="form-control height-35 f-12 input-width" name="full_name" id="name" placeholder="@lang('placeholders.name')">
                        </x-forms.input-group>
                    </td>
                    ...
                    @if (in_array('email', $formFields))
                        <td>
                            <x-forms.input-group>
                                <input type="text" min="0" class="form-control height-35 f-12 input-width" name="email" placeholder="@lang('placeholders.email')">
                            </x-forms.input-group>
                        </td>
                    @endif
                    ...
                    @if (in_array('phone', $formFields))
                        <td>
                            <x-forms.input-group>
                                <input type="text" min="0" class="form-control height-35 f-12 input-width" name="phone" placeholder="@lang('placeholders.mobile')">
                            </x-forms.input-group>
                        </td>
                    @endif
                    ...
                    @if (in_array('current_location', $formFields))
                        <td>
                            <x-forms.input-group>
                                <input type="text" min="0" class="form-control height-35 f-12 input-width" name="current_location" placeholder="@lang('recruit::modules.jobApplication.currentLocationPlaceholder')">
                            </x-forms.input-group>
                        </td>
                    @endif
                    ...
                    @if (in_array('current_ctc', $formFields))
                        <td>
                            <x-forms.input-group>
                                <input type="number" min="0" class="form-control height-35 f-12 input-width" name="current_ctc" placeholder="@lang('recruit::modules.jobApplication.currentCtcPlaceHolder')">
                            </x-forms.input-group>
                        </td>
                    @endif
                    ...
                    @if (in_array('expected_ctc', $formFields))
                        <td>
                            <x-forms.input-group>
                                <input type="number" min="0" class="form-control height-35 f-12 input-width" name="expected_ctc" placeholder="@lang('recruit::modules.jobApplication.expectedCtcPlaceHolder')">
                            </x-forms.input-group>
                        </td>
                    @endif
