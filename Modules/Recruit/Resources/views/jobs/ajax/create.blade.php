            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-3">
                                <x-forms.text fieldId="heading" :fieldLabel="__('recruit::modules.job.jobTitle')" fieldName="title" fieldRequired="true" :fieldValue="$job ? $job->title : ''" :fieldPlaceholder="__('recruit::modules.job.jobTitle')">
                                </x-forms.text>
                            </div>

                            <div class="col-md-3">
                                <x-forms.label fieldRequired="true" class="mt-3" fieldId="job-category" :fieldLabel="__('recruit::modules.job.job') . ' ' . __('app.category')">
                                </x-forms.label>
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="category_id" id="category_id" data-live-search="false">
                                        <option value="">--</option>
                                        @foreach ($categories as $category)
                                            <option @if (!is_null($job) && $category->id == $job->recruit_job_category_id) selected @endif value="{{ $category->id }}">{{ $category->category_name }}</option>
                                        @endforeach
                                    </select>

                                    @if ($addJobCategoryPermission == 'all')
                                        <x-slot name="append">
                                            <button type="button" class="btn btn-outline-secondary border-grey job-category-add">@lang('app.add')</button>
                                        </x-slot>
                                    @endif
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-md-3">
                                <x-forms.label fieldRequired="true" class="mt-3" fieldId="sub_category_id" :fieldLabel="__('recruit::modules.job.job') . ' ' . __('recruit::modules.job.subCategory')"></x-forms.label>
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="sub_category_id" id="sub_category_id" data-live-search="true">
                                        <option value="">--</option>
                                        @foreach ($Subcategories as $category)
                                            <option @if (!is_null($job) && $category->id == $job->recruit_job_sub_category_id) selected @endif value="{{ $category->id }}">{{ $category->sub_category_name }}</option>
                                        @endforeach
                                    </select>

                                    @if ($addJobSubCategoryPermission == 'all')
                                        <x-slot name="append">
                                            <button type="button" class="btn btn-outline-secondary border-grey job-sub-category-add">@lang('app.add')</button>
                                        </x-slot>
                                    @endif
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control multiple-users" multiple name="skill_id[]" id="selectEmployeeData" data-live-search="true" data-size="8">
                                        @foreach ($skills as $skill)
                                            <option data-content="<span class='badge badge-pill badge-light border'><div class='d-inline-block mr-1'></div> {{ $skill->name }}</span>" @if (!is_null($job) && isset($jobSkills) && in_array($skill->id, $jobSkills))
                                                selected
                                        @endif
                                    ...
                                    @if ($skillPermission == 'all')
                                        <x-slot name="append">
                                            <button type="button" class="btn btn-outline-secondary border-grey skill-setting">@lang('app.add')</button>
                                        </x-slot>
                                    @endif
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" multiple name="location_id[]" id="selectEmployee" data-live-search="true" data-size="8">
                                        @foreach ($locations as $location)
                                            <option data-content="<span class='badge badge-pill badge-light border'><div class='d-inline-block mr-1'></div> {{ $location->location }}</span>" @if (!is_null($job) && isset($jobLocation) && in_array($location->id, $jobLocation))
                                                selected
                                        @endif
                            ...
                            <div class="col-md-3">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control multiple-users" multiple name="stage_id[]" id="selectStages" data-live-search="true" data-size="8">
                                        @foreach ($stages as $stage)
                                            <option data-content="<span class='badge badge-pill badge-light border'><div class='d-inline-block mr-1'></div> {{ $stage->name }}</span>" @if (!is_null($job) && isset($jobInterviews) && in_array($stage->id, $jobInterviews))
                                                selected
                                        @endif
                                    ...
                                    @if ($addPermission == 'all' || $addPermission == 'added')
                                        <x-slot name="append">
                                            <button type="button" class="btn btn-outline-secondary border-grey interview-stage">@lang('app.add')</button>
                                        </x-slot>
                                    @endif
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-md-3">
                                <x-forms.datepicker fieldId="start_date" fieldRequired="true" :fieldLabel="__('modules.projects.startDate')" fieldName="start_date" :fieldValue="now($company->timezone)->format($company->date_format)" :fieldPlaceholder="__('placeholders.date')" />
                            </div>

                            <div class="col-md-3" id="endDateBox">
                                <x-forms.datepicker fieldId="end_date" fieldRequired="true" :fieldLabel="__('recruit::modules.job.endDate')" fieldName="end_date" :fieldValue="now($company->timezone)->format($company->date_format)" :fieldPlaceholder="__('placeholders.date')" />
                            </div>
                            <div class="col-md-6 col-lg-3">
                                <div class="form-group">
                                    <div class="d-flex mt-5">
                                        @if (!is_null($job))
                                            <x-forms.checkbox fieldId="without_end_date" :checked="$job->end_date == null ? true : false" :fieldLabel="__('recruit::modules.job.noEndDate')" fieldName="without_end_date" />
                                        @else
                                            <x-forms.checkbox fieldId="without_end_date" :fieldLabel="__('recruit::modules.job.noEndDate')" fieldName="without_end_date" />
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 position">
                                <x-forms.number fieldId="total_positions" :fieldLabel="__('recruit::modules.job.totalOpening')" :fieldValue="$job ? $job->total_positions : ''" fieldName="total_positions" fieldRequired="true">
                                    </x-forms.text>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3 recruiter">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="recruiter" id="fetch-recruiter" data-live-search="true">
                                        <option value="">--</option>
                                    ...
                                    @if ($addRecruiterPermission == 'all')
                                        <x-slot name="append">
                                            <button type="button" class="btn btn-outline-secondary border-grey recruiter-add">@lang('app.add')</button>
                                        </x-slot>
                                    @endif
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-md-3 jobtype">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="job_type_id" id="job-type" data-live-search="true">
                                        <option value="">--</option>
                                        @foreach ($jobTypes as $jobType)
                                            <option @if (!is_null($job) && $job->recruit_job_type_id == $jobType->id) selected @endif value="{{ $jobType->id }}">{{ $jobType->job_type }}</option>
                                        @endforeach
                                    </select>
                                    <x-slot name="append">
                                        <button type="button" class="btn btn-outline-secondary border-grey job-type">@lang('app.add')</button>
                                    </x-slot>
                                </x-forms.input-group>
                            </div>
                            ...
                            <div class="col-md-3 work_experience_1">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="work_experience" id="work_experience_1" data-live-search="true">
                                        <option value="">--</option>
                                        @foreach ($workExperience as $key => $experience)
                                            <option @if (!is_null($job) && $job->recruit_work_experience_id == $experience->id) selected @endif value="{{ $experience->id }}">{{ $experience->work_experience }}</option>
                                        @endforeach
                                    </select>
                                    <x-slot name="append">
                                        <button type="button" class="btn btn-outline-secondary border-grey work-experience">@lang('app.add')</button>
                                    </x-slot>
                                </x-forms.input-group>
                            </div>
                                    ...
                                    <div class="select-others height-35 rounded">
                                        <select class="form-control select-picker" name="currency_id" id="currency_id">
                                            @foreach ($currencies as $currency)
                                                <option @if ($company->currency->id == $currency->id) selected @endif value="{{ $currency->id }}">
                            ...
                            <div class="col-md-3 paytype">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="paytype" id="paytype" data-live-search="true">
                                        <option value="">--</option>
                            ...
                            <div class="col-md-6" id="amount_field">
                                <div class="row">
                                    <div class="col-md-6" id="start_amt">
                                        ...
                                        <x-forms.input-group>
                                            <input type="number" value="{{ $job ? $job->start_amount : '' }}" min="0" class="form-control height-35 f-14" name="start_amount" id="start_amount" :fieldValue="$job ? $job->start_amount : '' " fieldRequired>
                                        </x-forms.input-group>

                                    </div>
                                    <div class="col-md-6" id="end_amt">
                                        <x-forms.label fieldRequired="true" class="my-3" fieldId="endamtlabel" :fieldLabel="__('recruit::app.job.maxsal')"></x-forms.label>

                                        <x-forms.input-group>
                                            <input type="number" value="{{ $job ? $job->end_amount : '' }}" min="0" class="form-control height-35 f-14" name="end_amount" id="end_amount" fieldRequired>
                                        </x-forms.input-group>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 pay_according" id="payaccording">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="pay_according" id="pay_according" data-live-search="true">
                                        <option value="">--</option>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="form-group">
                                    <div class="d-flex mt-5">
                                        @if (!is_null($job))
                                            <x-forms.checkbox fieldId="remote_job" :checked="$job->remote_job == 'yes' ? true : false" :fieldLabel="__('recruit::modules.job.remoteJob')" fieldValue="yes" fieldName="remote_job" />
                                        @else
                                            <x-forms.checkbox fieldId="remote_job" :fieldLabel="__('recruit::modules.job.remoteJob')" fieldValue="yes" fieldName="remote_job" />
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="form-group">
                                    <div class="d-flex mt-5">
                                        <x-forms.checkbox fieldId="disclose_salary" :fieldLabel="__('recruit::modules.job.discloseSalary')" fieldValue="yes" fieldName="disclose_salary" />
                                    </div>
                                </div>
                            </div>
                            ...
                            @if ($job)
                                <div class="col-md-6">
                                    <x-forms.text fieldId="meta-title" :fieldLabel="__('recruit::modules.job.metaTitle')" fieldName="meta_title" fieldValue="{{ $job->meta_details ? $job->meta_details['title'] : '' }}" :fieldPlaceholder="__('recruit::modules.job.metaTitle')">
                                    </x-forms.text>
                                </div>

                                <div class="col-md-6">
                                    <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('recruit::modules.job.metaDescription')" fieldName="meta_description" fieldValue="{{ $job->meta_details ? $job->meta_details['description'] : '' }}" fieldId="meta_description" :fieldPlaceholder="__('recruit::modules.job.metaDescription')">
                                    </x-forms.textarea>
                                </div>
                            @endif
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <x-forms.label class="" fieldId="" :fieldLabel="__('recruit::modules.job.requiredColumn')" :popover="__('recruit::modules.job.requiredFiled')">
                                    </x-forms.label>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-2">
                                <div class="form-group">
                                    <div class="d-flex">
                                        <x-forms.checkbox :fieldLabel="__('recruit::modules.job.photoRequired')" fieldName="is_photo_require" fieldId="is_photo_require" fieldValue="1" :checked="$job ? $job->is_photo_require : ''" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-2">
                                <div class="form-group">
                                    <div class="d-flex ">
                                        <x-forms.checkbox :fieldLabel="__('recruit::modules.job.resumeRequired')" fieldName="is_resume_require" fieldId="is_resume_require" fieldValue="1" :checked="$job ? $job->is_resume_require : ''" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-2">
                                <div class="form-group">
                                    <div class="d-flex ">
                                        <x-forms.checkbox :fieldLabel="__('recruit::modules.jobApplication.dateOfBirth')" fieldName="is_dob_require" fieldId="is_dob_require" fieldValue="1" :checked="$job ? $job->is_dob_require : ''" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-2">
                                <div class="form-group">
                                    <div class="d-flex ">
                                        <x-forms.checkbox :fieldLabel="__('recruit::modules.jobApplication.gender')" fieldName="is_gender_require" fieldId="is_gender_require" fieldValue="1" :checked="$job ? $job->is_gender_require : ''" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-2">
                                <div class="form-group">
                                    <div class="d-flex ">
                                        <x-forms.checkbox :fieldLabel="__('recruit::modules.jobApplication.currentCtc')" fieldName="is_currentctc_require" fieldId="is_currentctc_require" fieldValue="1" :checked="$job ? $job->is_dob_require : ''" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-2">
                                <div class="form-group">
                                    <div class="d-flex ">
                                        <x-forms.checkbox :fieldLabel="__('recruit::modules.jobApplication.expectedCtc')" fieldName="is_expectedctc_require" fieldId="is_expectedctc_require" fieldValue="1" :checked="$job ? $job->is_expectedctc_require : ''" />
                                    </div>
                                </div>
                            </div>
