<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('recruit::app.menu.add') @lang('recruit::modules.job.job') @lang('recruit::modules.job.subCategory')</h5>
            ...
            <tr id="row-{{ $subcategory->id }}">
                ...
                <td class="text-right">
                    @if ($deletePermission == 'all' || $deletePermission == 'added')
                        <x-forms.button-secondary data-row-id="{{ $subcategory->id }}" icon="trash" class="delete-category">
                            @lang('app.delete')
    ...
    <x-form id="createJobSubCategory">
        <div class="row border-top-grey ">
            <div class="col-sm-12 col-md-6">
                <x-forms.select fieldId="recruit_job_category_id" :fieldLabel="__('recruit::modules.job.job') . ' ' . __('app.category')" fieldName="recruit_job_category_id" search="true" fieldRequired="true">
            ...
            <div class="col-sm-12 col-md-6">
                <x-forms.text fieldId="sub_category_name" :fieldLabel="__('recruit::modules.job.subCategory') . ' ' . __('app.name')" fieldName="sub_category_name" fieldRequired="true" :fieldPlaceholder="__('app.category') . ' ' . __('app.name')">
                </x-forms.text>
            </div>
