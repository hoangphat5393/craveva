...
<body class="content-wrapper">
    <table class="bg-white" border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
        <tbody>
            <!-- Table Row Start -->
            <tr>
                <td><img src="{{ $company->logo_url }}" alt="{{ $company->company_name }}" class="logo" /></td>
                <td align="right" colspan="2" class="f-21 text-black font-weight-700 text-uppercase">
                    @lang('recruit::modules.job.offerletter')</td>
            </tr>
            <!-- Table Row End -->
            <!-- Table Row Start -->
            <tr>
            ...
            <br>
            <tr class="f-14 text-black ">
                <td colspan="2"><b>@lang('recruit::modules.joboffer.candidateDetails')</b< /td>
            </tr>
            <tr width=100%>
            ...
            <br>
            <tr class="f-14 text-black ">
                <td colspan="2"><b>@lang('recruit::modules.joboffer.jobDetails')</b></td>
            </tr>
            <tr>
                <td class="f-14 text-grey" width="30%">
            ...
            <br>
            <tr class="f-14 text-black ">
                <td colspan="2"><b>@lang('recruit::modules.joboffer.offerDetail')</b></td>
            </tr>
            <tr>
                <td class="f-14 text-grey" width="30%">
                    ...
                    @if (is_null($salaryStructure))
                        <p class="line-height mb-0">
                            @if ($jobOffer->comp_amount)
                                {{ currency_format($jobOffer->comp_amount, $currency->id, false) }} @lang('recruit::modules.joboffer.per')
                                {{ $jobOffer->job->pay_according }}
                            @else
            ...
            <tr>
                ...
                <td class="f-14 text-grey" width="60%">
                    <p class="line-height mb-0">
                        {{ $jobOffer->job_expire ? $jobOffer->job_expire->translatedFormat($company->date_format) : '--' }}
                    </p>
                </td>
            </tr>
            <tr>
                            ...
                            @foreach ($selectedDeductionsComponent as $item)
                                <tr>
                                    ...
                                    <td class="text-right" align="right">
                                        {{ sprintf('%0.2f', $item->component_value) }}</td>
                                </tr>
                            @endforeach
        ...
        <div class="card-body" width="100%" style="text-align: center;">
            <div class="p-20 mt-3" style="text-align: center;">
                <div class="f-14 text-black" style="text-align: center;">
                    <p class="text-bold mb-0" style="text-align: center;">@lang('recruit::modules.joboffer.netSalary') :
                        {{ sprintf('%0.2f', $netSalary) . ' ' . $currency->currency_code }}</p>
    ...
    @if (!is_null($jobOffer->sign_image))
        <div style="text-align: right; margin-top: 10px;">
            ...
            <img src="{{ $jobOffer->file_url }}" class="" height="75px" alt="Signature" />
