    ...
    <div id="default-structure">
                    ...
                    <select class="form-control multiple-users" multiple name="component_id[]" id="selectComponentData" data-live-search="true" data-size="8">
                        <optgroup label="@lang('recruit::modules.joboffer.earning')">
                            @foreach ($earningComponents as $component)
                                <option data-content="<span class='badge badge-pill badge-light border'><div class='d-inline-block mr-1'></div> {{ $component->component_name }}</span>" value="{{ $component->id }}">{{ $component->component_name }}</option>
                            @endforeach
                        </optgroup>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <x-forms.input-group class="mt-2">
                    ...
                    <input type="number" class="form-control height-35 f-14" name="annual_salary" onmouseout="changeClc()" id="annual_salary" value="">
                </x-forms.input-group>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <x-forms.input-group>
                    <input type="number" value="" onmouseout="changeClc()" name="basic_salary" id="basic_value" class="form-control height-35 f-15">
                </x-forms.input-group>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <x-forms.input-group>
                                ...
                                <input type="text" class="form-control height-35 f-14" name="slack_username" value="{{ $payrollController->currencyFormatterCustom(0) }}" readonly>
