    ...
    <div class="portlet-body">
        <x-form id="createJobQuestions" method="POST" class="ajax-form">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <x-forms.select fieldId="category" :fieldLabel="__('modules.tasks.category')" fieldName="category" search="true">
                        <option value="job_application" data-content="@lang('recruit::app.report.jobapplication')"></option>
                        <option value="job_offer" data-content="@lang('recruit::app.menu.joboffer')"></option>
                    </x-forms.select>
                </div>

                <div class="col-lg-6">
                    <x-forms.text fieldId="question" :fieldLabel="__('recruit::modules.setting.question')" fieldName="question" fieldRequired="true" :fieldPlaceholder="__('recruit::modules.setting.question')">
                    </x-forms.text>
                </div>

                <div class="col-lg-6">
                    <x-forms.select fieldId="status" :fieldLabel="__('app.status')" fieldName="status" search="true">
                        <option value="enable" data-content="@lang('app.enable')"></option>
                        <option value="disable" data-content="@lang('app.disable')"></option>
                    </x-forms.select>
                </div>
