        ...
        <x-form id="editQuestion" method="POST" class="ajax-form">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group my-3">
                        ...
                        <select disabled class="form-control select-picker" data-size="8">
                            <option @if ($question->status == 'job_application') selected @endif value="job_application" data-content="@lang('recruit::app.report.jobapplication')"></option>
                            <option @if ($question->status == 'job_offer') selected @endif value="job_offer" data-content="@lang('recruit::app.menu.joboffer')"></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <x-forms.text fieldId="question" :fieldLabel="__('recruit::modules.setting.question')" fieldName="question" :fieldValue="$question->question" fieldRequired="true" :fieldPlaceholder="__('recruit::modules.setting.question')">
                    </x-forms.text>
                </div>
                ...
                <div class="col-lg-6">
                    <x-forms.select fieldId="status" :fieldLabel="__('app.status')" fieldName="status" search="true">
                        <option value="">--</option>
                        <option @if ($question->status == 'enable') selected @endif value="enable" data-content="@lang('app.enable')"></option>
                        <option @if ($question->status == 'disable') selected @endif value="disable" data-content="@lang('app.disable')"></option>
                    </x-forms.select>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group my-3">
                        ...
                        <div class="d-flex">
                            <x-forms.radio fieldId="optionsRadios1" :fieldLabel="__('app.yes')" fieldName="required" fieldValue="yes" :checked="$question->required == 'yes'">
                            </x-forms.radio>
                            <x-forms.radio fieldId="optionsRadios2" :fieldLabel="__('app.no')" fieldValue="no" fieldName="required" :checked="$question->required == 'no'"></x-forms.radio>
                        </div>
                    </div>
                </div>
