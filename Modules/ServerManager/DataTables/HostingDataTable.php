...
class HostingDataTable extends BaseDataTable
{
    ...
    public function query(ServerHosting $model)
    {
        ...
        $hostings = $model->withoutGlobalScope(CompanyScope::class)
            ...
            ->with(['assignedTo', 'createdBy', 'provider']);
    ...
    protected function getColumns()
    {
        return [
            ...
            __('servermanager::app.hosting.provider') => ['data' => 'hosting_provider', 'name' => 'hosting_provider', 'title' => __('servermanager::app.hosting.provider'), 'width' => '20%', 'orderable' => true, 'searchable' => true],
