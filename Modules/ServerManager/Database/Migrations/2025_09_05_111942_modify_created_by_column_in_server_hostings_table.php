...
return new class extends Migration
{
    ...
    public function up(): void
    {
        try {
            ...
            $this->setUnsignedIntNullable('server_hostings', 'created_by', true);
        } catch (\Throwable $th) {
        }
        ...
        try {
            ...
            $this->setUnsignedIntNullable('server_domains', 'created_by', true);
        } catch (\Throwable $th) {
        }
        ...
        try {
            ...
            $this->setUnsignedIntNullable('server_logs', 'performed_by', true);
        } catch (\Throwable $th) {
            // throw $th;
        }
    }
