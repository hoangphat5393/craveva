                ...
                <form class="form-horizontal form-material" method="POST" id="register">
                    ...
                    <div class="form-group removeable text-center m-t-20">
                        <div class="col-xs-6 text-center">
                            <button class="btn btn-custom btn-rounded text-uppercase waves-effect waves-light pl-5 pr-5" type="submit" id="submit-form" onclick="confirm();return false;">@lang('app.submit')</button>
                        </div>
                    ...
                    <div class="form-group mt-2">
                        <div class="col-sm-12 text-center">
                            ...
                            <span class="my-1">
                                <a href="{{ route('front.workspace') }}" class="text-primary f-w-500">
