            ...
            <div class="s-b-n-content">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-4">
                        ...
                        <form class="ajax-form mt-5" method="POST" id="editSettings">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="banned_subdomain" id="banned_subdomain" autocomplete="off" class="form-control height-35 f-14">

                                <div class="input-group-append">
                                    <span class="input-group-text f-14 bg-white-shade text-bold"> .{{ getDomain() }} </span>
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 ntfcn-tab-content-right border-left-grey p-4">
                        <h4 class="f-16 text-capitalize f-w-500 text-dark-grey">Banned Subdomain List</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="task_view mt-1 mt-lg-0 mt-md-0">
                                                    <a href="javascript:;" data-key-id="{{ $key }}" class="sa-params task_view_more d-flex align-items-center justify-content-center">
...
@push('scripts')
    <script>
        ...
        $('#save-form').click(function() {
            window.apiHttp.postUrlEncoded("{{ route('super-admin.post.banned-subdomains') }}", $('#editSettings').serialize())
                .catch(function(err) {
