...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (empty($module->description)) {
            $module->description = 'Warehouse Module';
            $module->save();
        }

        $permissions = [
            'view_warehouses' => Permission::ALL_NONE,
            'add_warehouses' => Permission::ALL_NONE,
            'edit_warehouses' => Permission::ALL_NONE,
            'delete_warehouses' => Permission::ALL_NONE,
            'view_warehouse_stock' => Permission::ALL_NONE,
            'add_warehouse_stock' => Permission::ALL_NONE,
            'edit_warehouse_stock' => Permission::ALL_NONE,
            'delete_warehouse_stock' => Permission::ALL_NONE,
            'manage_warehouse_transfer' => Permission::ALL_NONE,
        ];
        ...
        foreach ($packages as $package) {
            ...
            $hasPurchaseOrProducts = in_array('purchase', $modules, true) || in_array('products', $modules, true);

            if ($hasPurchaseOrProducts && ! in_array($moduleName, $modules, true)) {
                $modules[] = $moduleName;
