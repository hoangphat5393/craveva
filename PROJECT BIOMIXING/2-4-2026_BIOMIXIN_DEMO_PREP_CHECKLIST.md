...
| **After demo**         | Status & scope: `FUNC_IMPROVE/BIOMIXING_GAP_STATUS_VI.md`. Production ops: `FUNC_LOGIC/PRODUCTION_OPERATIONS_LIVE_VI.md`. Baseline: `FUNC_IMPROVE/BIOMIXING_PREP_INDEX_EN.md`.                                                                              |
