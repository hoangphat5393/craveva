...
| [`PM_YEU_CAU_TONG_HOP_VI.md`](./PM_YEU_CAU_TONG_HOP_VI.md)                                                                           | Yêu cầu PM luồng báo giá gia công     |

**Luồng vận hành trên Hub:** [`FUNC_IMPROVE/BIOMIXING_BUSINESS_FLOW_LIVE_VI.md`](../FUNC_IMPROVE/BIOMIXING_BUSINESS_FLOW_LIVE_VI.md)
...
Cùng một hệ thống, **hai luồng** (xem [`BIOMIXING_MULTITENANT_RISKS_VI.md`](../FUNC_IMPROVE/BIOMIXING_MULTITENANT_RISKS_VI.md)):
...
Theo [`BIOMIXING_PHASES_1_4_SUMMARY_VI.md`](./BIOMIXING_PHASES_1_4_SUMMARY_VI.md):
...
Chi tiết từng bước + bảng BOM/dòng bán: [`BIOMIXING_QUOTATION_EXAMPLE_OLDTOWN_VI.md`](./BIOMIXING_QUOTATION_EXAMPLE_OLDTOWN_VI.md)
...
Chi tiết từng bước + duyệt 2 cấp + COA/nhãn lô: [`BIOMIXING_QUOTATION_EXAMPLE_FRESHTEA_VI.md`](./BIOMIXING_QUOTATION_EXAMPLE_FRESHTEA_VI.md)
...
| Vai trò        | Đọc thêm                                                                                                                                                                        |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PM / BA        | [`PM_YEU_CAU_TONG_HOP_VI.md`](./PM_YEU_CAU_TONG_HOP_VI.md), [`PHASE_BUSINESS_CONTEXT_EXAMPLE.md`](./PHASE_BUSINESS_CONTEXT_EXAMPLE.md)                                          |
| Dev / QA       | [`UI_RUNBOOK_PHASE1_QUOTATION_TO_SO_VI.md`](./UI_RUNBOOK_PHASE1_QUOTATION_TO_SO_VI.md), [`FUNC_IMPROVE/BIOMIXING_GAP_STATUS_VI.md`](../FUNC_IMPROVE/BIOMIXING_GAP_STATUS_VI.md) |
| Vận hành xưởng | [`PRODUCTION_MODULE_SOP_VI.md`](./PRODUCTION_MODULE_SOP_VI.md), [`FUNC_LOGIC/PRODUCTION_OPERATIONS_LIVE_VI.md`](../FUNC_LOGIC/PRODUCTION_OPERATIONS_LIVE_VI.md)                 |
