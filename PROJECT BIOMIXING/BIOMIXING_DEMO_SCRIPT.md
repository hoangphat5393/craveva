...
*   **Platform: Sales AI Agent (ai.craveva.com)**
    *   **Action:** President asks: *"Show me the last 3 approved formulations for Siam Shrimp Distributors and their success rates."*
...
*   **Platform: Analytic AI Agent (ai.craveva.com)**
    *   **Action:** VP asks: *"Simulate margin for Probiotic Mix if raw material costs increase by 5% next month."*
...
*   **Platform: Analytic AI Agent (ai.craveva.com)**
    *   **Action:** Factory Director asks: *"Do we have enough 'Probiotic Base A' for 500kg of EHPurge? If not, when is the next shipment arriving?"*
...
*   **Platform: Analytic AI Agent (ai.craveva.com)**
    *   **Action:** Quality Manager asks: *"Retrieve the quality certificate for Batch #2025-BX and compare it to the client's required specs."*
...
*   **Platform: Analytic AI Agent (ai.craveva.com)**
    *   **Action:** Logistics Manager asks: *"Verify storage temperature requirements for EHPurge shipment to Thailand and suggest best carrier."*
...
*   **Platform: Analytic AI Agent (ai.craveva.com)**
    *   **Action:** Finance Officer asks: *"Generate a profitability report for Order #PO-1001 including overheads and raw material fluctuations."*
