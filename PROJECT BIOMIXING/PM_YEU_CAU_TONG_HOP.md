...
| ------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| [`FUNC_IMPROVE/BIOMIXING_GAP_STATUS.md`](../FUNC_IMPROVE/BIOMIXING_GAP_STATUS.md)           | Tiến độ triển khai Phase 1/2, cập nhật theo code      |
| [`FUNC_IMPROVE/PHASE1_QUOTATION_PM_HUMAN.md`](../FUNC_IMPROVE/PHASE1_QUOTATION_PM_HUMAN.md) | Tóm tắt ngắn cho dev nội bộ                           |
...
| ----------- | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| **Phase 1** | Báo giá + BOM trên báo giá + duyệt 2 cấp + chặn SO | **~90% — chốt go-live** · [`BIOMIXING_GAP_STATUS.md`](../FUNC_IMPROVE/BIOMIXING_GAP_STATUS.md) |
| **Phase 2** | SO → SX → batch → tồn                              | Vận hành: [`PRODUCTION_BUSINESS.md`](../FUNC_LOGIC/PRODUCTION_BUSINESS.md)         |
...
_Cập nhật tiến độ: sửa `FUNC_IMPROVE/BIOMIXING_GAP_STATUS.md`, không nhân bản % trong file này._
