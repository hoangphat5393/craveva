...
**Lưu ý tên “Phase 1”:** trong repo, **Phase 1 báo giá** (Estimate) khác **Production MVP** (BOM, lệnh SX — xem `FUNC_LOGIC/PRODUCTION_BUSINESS.md`). Tài liệu **này** chỉ nói **báo giá → SO**.
...
- `PROJECT BIOMIXING/UI_RUNBOOK_PHASE2_PLANNING_PREPRODUCTION.md` — bước tiếp theo sau SO.
