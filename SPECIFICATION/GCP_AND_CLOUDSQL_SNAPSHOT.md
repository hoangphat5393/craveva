...
> **Runbook vận hành:** `docs/SERVER_RUNBOOK.md`  
> **Bản GCP tóm tắt khác (có thể mới hơn):** `docs/GCP_INVENTORY.md` — khi mâu thuẫn IP/zone, xác minh trên cloud rồi cập nhật đúng file.
>
...
- **Public access enabled (`ipv4Enabled`):** `true`
- **Require SSL (`requireSsl`):** `false`
- **Automated backup enabled:** `true` (7 bản, binary log 7 ngày, `startTime` 15:00 — xem `docs/CLOUD_SQL_BACKUP.md`)
