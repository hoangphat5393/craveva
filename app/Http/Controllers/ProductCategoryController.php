...
class ProductCategoryController extends AccountBaseController
{
    ...
    public function store(StoreProductCategory $request)
    {
        ...
        $subCategoryOptions = BaseModel::options($subCategoryData, null, 'category_name');

        return Reply::successWithData(__('messages.recordSaved'), ['data' => $options, 'subCategoryData' => $subCategoryOptions]);
    }
