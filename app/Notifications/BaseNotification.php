...
class BaseNotification extends Notification implements ShouldQueue
{
    ...
    public function build($notifiable = null)
    {
        ...
        $replyEmail = $smtpSetting->mail_from_email;
        $companyEmail = $smtpSetting->mail_from_email ?: $smtpSetting->mail_username;
        ...
        return $build->from(config('mail.from.address'), $replyName)->replyTo($replyEmail, $replyName);
    }
