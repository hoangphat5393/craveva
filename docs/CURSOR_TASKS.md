...
**Tham chiếu Cursor (Agent / Multitask / token):** [`CURSOR_USAGE.md`](CURSOR_USAGE.md)
...
- Kho / bán mua: `FUNC_LOGIC/WAREHOUSE_INDEX.md`, `FUNC_LOGIC/INDEX.md`
- Cải tiến / Biomixing: `FUNC_IMPROVE/INDEX.md`, `FUNC_IMPROVE/BIOMIXING_PREP_INDEX_EN.md`
- Test matrix: `FUNC_TEST/01_BIOMIXING_TEST_MATRIX.md`
