...
**Runbook server:** [`docs/SERVER_RUNBOOK.md`](SERVER_RUNBOOK.md) — rehearsal/zip: [`STAGING_OPERATIONS.md`](STAGING_OPERATIONS.md)
...
> Gộp từ `docs/STAGING_RECOVERY_LATEST.md` (2026-05-12). Runbook đầy đủ: [`SERVER_RUNBOOK.md`](SERVER_RUNBOOK.md), [`STAGING_OPERATIONS.md`](STAGING_OPERATIONS.md). _(File log `STAGING_DISK_RECOVERY_2026-03-27.md` có thể không còn trong repo — xem mục incident trong tài liệu này hoặc runbook.)_
