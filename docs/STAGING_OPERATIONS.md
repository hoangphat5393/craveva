...
**Sao lưu GCP (Cloud SQL):** tần suất, số bản giữ, khi nào bản cũ bị xoay vòng, binary log / PITR — xem **[`STAGING_CLOUD_SQL_BACKUP_POLICY_VI.md`](STAGING_CLOUD_SQL_BACKUP_POLICY_VI.md)**.
