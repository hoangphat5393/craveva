...
- `docs/axios-migration/EASYAJAX_AND_AJAX_AUDIT.md`
...
- Cập nhật bảng trạng thái trong `docs/axios-migration/<module>.md` và changelog ngắn.
...
- Update `docs/axios-migration/*.md` status tables.
