...
- List: `warehouse.index` → `/account/warehouse`
- Create/Edit/Show: route `warehouse.create`, `.edit`, `.show` (usually AJAX modal; list URL unchanged)

## Purpose

Warehouse list and configuration.
...
1. Open the list: `/account/warehouse`.
