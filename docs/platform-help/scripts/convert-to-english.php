...
function rewriteExternalLinks(string $text, string $path, string $base): string
{
    ...
    $replacements = [
        '#\]\(\.\./\.\./FUNC_LOGIC/[^\)]+\)#u' => '](../REFERENCE/BUSINESS-FLOWS-SUMMARY.md)',
        '#\]\(\.\./\.\./docs/[^\)]+\)#u' => '](../REFERENCE/ERP-SYSTEM-OVERVIEW.md)',
        '#\]\(\.\./\.\./SPECIFICATION/[^\)]+\)#u' => '](../REFERENCE/ERP-SYSTEM-OVERVIEW.md)',
        '#\]\(\.\./\.\./Modules/[^\)]+\)#u' => '](../REFERENCE/ERP-SYSTEM-OVERVIEW.md)',
        '#\]\(\.\./\.\./RAG_agent\.md[^\)]*\)#u' => '](README.md)',
        '#\]\(\.\./\.\./FUNC_LOGIC/[^\)]*\)#u' => '](../REFERENCE/BUSINESS-FLOWS-SUMMARY.md)',
        '#\]\(../../FUNC_LOGIC/[^\)]+\)#u' => '](../REFERENCE/BUSINESS-FLOWS-SUMMARY.md)',
        '#\]\(../../docs/[^\)]+\)#u' => '](../REFERENCE/ERP-SYSTEM-OVERVIEW.md)',
        '#\]\(../../SPECIFICATION/[^\)]+\)#u' => '](../REFERENCE/ERP-SYSTEM-OVERVIEW.md)',
