...
return [
    ...
    'importLogFailedRows' => 'The following rows could not be imported.',
    'rowNumber' => 'Row #',
    'downloadFailedRowsCsv' => 'Download failed rows (CSV)',
    'allRowsImportedSuccessfully' => 'All rows were imported successfully. No errors.',
    'importSummary' => ':processed jobs succeeded, :failed failed (:total total jobs).',
