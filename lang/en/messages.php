...
return [
    ...
    'clientNameRequired' => 'Client name is required and cannot be empty.',
    'importFileCsvDisguisedAsXlsx' => 'This file has .xlsx extension but its content is CSV/plain text (not a real Excel file). Please either: 1) Save the file as proper .xlsx in Excel (File → Save As → Excel Workbook), or 2) Upload it with .csv extension.',
    'invalidDate' => 'Invalid Date Format : ',
    'duplicateEntry' => 'Duplicate entry (client code already exists)',
