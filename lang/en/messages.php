...
return [
    ...
    'salesDoHeaderRequiresOrderAndWarehouse' => 'This delivery order must be linked to a sales order and a warehouse before confirming or shipping. Open it, select the sales order and warehouse, save, then try again.',
    ...
    'orderCompleteRequiresShippedDo' => 'Cannot complete this order because items are not fully shipped yet. Please complete the Delivery Order (DO) first.',
