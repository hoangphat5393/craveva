...
+(function ($, window) {
        ...
        if (
            ...
            $.getScript(
                "https://maps.googleapis.com/maps/api/js?key=" +
                    craveva.defaults.googleApiKey +
                    "&callback=craveva.map"
            );
        }
    ...
    */
        ...
        $("[data-countdown]").each(function () {
            ...
            format +=
                '<div class="col"><h5>%H</h5><small>Hour%!H</small></div>';
            format +=
                '<div class="col"><h5>%M</h5><small>Minute%!M</small></div>';
            format +=
                '<div class="col"><h5>%S</h5><small>Second%!S</small></div>';
            format += "</div>";
