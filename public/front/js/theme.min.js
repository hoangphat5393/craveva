...
+(function (a, b) {
    var c = { name: "Craveva", version: "1.5.0" };
    (c.defaults = {
        googleApiKey: null,
        ...
        (c.breakpoint = { xs: 576, sm: 768, md: 992, lg: 1200 }),
        (c.config = function (d) {
            if ("string" == typeof d) return c.defaults[d];
            if (
                (a.extend(!0, c.defaults, d),
                c.defaults.smoothScroll || SmoothScroll.destroy(),
                a('[data-provide~="map"]').length &&
                    void 0 === b["google.maps.Map"] &&
                    a.getScript(
                        "https://maps.googleapis.com/maps/api/js?key=" +
                            c.defaults.googleApiKey +
                            "&callback=craveva.map"
                    ),
                c.defaults.googleAnalyticsId &&
                    ...
                    })(b, document, "script", 0, "ga"),
                    ga("create", c.defaults.googleAnalyticsId, "auto"),
                    ga("send", "pageview")),
                a('[data-provide~="recaptcha"]').length &&
                    void 0 === b.grecaptcha)
            ) {
                var e =
                    "https://www.google.com/recaptcha/api.js?onload=recaptchaCallback";
                "" != c.defaults.reCaptchaLanguage &&
                    (e += "&hl=" + c.defaults.reCaptchaLanguage),
                    a.getScript(e);
            }
        }),
        (c.init = function () {
            c.topbar(),
                ...
                c.shuffle(),
                c.bindValue(),
                a(document).on("click", '[data-provide~="lightbox"]', lity),
                objectFitPolyfill(a(".bg-video")),
                a(document).on("click", ".video-wrapper .btn", function () {
                    var b = a(this).closest(".video-wrapper");
                    if (
                        (b.addClass("reveal"),
                        b.find("video").length && b.find("video").get(0).play(),
                        b.find("iframe").length)
                    ) {
                        var c = b.find("iframe");
                        c.attr("src").indexOf("?") > 0
                            ? (c.get(0).src += "&autoplay=1")
                            : (c.get(0).src += "?autoplay=1");
                    }
                }),
                ...
                a(document).on(
                    "change",
                    '.file-group [type="file"]',
                    function () {
                        var b = a(this),
                            c = b.val().split("\\").pop();
                        b.closest(".file-group")
                            .find(".file-value")
                            .val(c)
                            .text(c)
                            .focus();
        ...
        (c.parallax = function () {
            a("[data-parallax]").each(function () {
                var b = a(this),
                    d = { imageSrc: b.data("parallax"), speed: 0.3, bleed: 50 };
                a(this).hasClass("header") && (d.speed = 0.6),
                    (d = a.extend(d, c.getDataOptions(b))),
                    b.parallax(d);
            });
        }),
        (c.map = function () {
        ...
        (c.recaptcha = function () {
            a('[data-provide~="recaptcha"]').each(function () {
                var b = { sitekey: c.defaults.reCaptchaSiteKey };
                (b = a.extend(b, c.getDataOptions(a(this)))),
                    grecaptcha.render(a(this)[0], b);
            });
        }),
        (c.carousel = function () {
            a(".swiper-container").each(function () {
                var b = {
                    ...
                    d = a(this);
                d.find(".swiper-button-next").length &&
                    (b.nextButton = ".swiper-button-next"),
                    d.find(".swiper-button-prev").length &&
                        (b.prevButton = ".swiper-button-prev"),
                    d.find(".swiper-pagination").length &&
                        ((b.pagination = ".swiper-pagination"),
                        (b.paginationClickable = !0)),
                    (b = a.extend(b, c.getDataOptions(d))),
                    new Swiper(d, b);
            });
        }),
        (c.scrolling = function () {
            ...
            a(document).on("click", ".scroll-top", function () {
                ...
                a(document).on("click", "[data-scrollto]", function () {
                    ...
                    if (a(c).length > 0) {
                        var d = 0;
                        a(".topbar.topbar-sticky").length && (d = 60),
                            b.animate(
            ...
            "" != c &&
                a("#" + c).length > 0 &&
                b.animate({ scrollTop: a("#" + c).offset().top - 60 }, 1e3);
        }),
        (c.counter = function () {
            ...
            a("[data-countdown]").each(function () {
                var b = "";
                (b += '<div class="row gap-items-3">'),
                    (b +=
                        '<div class="col"><h5>%D</h5><small>Day%!D</small></div>'),
                    (b +=
                    ...
                    (b += "</div>"),
                    a(this).hasDataAttr("format") &&
                        (b = a(this).data("format")),
                    a(this).countdown(a(this).data("countdown"), function (c) {
        ...
        (c.topbar = function () {
            ...
            a(b).on("scroll", function () {
                ...
                a(document).on(
                    ...
                    function (b) {
                        ...
                        "#" == c.attr("href") && b.preventDefault(),
                            e.removeClass("show"),
                            e.find(".nav-item.show").removeClass("show"),
                            d.toggleClass("show");
                    }
                ),
                a(document).on("click", ".topbar-toggler", function () {
                    c.toggleClass("topbar-reveal"),
                        a(this)
                            .closest(".topbar")
                ...
                a(document).on(
                    ...
                    function () {
                        a(this).hasDataAttr("scrollto") &&
                            (c.removeClass("topbar-reveal"),
                            a(".topbar-backdrop").remove());
                    }
                );
        }),
        (c.typed = function () {
        ...
        (c.mailer = function () {
            ...
            a('[data-form="mailer"]').each(function () {
                ...
                c.on("submit", function () {
                    return (
                        c.children(".alert-danger").remove(),
                        d.length && (d.val().length < 1 || !b.test(d.val()))
                            ? (f.addClass("has-danger"), !1)
                            : e.length && e.val().length < 1
                            ? (g.addClass("has-danger"), !1)
                            : (a
                                  .ajax({
                                      type: "POST",
                                      url: c.attr("action"),
        ...
        (c.constellation = function () {
            var c = "rgba(255, 255, 255, .8)",
                d = 120;
            a(b).width() < 700 && (d = 25),
                a(".constellation").each(function () {
                    "dark" == a(this).data("color") &&
                        (c = "rgba(0, 0, 0, .5)");
        ...
        (c.shuffle = function () {
            if (
                void 0 !== b.Shuffle &&
                0 !== a('[data-provide="shuffle"]').length
            ) {
                var c = b.Shuffle;
                (c.options.itemSelector = '[data-shuffle="item"]'),
                    (c.options.sizer = '[data-shuffle="sizer"]'),
                    (c.options.delimeter = ","),
                    (c.options.speed = 500),
                    a('[data-provide="shuffle"]').each(function () {
        ...
        (c.bindValue = function () {
            a("[data-bind-radio]").each(function () {
                ...
                b.text(b.dataAttr(d, b.text())),
                    a('input[name="' + c + '"]').on("change", function () {
