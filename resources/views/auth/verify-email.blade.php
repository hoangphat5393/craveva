...
<x-auth>
    ...
    <div class="alert alert-success" id="sessionCondition">
        ...
        @if ($showbtn)
            <button type="submit" class="btn-primary f-w-500 rounded w-50 f-18" href="verify"
                id="verifyEmailLink">@lang('superadmin.superadmin.verifyMail')</button>
        @endif
    </div>
    ...
    <div class="container"id="verificationContainer" style="display: none;">
        <div class="d-flex justify-content-between mb-4">
            ...
            <button type="button" class="btn-light btn btn-sm rounded f-12"
                onclick="event.preventDefault();
            document.getElementById('logout-form').submit();"><i
                    class="fa fa-power-off f-16 mr-1"></i>
        ...
        <div class="card border-0">
            ...
            <div class="card-body">
                ...
                <form class="otc my-3 d-inline ajax-form" id="email-verification-form" name="one-time-code"
                    action="#">
                    @csrf
                    <fieldset class="form-group">
                        ...
                        <div>
                            ...
                            <input type="number" name="email_otp[]" pattern="[0-9]*" min="0" max="9"
                                maxlength="1" value="" inputtype="numeric" autocomplete="one-time-code"
                        ...
                        <button type="button" onclick="return verifyCode()" id="verify-code"
                            class="btn-primary rounded f-14 p-2 mt-3 align-baseline">
                            @lang('superadmin.emailVerificationCode.verifyCode')
                        </button>

                        {{-- SAAS --}}
                        {{-- @if (session('impersonate') && isCraveva())
                ...
                <form method="POST" action="#" id="send-email-verification-code">
                    @csrf
                    <button type="button" onclick="return sendVerifyCode()" id="send-verify-code"
                        class="btn-light rounded f-11 p-2 mt-3 align-baseline">
