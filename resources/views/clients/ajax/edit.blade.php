            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.text fieldId="name" :fieldLabel="__('modules.client.clientName')" fieldName="name" fieldRequired="true" :fieldPlaceholder="__('placeholders.name')" :fieldValue="$client->name">
                                </x-forms.text>
                            </div>
                            <div class="col-md-4">
                                <x-forms.email fieldId="email" :fieldLabel="__('app.email')" fieldName="email" :popover="__('modules.client.emailNote')" :fieldPlaceholder="__('placeholders.email')" :fieldValue="$client->email" :fieldReadOnly="!is_null($client->email)" :popover="__('superadmin.emailCannotChange')">
                                </x-forms.email>
                            </div>

                            <div class="col-md-4">
                                <x-forms.text fieldId="client_code" :fieldLabel="__('modules.client.clientCode')" fieldName="client_code" :fieldPlaceholder="__('placeholders.clientCode')" :fieldValue="$client->clientDetails->client_code ?? ''">
                                </x-forms.text>
                            </div>
                            <div class="col-md-4">
                                <x-forms.select fieldId="country" :fieldLabel="__('app.country')" fieldName="country" search="true">
                                    ...
                                    @foreach ($countries as $item)
                                        <option @selected($client->country_id == $item->id) data-mobile="{{ $client->mobile }}" data-tokens="{{ $item->iso3 }}" data-phonecode="{{ $item->phonecode }}" data-iso="{{ $item->iso }}" data-content="{{ $item->nicename }}" value="{{ $item->id }}">{{ $item->nicename }}</option>
                                    @endforeach
                                </x-forms.select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="country_phonecode" id="country_phonecode" data-live-search="true" data-size="8">
                                        @foreach ($countries as $item)
                                            <option @selected($client->country_phonecode == $item->phonecode && !is_null($item->numcode)) data-tokens="{{ $item->name }}" data-country-iso="{{ $item->iso }}" data-content="+{{ $item->phonecode }}" value="{{ $item->phonecode }}">
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="col-md-3">
                        <x-forms.select fieldId="locale" :fieldLabel="__('modules.accountSettings.changeLanguage')" fieldName="locale" search="true">
                            @foreach ($languages as $language)
                                <option @selected($client->locale == $language->language_code) data-content="{{ $language->language_name }}" value="{{ $language->language_code }}">{{ $language->language_name }}</option>
                            @endforeach
                        </x-forms.select>
                    </div>

                    <div class="col-md-3">
                        <x-forms.label class="mt-3" fieldId="category" :fieldLabel="__('modules.client.clientCategory')">
                        </x-forms.label>
                        <x-forms.input-group>
                            ...
                            @if ($addClientCategoryPermission == 'all' || $addClientCategoryPermission == 'added' || $addClientCategoryPermission == 'both')
                                <x-slot name="append">
                                    <button id="addClientCategory" type="button" class="btn btn-outline-secondary border-grey" data-toggle="tooltip" data-original-title="{{ __('app.add') . ' ' . __('modules.client.clientCategory') }}">@lang('app.add')</button>
                                </x-slot>
                            @endif
                        </x-forms.input-group>
                    </div>
                    ...
                    <div class="col-md-3">
                        <x-forms.label class="mt-3" fieldId="sub_category_id" :fieldLabel="__('modules.client.clientSubCategory')"></x-forms.label>
                        <x-forms.input-group>
                            ...
                            @if ($addClientSubCategoryPermission == 'all' || $addClientSubCategoryPermission == 'added' || $addClientSubCategoryPermission == 'both')
                                <x-slot name="append">
                                    <button id="addClientSubCategory" type="button" class="btn btn-outline-secondary border-grey" data-toggle="tooltip" data-original-title="{{ __('app.add') . ' ' . __('modules.client.clientSubCategory') }}">@lang('app.add')</button>
                                </x-slot>
                            @endif
                        </x-forms.input-group>
                    </div>
                    ...
                    <div class="col-md-3">
                        <x-forms.select fieldId="default_warehouse_id" fieldLabel="Default Warehouse" fieldName="default_warehouse_id" search="true">
                            ...
                            @foreach ($warehouses ?? collect() as $warehouse)
                                <option value="{{ $warehouse->id }}" @selected(optional($client->clientDetails)->default_warehouse_id == $warehouse->id)>
                    ...
                    <div class="col-md-4">
                        <div class="form-group my-3">
                            ...
                            <div class="d-flex">
                                <x-forms.radio fieldId="notification-yes" :fieldLabel="__('app.yes')" fieldValue="yes" fieldName="sendMail" checked="($client->email_notifications) ? 'checked' : ''">
                                </x-forms.radio>
                                <x-forms.radio fieldId="notification-no" :fieldLabel="__('app.no')" fieldValue="no" fieldName="sendMail" :checked="!$client->email_notifications ? 'checked' : ''">
                                </x-forms.radio>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row p-20">
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text class="mb-3 mt-3 mt-lg-0 mt-md-0" fieldId="company_name" :fieldLabel="__('modules.client.companyName')" fieldName="company_name" :fieldValue="$client->clientDetails->company_name" :fieldPlaceholder="__('placeholders.company')">
                        </x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text class="mb-3 mt-3 mt-lg-0 mt-md-0" fieldId="website" :fieldLabel="__('modules.client.website')" fieldName="website" :fieldValue="$client->clientDetails->website" :fieldPlaceholder="__('placeholders.website')">
                        </x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text class="mb-3 mt-3 mt-lg-0 mt-md-0" fieldId="tax_name" :fieldLabel="__('app.taxName')" :fieldValue="$client->clientDetails->tax_name" fieldName="tax_name" :fieldPlaceholder="__('placeholders.gst/vat')"></x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text class="mb-3 mt-3 mt-lg-0 mt-md-0" fieldId="gst_number" :fieldLabel="__('app.gstNumber')" :fieldValue="$client->clientDetails->gst_number" fieldName="gst_number" :fieldPlaceholder="__('placeholders.gstNumber')"></x-forms.text>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text fieldId="city" :fieldLabel="__('modules.stripeCustomerAddress.city')" fieldName="city" :fieldPlaceholder="__('placeholders.city')" :fieldValue="$client->clientDetails->city"></x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text fieldId="state" :fieldLabel="__('modules.stripeCustomerAddress.state')" fieldName="state" :fieldPlaceholder="__('placeholders.state')" :fieldValue="$client->clientDetails->state"></x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text fieldId="postalCode" :fieldLabel="__('modules.stripeCustomerAddress.postalCode')" fieldName="postal_code" :fieldPlaceholder="__('placeholders.postalCode')" :fieldValue="$client->clientDetails->postal_code"></x-forms.text>
                    </div>

                    <div class="col-md-6">
                        <div class="form-group my-3">
                            <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.accountSettings.companyAddress')" fieldName="address" fieldId="address" :fieldPlaceholder="__('placeholders.address')" :fieldValue="$client->clientDetails->address">
                            </x-forms.textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group my-3">
                            <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.shippingAddress')" :fieldValue="$client->clientDetails->shipping_address" fieldName="shipping_address" fieldId="shipping_address" :fieldPlaceholder="__('placeholders.address')">
                            </x-forms.textarea>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <x-forms.text fieldId="skype" fieldLabel="Skype" fieldName="skype" :fieldPlaceholder="__('placeholders.client.skype')" :fieldValue="$client->clientDetails->skype">
                        </x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text fieldId="linkedin" fieldLabel="Linkedin" fieldName="linkedin" :fieldPlaceholder="__('placeholders.client.linkedin')" :fieldValue="$client->clientDetails->linkedin"></x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text fieldId="twitter" fieldLabel="Twitter" fieldName="twitter" :fieldPlaceholder="__('placeholders.client.twitter')" :fieldValue="$client->clientDetails->twitter">
                        </x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text fieldId="facebook" fieldLabel="Facebook" fieldName="facebook" :fieldPlaceholder="__('placeholders.client.facebook')" :fieldValue="$client->clientDetails->facebook"></x-forms.text>
                    </div>
                    ...
                    @if (function_exists('sms_setting') && sms_setting()->telegram_status)
                        <div class="col-md-6">
                            <x-forms.number fieldName="telegram_user_id" fieldId="telegram_user_id" fieldLabel="<i class='fab fa-telegram'></i> {{ __('sms::modules.telegramUserId') }}" :fieldValue="$client->telegram_user_id" :popover="__('sms::modules.userIdInfo')" />
                    ...
                    <div class="col-lg-12">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.contracts.companyLogo')" fieldName="company_logo" :fieldValue="$client->clientDetails->company_logo ? $client->clientDetails->image_url : null" fieldId="company_logo" :popover="__('messages.fileFormat.ImageFile')" />
                    </div>
                </div>
