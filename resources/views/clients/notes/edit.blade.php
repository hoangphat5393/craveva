        ...
        <x-form id="save-client-note-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                ...
                <div class="row px-4">
                    ...
                    <div class="col-md-6">
                        <x-forms.text fieldId="title" :fieldLabel="__('modules.client.noteTitle')" fieldName="title" fieldRequired="true" :fieldPlaceholder="__('placeholders.name')" :fieldValue="$note->title">
                        </x-forms.text>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group my-3">
                            ...
                            <div class="d-flex">
                                <x-forms.radio fieldId="public" :fieldLabel="__('app.public')" fieldName="type" fieldValue="0" :checked="$note->type == 0">
                                </x-forms.radio>
                                <x-forms.radio fieldId="private" :fieldLabel="__('app.private')" fieldValue="1" fieldName="type" :checked="$note->type == 1"></x-forms.radio>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row px-4 @if ($note->type == 0) d-none @endif" id="private-note-details">
                    ...
                    @if (!in_array('client', user_roles()))
                        <div class="col-md-3">
                            ...
                            <x-forms.checkbox :fieldLabel="__('modules.client.visibleToClient')" fieldName="is_client_show" fieldId="is_client_show" fieldValue="1" fieldRequired="true" :checked="$note->is_client_show == 1" />
                        </div>
                    @endif
