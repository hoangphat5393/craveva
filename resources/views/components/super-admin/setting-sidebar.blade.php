...
<div class="settings-sidebar bg-white py-3" id="mob-settings-sidebar">
    ...
    <ul class="settings-menu" id="settingsMenu">
        ...
        @if (user()->permission('manage_superadmin_currency_settings') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="currency_settings" :href="route('superadmin.settings.global-currency-settings.index')" :text="__('app.menu.currencySettings')" />
        @endif
        @if (user()->permission('manage_superadmin_payment_settings') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="payment_gateway_settings" :href="route('superadmin.settings.global-payment-gateway-settings.index')" :text="__('app.menu.paymentGatewayCredential')" />
        @endif
        @if (user()->permission('manage_superadmin_finance_settings') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="global_invoice_settings" :href="route('superadmin.settings.global-invoice-settings.index')" :text="__('app.menu.financeSettings')" />
        @endif
        @if (user()->permission('manage_superadmin_custom_field_settings') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="custom_fields" :href="route('superadmin.settings.global-custom-fields.index')" :text="__('app.menu.customFields')" />
        @endif
        @if (user()->permission('manage_superadmin_permission_settings') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="superadmin_role_permissions" :href="route('superadmin.settings.superadmin-permissions.index')" :text="__('superadmin.superadminRoleAndPermission')" />
        @endif
        ...
        @if (user()->permission('manage_superadmin_theme_settings') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="theme_settings" :href="route('superadmin.settings.super-admin-theme-settings.index')" :text="__('app.menu.themeSettings')" />
        @endif
        @if (user()->permission('manage_superadmin_custom_module_settings') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="module_settings" :href="route('superadmin.settings.custom-module-settings.index')" :text="__('app.menu.moduleSettings')" />
        @endif
