    ...
    <div class="container content-wrapper">
        ...
        <div class="border-0 card invoice">
                ...
                <div class="invoice-table-wrapper">
                    <table width="100%" class="">
                        <tr class="inv-logo-heading">
                            <td><img src="{{ $invoiceSetting->logo_url }}" alt="{{ $company->company_name }}" class="logo" /></td>
                    ...
                    <table width="100%">
                        <tr class="inv-unpaid">
                            <td class="f-14 text-dark">
                                <p class="mb-0 text-left"><span class="text-dark-grey ">@lang('app.client')</span><br>
                            ...
                            <td align="right">
                                @if ($contract->client->clientDetails->company_logo)
                                    <img src="{{ $contract->client->clientDetails->image_url }}" alt="{{ $contract->client->clientDetails->company_name }}" class="logo" />
                                @endif
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="py-0 mb-4 bg-white border-0 card-footer d-flex justify-content-end py-lg-4 py-md-4 mb-lg-3 mb-md-3 ">
                ...
                <x-forms.link-secondary :link="route('front.contract.download', $contract->hash)" class="mb-2 mr-3" icon="download">@lang('app.download')
                </x-forms.link-secondary>

                @if (!$contract->signature)
                    <x-forms.link-primary class="mb-2" link="javascript:;" data-toggle="modal" data-target="#signature-modal" icon="check">@lang('app.sign')
