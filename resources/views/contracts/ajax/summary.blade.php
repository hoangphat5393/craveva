        ...
        <div class="d-flex">
            <div class="inv-action mr-3 mr-lg-3 mr-md-3 dropup">
                ...
                <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuButton" tabindex="0">
                    ...
                    || ($editContractPermission == 'added' && (user()->id == $contract->added_by || $userId == $contract->added_by || in_array($contract->added_by, $id)))
                    || ($editContractPermission == 'owned' && $userId == $contract->client_id)
                    || ($editContractPermission == 'both' && ($userId == $contract->client_id || user()->id == $contract->added_by || $userId == $contract->added_by || in_array($contract->added_by, $id)))
                    )
                        <li>
                            <a class="dropdown-item openRightModal"
