...
<body class="content-wrapper">
    <table class="bg-white" border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
        <tbody>
            <!-- Table Row Start -->
            <tr>
                <td><img src="{{ $contract->company->invoiceSetting->logo_url }}"
                        alt="{{ $contract->company->company_name }}" class="logo" /></td>
                    ...
                    <table class="text-black mt-1 f-13 b-collapse rightaligned">
                        ...
                        <tr>
                            ...
                            <td class="heading-table-right">
                                {{ $contract->start_date->translatedFormat($contract->company->date_format) }}
                            </td>
                        </tr>
    ...
    <div>
        ...
        @if ($contract->company_sign)
            <div style="text-align: left; margin-top: 10px">
                ...
                @if ($contract->signer)
                    <p style="margin-top: -16px;">Sign By : {{ $contract->signer ? $contract->signer->name : '--' }}
                    </p>
                @endif
            </div>
        @endif
        ...
        @if ($contract->signature)
            <div style="text-align: right; margin-top: -260px">
                ...
                <img src="{{ $contract->signature->signature }}" class="" height="75px" alt="Signature" />
