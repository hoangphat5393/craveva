                ...
                <div class="row px-lg-4 px-md-4 px-3 py-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-lg-0 mb-md-0 mb-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="invoice_date" name="issue_date" class="px-6 position-relative text-dark font-weight-normal form-control height-35 rounded p-0 text-left f-15" placeholder="@lang('placeholders.date')" value="{{ $creditNote->issue_date ? $creditNote->issue_date->translatedFormat(company()->date_format) : '' }}">
                            </div>
                        </div>
                    </div>
                    <!-- INVOICE DATE END -->
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-lg-0 mb-md-0 mb-4">
                            ...
                            <div class="input-group ">
                                <input type="text" id="due_date" name="due_date" class="px-6 position-relative text-dark font-weight-normal form-control height-35 rounded p-0 text-left f-15" placeholder="@lang('placeholders.date')" value="{{ $creditNote->due_date ? $creditNote->due_date->translatedFormat(company()->date_format) : '' }}">
                            </div>
                        </div>
                    </div>
                    <!-- DUE DATE END -->
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="50%" class="c-inv-sub-padding">
                                                                    <input type="number" min="0" name="discount_value" class="f-14 border-0 w-100 text-right discount_value" placeholder="0" value="{{ $creditNote->discount }}">
                                                                </td>
