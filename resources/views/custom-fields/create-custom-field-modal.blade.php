...
<div class="modal-footer">
    ...
    <x-forms.button-secondary id="save-add-another" class="mr-3" icon="check-double">@lang('app.saveAddMore')</x-forms.button-secondary>
        ...
        $.easyAjax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    // Remove extra value boxes if added
