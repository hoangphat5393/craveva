                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <x-forms.file-multiple
                            ...
                            :fieldLabel=" __('messages.downloadFile') " fieldName="file"
...
@push('scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            myDrop.on("error", function (file, message) {
                if (typeof message === 'object') {
                    message = message.message; // Handle Laravel validation error JSON
                }
                Swal.fire({
                    icon: 'error',
                    title: "@lang('messages.fileUploadIssue')",
                    text: message,
                });
            });
        });

        $('body').on('click', '.install-files', function () {
