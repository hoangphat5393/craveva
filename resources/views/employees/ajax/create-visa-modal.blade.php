    ...
    <div class="portlet-body">
        <x-form id="save-visa-data-form" method="POST" class="ajax-form">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <x-forms.text :fieldLabel="__('modules.employees.visaNumber')" fieldName="visa_number" fieldId="visa_number" fieldValue="" :fieldRequired="true" />
                </div>
...
<script>
    ...
    $('#save-visa-form').click(function() {
        ...
        window.apiHttp.postForm("{{ route('employee-visa.store') }}", document.getElementById('save-visa-data-form')).then(function(response) {
