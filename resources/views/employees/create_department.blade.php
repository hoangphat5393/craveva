...
<div class="modal-body">
    ...
    <x-form id="save-department-data-form">
        <div class="add-client bg-white rounded">
            ...
            <div class="row p-20">
                <div class="col-md-6">
                    <x-forms.text fieldId="designation_name" :fieldLabel="__('app.name')" fieldName="team_name" fieldRequired="true" :fieldPlaceholder="__('placeholders.department')">
                    </x-forms.text>
                </div>
                <div class="col-md-6">
...
<script>
    ...
    $('#save-department-form').click(function() {
        ...
        var $btn = $('#save-department-form');
        $btn.prop('disabled', true);
        $.easyBlockUI('#save-department-data-form');
        window.apiHttp.postUrlEncoded(url, $('#save-department-data-form').serialize()).then(function(response) {
