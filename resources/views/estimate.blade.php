...
<body id="body" class="h-100 bg-additional-grey {{ isRtl('rtl') }}">
                                ...
                                <tr class="inv-unpaid">
                                    ...
                                    <td align="right" class="mt-4 mt-lg-0 mt-md-0">
                                        @if ($estimate->clientDetails->company_logo)
                                            ...
                                            <br><br><br>
                                        @endif
                                        <span class="unpaid {{ $estimate->status == 'draft' ? 'text-primary border-primary' : '' }} {{ $estimate->status == 'accepted' ? 'text-success border-success' : '' }} rounded f-15 ">@lang('modules.estimates.' . $estimate->status)</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <table class="inv-detail f-14 table-responsive-sm" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="{{ $invoiceSetting->hsn_sac_code_show ? 4 : 3 }}" class="p-0 ">
                                                    <table width="100%">
    ...
    <script>
        ...
        function initPublicEstimatePage() {
