...
<div class="modal-body">
    ...
    <x-form id="acceptEstimate">
        <div class="row">
            <div class="col-md-4">
                <x-forms.text fieldId="first_name" :fieldLabel="__('modules.estimates.firstName')" fieldName="first_name" fieldRequired="true">
                </x-forms.text>
            </div>
            <div class="col-md-4">
                <x-forms.text fieldId="last_name" :fieldLabel="__('modules.estimates.lastName')" fieldName="last_name" fieldRequired="true">
                </x-forms.text>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-sm-12 p-4 d-none upload-image">
                <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.estimates.signature')" fieldName="image" fieldId="image" :popover="__('messages.fileFormat.ImageFile')" fieldRequired="true" />
            </div>
