                    ...
                    <div class="form-group c-inv-select mb-4">
                        @if (isset($isClient) && $isClient == true)
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $estimate->client->name_salutation }}" class="form-control height-35 f-15 readonly-background" readonly>
                            </div>
                        @else
                                    ...
                                    <tr class="d-none d-md-block d-lg-table-row">
                                        ...
                                        <td class="border-left-0">
                                            <input type="file" class="dropify" name="invoice_item_image[]" data-allowed-file-extensions="png jpg jpeg bmp" data-messages-default="test" data-height="70" data-id="{{ $item->id }}" id="{{ $item->id }}" data-default-file="{{ $item->estimateItemImage ? $item->estimateItemImage->file_url : '' }}"
                                                @if ($item->estimateItemImage && $item->estimateItemImage->external_link) data-show-remove="false" @endif />
                                ...
                                <table width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td width="70%" class="c-inv-sub-padding">
                                                                <input type="number" min="0" name="discount_value" class="f-14 border-0 w-100 text-right discount_value form-control" placeholder="0" value="{{ $estimate->discount }}">
                                                            </td>
                                            ...
                                            <td><span id="discount_amount">{{ number_format((float) $estimate->discount, 2, '.', '') }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="bg-amt-grey f-16 f-w-500">
                                            ...
                                            <td>
                                                <span class="total-currency mr-1">
                                                    {{ $estimate->currency ? $estimate->currency->currency_code : (companyOrGlobalSetting()->currency ? companyOrGlobalSetting()->currency->currency_code : '') }}
                                                </span>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function addProduct(id) {
                ...
                var exchangeRate = $('#estimate_exchange_rate').val() || '';
                $.easyBlockUI('#saveInvoiceForm');
            ...
            $('.save-form').click(function() {
                ...
                var updateUrl = "{{ route('estimates.update', $estimate->id) }}";
