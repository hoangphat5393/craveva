            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <x-forms.text :fieldLabel="__('modules.events.eventName')" fieldName="event_name" fieldRequired="true" fieldId="event_name" fieldPlaceholder="" :fieldValue="$event->event_name" />
                    </div>

                    <div class="col-md-4">
                        <div class="form-group my-3">
                            <x-forms.label fieldId="colorselector" fieldRequired="true" :fieldLabel="__('modules.tasks.labelColor')">
                            </x-forms.label>
                            <x-forms.input-group id="colorpicker">
                                <input type="text" class="form-control height-35 f-14" placeholder="{{ __('placeholders.colorPicker') }}" name="label_color" id="colorselector" :fieldValue="$event->label_color">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <x-forms.text :fieldLabel="__('modules.events.where')" fieldName="where" fieldRequired="true" fieldId="where" fieldPlaceholder="" :fieldValue="$event->where" />
                    </div>
                    ...
                    <div class="col-md-3 col-lg-3">
                        <x-forms.datepicker fieldId="start_date" fieldRequired="true" :fieldLabel="__('modules.events.startOnDate')" fieldName="start_date" :fieldValue="$event->start_date_time->format(company()->date_format)" :fieldPlaceholder="__('placeholders.date')" />
                    </div>

                    <div class="col-md-3 col-lg-3">
                        <div class="bootstrap-timepicker timepicker">
                            <x-forms.text :fieldLabel="__('modules.events.startOnTime')" :fieldPlaceholder="__('placeholders.hours')" fieldName="start_time" fieldId="start_time" fieldRequired="true" :fieldValue="$event->start_date_time->format(company()->time_format)" />
                        </div>
                    </div>

                    <div class="col-md-3 col-lg-3">
                        <x-forms.datepicker fieldId="end_date" fieldRequired="true" :fieldLabel="__('modules.events.endOnDate')" fieldName="end_date" :fieldValue="$event->end_date_time->format(company()->date_format)" :fieldPlaceholder="__('placeholders.date')" />
                    </div>

                    <div class="col-md-3 col-lg-3">
                        <div class="bootstrap-timepicker timepicker">
                            <x-forms.text :fieldLabel="__('modules.events.endOnTime')" :fieldPlaceholder="__('placeholders.hours')" fieldName="end_time" fieldId="end_time" fieldRequired="true" :fieldValue="$event->end_date_time->format(company()->time_format)" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <x-forms.input-group>
                            <select class="form-control multiple-users emp-event-department" multiple name="team_id[]" id="employee_department" data-live-search="true">
                                @foreach ($teams as $team)
                                    <option data-content="<span class='p-2 border badge badge-pill badge-light'>{{ $team->team_name }}</span>" value="{{ $team->id }}" @if (in_array($team->id, $departments ?? []))
                                        selected
                    ...
                    <div class="{{ !in_array('client', user_roles()) ? 'col-md-6' : 'col-md-12' }}">
                        <div class="form-group my-3">
                            @if (in_array('client', user_roles()) || (!in_array('admin', user_roles()) && in_array('employee', user_roles()) && $viewEmployeePermission != 'all'))
                                <x-forms.text :fieldLabel="__('app.select') . ' ' . __('app.employee')" fieldReadOnly="true" fieldName="users" fieldId="selectAssignee" :fieldValue="$userIds->pluck('user.name')->implode(', ')" />

                                @foreach ($userIds as $user)
                                    <input type="hidden" name="user_id[]" value="{{ $user->user_id }}">
                                @endforeach
                            @else
                                <x-forms.label fieldId="selectAssignee" fieldRequired="true" :fieldLabel="__('app.select') . ' ' . __('app.employee')">
                                </x-forms.label>
                                <x-forms.input-group>
                                    @php
                                    ...
                                    @endphp
                                    <select class="form-control multiple-users" multiple name="user_id[]" id="selectAssignee" data-live-search="true" data-size="8">
                        ...
                        <div class="col-md-6">
                            <div class="form-group my-3">
                                @if (!in_array('admin', user_roles()) && in_array('employee', user_roles()) && $viewClientPermission != 'all')
                                    <x-forms.text :fieldLabel="__('app.select') . ' ' . __('app.client')" fieldReadOnly="true" fieldName="clients" fieldId="selectAssignee2" :fieldValue="!$clientIds->isEmpty() ? $clientIds->pluck('user.name')->implode(', ') : __('placeholders.noneSelectedText')" />

                                    @foreach ($clientIds as $client)
                                        <input type="hidden" name="user_id[]" value="{{ $client->user_id }}">
                                    @endforeach
                                @else
                                    <x-forms.label fieldId="selectAssignee2" :fieldLabel="__('app.select') . ' ' . __('app.client')">
                                    </x-forms.label>
                                    <x-forms.input-group>
                                        <select class="form-control multiple-users" multiple name="user_id[]" id="selectAssignee2" data-live-search="true" data-size="8">
                    ...
                    <div class="col-md-6">
                        <div class="form-group my-3">
                            @if (in_array('client', user_roles()) || (!in_array('admin', user_roles()) && in_array('employee', user_roles()) && $viewEmployeePermission != 'all'))
                                <x-forms.text :fieldLabel="__('app.host')" fieldReadOnly="true" fieldName="host_show" fieldId="host" :fieldValue="optional($event->user)->name ?? '--'" />

                                <input type="hidden" name="host" value="{{ $event->host ?? '' }}">
                            @else
                                <x-forms.label fieldId="host" fieldRequired="false" :fieldLabel="__('app.host')">
                                </x-forms.label>
                                <x-forms.input-group>
                                    @php
                                        $activeEmployees = $employees->filter(function ($employee) {
                                    ...
                                    @endphp
                                    <select class="form-control multiple-users" name="host" id="selectHost" data-live-search="true" data-size="8">
                                        <option value="">--</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group c-inv-select mb-4 my-3">
                            ...
                            <div class="select-others height-35 rounded">
                                <select class="form-control select-picker" data-live-search="true" data-size="8" name="status" id="status">
                                    <option data-content="<i class='fa fa-circle mr-1 f-15 text-yellow'></i> @lang('app.pending')" value="pending" @if ($event->status == 'pending')
                                        selected
                                        @endif></option>
                                    <option data-content="<i class='fa fa-circle mr-1 f-15 text-light-green'></i> @lang('app.completed')" value="completed" @if ($event->status == 'completed')
                                        selected
                                        @endif></option>
                                    <option data-content="<i class='fa fa-circle mr-1 f-15 text-red'></i> @lang('app.cancelled')" value="cancelled" @if ($event->status == 'cancelled')
                                        selected
                                        @endif></option>
                                </select>
                            </div>
                    ...
                    @if ($event->parent_id == null && $event->repeat == 'yes')
                        <div class="col-lg-2 my-3">
                            <x-forms.checkbox :fieldLabel="__('modules.events.repeat')" fieldName="repeat" :popover="$event->parent_id !== null ? __('messages.repeatEvent') : null" fieldId="repeat-event" fieldValue="yes" fieldRequired="true" :checked="$event->repeat == 'yes'" />
                        </div>

                        <div class="col-lg-12 repeat-event-div @if ($event->repeat == 'no') d-none @endif">
                            <div class="row">
                                <div class="col-lg-4">
                                    <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.events.repeatEvery')" fieldName="repeat_count" fieldId="repeat_count" :fieldValue="$event->repeat_every" fieldRequired="true" />
                                </div>
                                <div class="col-md-4 mt-3">
                                    <x-forms.select fieldId="repeat_type" fieldLabel="" fieldName="repeat_type" search="true">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <x-forms.text :fieldLabel="__('modules.events.cycles')" fieldName="repeat_cycles" fieldRequired="true" fieldId="repeat_cycles" fieldPlaceholder="" :fieldValue="$event->repeat_cycles" />
                                </div>
                            </div>
                        </div>
                    @else
                    ...
                    <div class="col-lg-3 my-3">
                        <x-forms.checkbox :fieldLabel="__('modules.tasks.reminder')" fieldName="send_reminder" fieldId="send_reminder" fieldValue="yes" fieldRequired="true" :checked="$event->send_reminder == 'yes'" />
                    </div>

                    <div class="col-lg-12 send_reminder_div @if ($event->send_reminder == 'no') d-none @endif">
                        <div class="row">
                            <div class="col-lg-4">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.events.remindBefore')" fieldName="remind_time" fieldId="remind_time" :fieldValue="$event->remind_time" fieldRequired="true" />
                            </div>
                            <div class="col-md-4 mt-3">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <x-forms.text :fieldLabel="__('modules.events.eventLink')" fieldName="event_link" fieldId="event_link" :fieldValue="$event->event_link" :fieldPlaceholder="__('placeholders.website')" />
                    </div>
                    <div class="col-md-12 mt-3">
                        <a class="f-15 f-w-500" href="javascript:;" id="add-file"><i class="icons icon-plus font-weight-bold mr-1"></i>@lang('modules.events.uploadFile')</a>
                    </div>
                    <div class="col-md-12 d-none" id="event-file">
                        <x-forms.file-multiple class="mr-0" :fieldLabel="__('app.menu.addFile')" fieldName="file" fieldId="file-upload-dropzone" />

                        <div class="w-100 justify-content-end d-flex mt-2">
                            <button id="cancel-file" type="button" class="btn btn-secondary border-grey rounded f-14">@lang('app.cancel')</button>
                        </div>
                    </div>
                    <div class="col-sm-12">
                                    ...
                                    <x-slot name="action">
                                        <div class="dropdown ml-auto file-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0" aria-labelledby="dropdownMenuLink" tabindex="0">
                                                ...
                                                @endif
                                                <a class="cursor-pointer d-block text-dark-grey f-13 py-3 px-3 " href="{{ route('event-files.download', md5($file->id)) }}">@lang('app.download')</a>
