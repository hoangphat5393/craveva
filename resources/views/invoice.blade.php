        ...
        <section class="bg-additional-grey" id="fullscreen">
            ...
            <div class="container content-wrapper">
                ...
                <div class="border-0 card invoice">
                        ...
                        <div class="invoice-table-wrapper">
                            <table width="100%" class="___class_+?14___">
                                <tr class="inv-logo-heading">
                                    <td><img src="{{ $company->invoiceSetting->logo_url }}" alt="{{ $company->company_name }}" id="logo" /></td>
                                ...
                                <tr class="inv-unpaid">
                                    ...
                                    <td align="right" class="mt-4 mt-lg-0 mt-md-0">
                                        @if ($invoice->clientDetails->company_logo)
                                            ...
                                            <br><br><br>
                                        @endif
                                        <span class="unpaid {{ $invoice->status == 'partial' ? 'text-primary border-primary' : '' }} {{ $invoice->status == 'paid' ? 'text-success border-success' : '' }} rounded f-15 ">@lang('modules.invoices.' . $invoice->status)</span>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <!-- CARD BODY END -->
                    <!-- CARD FOOTER START -->
                    <div class="py-0 mb-4 bg-white border-0 card-footer d-flex justify-content-end py-lg-4 py-md-4 mb-lg-3 mb-md-3 ">
                        ...
                        <div class="d-flex">
                            ...
                            @if ($invoice->status == 'paid' && $invoice->file != null)
                                <x-forms.link-secondary icon="download" :link="route('front.invoice_download', [md5($invoice->id), 'download-uploaded' => 'true'])" class="mr-3">
                            ...
                            @if ($invoice->total > 0 && $invoice->status != 'paid' && $invoice->status != 'pending-confirmation' && $credentials->show_pay)
                                <div class="mr-3 inv-action mr-lg-3 mr-md-3 dropup">
                                    ...
                                    <button class="dropdown-toggle btn-secondary" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" tabindex="0">
                                        @if ($credentials->paypal_status == 'active')
                                            <li>
                                                <a class="dropdown-item f-14 text-dark" href="{{ route('paypal_public', [$invoice->id]) }}">
