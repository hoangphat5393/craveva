    ...
    @if (user()->is_superadmin)
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 ">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2 field" :fieldLabel="__('modules.emailSettings.mailFrom')" fieldRequired="true"
                    :fieldPlaceholder="__('placeholders.name')" fieldName="mail_from_name" fieldId="mail_from_name" :fieldValue="$smtpSetting->mail_from_name" />
            </div>

            <div class="col-lg-6 col-md-6 ">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2 field" :fieldLabel="__('modules.emailSettings.mailFromEmail')" fieldRequired="true"
                    :fieldPlaceholder="__('placeholders.email')" fieldName="mail_from_email" fieldId="mail_from_email" :fieldValue="$smtpSetting->mail_from_email" />
            </div>

            <div class="col-lg-6 col-md-6 ">
                <x-forms.select fieldId="mail_connection" :fieldLabel="__('modules.emailSettings.mailConnection')" fieldName="mail_connection"
                    :popover="__('modules.emailSettings.mailConnectionInfo')">
            ...
            <div class="col-lg-6 col-md-6 form-group my-3">
                ...
                <div class="d-flex">
                    <x-forms.radio fieldId="mail_driver-mail" fieldLabel="Mail" fieldName="mail_driver"
                        fieldValue="mail" checked="true" :checked="$smtpSetting->mail_driver == 'mail' ? 'checked' : ''">
                    </x-forms.radio>
                    <x-forms.radio fieldId="mail_driver-smtp" fieldLabel="SMTP" fieldValue="smtp"
                        fieldName="mail_driver" :checked="$smtpSetting->mail_driver == 'smtp' ? 'checked' : ''">
                    </x-forms.radio>
                </div>
            ...
            <div class="col-lg-12 col-md-6 smtp_div">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2 field" :fieldLabel="__('modules.emailSettings.mailHost')" fieldRequired="true"
            ...
            <div class="col-lg-6 col-md-6 smtp_div">
                <x-forms.text :fieldLabel="__('modules.emailSettings.mailPort')" fieldRequired="true" class="field" fieldName="mail_port"
                    fieldId="mail_port" :fieldValue="$smtpSetting->mail_port" />
            </div>

            <div class="col-lg-6 col-md-6 smtp_div">
                <x-forms.select fieldId="mail_encryption" :fieldLabel="__('modules.emailSettings.mailEncryption')" fieldName="mail_encryption">
            ...
            <div class="col-lg-6 col-md-6 smtp_div">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2 field" :fieldLabel="__('modules.emailSettings.mailUsername')" fieldRequired="true"
                    :fieldPlaceholder="__('placeholders.email')" fieldName="mail_username" fieldId="mail_username" :fieldValue="$smtpSetting->mail_username" />
            </div>

            <div class="col-lg-6 col-md-6 smtp_div">
                <x-forms.label class="mt-3" fieldId="mail_password" :fieldLabel="__('modules.emailSettings.mailPassword')" />
                <x-forms.input-group>
                    <input type="password" name="mail_password" id="mail_password"
                        value="{{ $smtpSetting->mail_password }}" placeholder="@lang('modules.emailSettings.mailPassword')"
            ...
            @if (isCraveva())
                <div class="col-lg-6 col-md-6 smtp_div">
                    <x-forms.select fieldId="email_verified" :fieldLabel="__('modules.emailSettings.emailVerified')" fieldName="email_verified"
                        fieldRequired="true" :popover="__('modules.emailSettings.emailVerifiedInfo')">
...
@if (!user()->is_superadmin)
    <div class="col-xl-4 col-lg-12 col-md-12 ntfcn-tab-content-right border-left-grey p-4">
        ...
        <div class="mb-3 d-flex">
            ...
            <x-forms.checkbox :checked="$checkedAll == true" :fieldLabel="__('modules.permission.selectAll')" fieldName="select_all_checkbox" fieldId="select_all"
                fieldValue="all" />
        </div>
        @foreach ($emailSettings as $emailSetting)
            <div class="mb-3 d-flex notification">
                <x-forms.checkbox :checked="$emailSetting->send_email == 'yes'" :fieldLabel="__('modules.emailNotification.' . str_slug($emailSetting->setting_name))" fieldName="send_email[]" :fieldId="'send_email_' . $emailSetting->id"
