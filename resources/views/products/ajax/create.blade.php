                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <x-forms.text fieldId="name" :fieldLabel="__('app.name')" fieldName="name" fieldRequired="true" :fieldPlaceholder="__('placeholders.productName')">
                                </x-forms.text>
                            </div>
                            ...
                            <div class="col-12">
                                <x-forms.number class="w-100" :fieldLabel="__('Wholesale_Price.Wholesale Price')" fieldName="wholesale_price" fieldId="wholesale_price" fieldRequired="true" :fieldPlaceholder="__('Wholesale_Price.Wholesale Price')" fieldValue="0" />
                            </div>

                            <div class="col-12">
                                <x-forms.number class="w-100" :fieldLabel="__('Price_Per_Box.Price Per Box')" fieldName="price_per_box" fieldId="price_per_box" fieldRequired="true" :fieldPlaceholder="__('Price_Per_Box.Price Per Box')" fieldValue="0" />
                            </div>

                            <div class="col-12">
                                <x-forms.number class="w-100" :fieldLabel="__('Employee_Price.Employee Price')" fieldName="employee_price" fieldId="employee_price" fieldRequired="true" :fieldPlaceholder="__('Employee_Price.Employee Price')" fieldValue="0" />
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="category_id" id="product_category_ids" data-live-search="true">
                                        <option value="">--</option>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="tax[]" id="tax_id" data-live-search="true" multiple="true">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <x-forms.text fieldId="hsn_sac_code" :fieldLabel="__('app.hsnSac')" fieldName="hsn_sac_code" :fieldPlaceholder="__('placeholders.hsnSac')">
                                </x-forms.text>
                            </div>
