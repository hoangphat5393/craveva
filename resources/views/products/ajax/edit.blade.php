                ...
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.price')" fieldName="price" fieldId="price" :fieldPlaceholder="__('placeholders.price')" :fieldValue="$product->price" />
                            </div>

                            <div class="col-12">
                                <x-forms.number class="w-100" :fieldLabel="__('Wholesale_Price.Wholesale Price')" fieldName="wholesale_price" fieldId="wholesale_price" :fieldPlaceholder="__('Wholesale_Price.Wholesale Price')" :fieldValue="$product->wholesale_price" />
                            </div>

                            <div class="col-12">
                                <x-forms.number class="w-100" :fieldLabel="__('Price Per Box')" fieldName="price_per_box" fieldId="price_per_box" :fieldPlaceholder="__('Price Per Box')" :fieldValue="$product->price_per_box" />
                            </div>

                            <div class="col-12">
                                <x-forms.number class="w-100" :fieldLabel="__('Employee_Price.Employee Price')" fieldName="employee_price" fieldId="employee_price" :fieldPlaceholder="__('Employee_Price.Employee Price')" :fieldValue="$product->employee_price" />
                            </div>

                            <div class="col-md-4">
                                <x-forms.number :fieldLabel="__('app.shelfLifeDays')" fieldName="shelf_life_days" fieldId="shelf_life_days" :fieldPlaceholder="__('app.shelfLifeDays')" :fieldValue="$product->shelf_life_days ?? ''" />
                            </div>
                            ...
                            <div class="col-md-4">
                                <x-forms.text fieldId="sku" :fieldLabel="__('app.sku')" fieldName="sku" :fieldPlaceholder="__('placeholders.sku')" :fieldValue="$product->sku">
                                </x-forms.text>
                            </div>
