                        ...
                        <div class="invoice-table-wrapper">
                            ...
                            <table width="100%">
                                <tr class="inv-unpaid">
                                    <td class="f-14 text-dark">
                                        @if (
                                            $proposal->lead->contact &&
                                                ($proposal->lead->contact->client_name || $proposal->lead->contact->client_email || $proposal->lead->contact->mobile || $proposal->lead->contact->company_name || $proposal->lead->contact->address) &&
                                    ...
                                    <td align="right" class="mt-4 mt-lg-0 mt-md-0">
                                        <span class="unpaid {{ $proposal->status == 'waiting' ? 'text-warning border-warning' : '' }} {{ $proposal->status == 'accepted' ? 'text-success border-success' : '' }} rounded f-15 ">@lang('modules.estimates.' . $proposal->status)</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <table class="inv-detail f-14 table-responsive-sm" width="100%">
                                                ...
                                                <tr>
                                                    <td colspan="{{ $invoiceSetting->hsn_sac_code_show == 1 ? '4' : '3' }} " class="blank-td border-bottom-0 border-left-0 border-right-0"></td>
                    ...
                    <div class="py-0 mb-4 bg-white border-0 card-footer d-flex justify-content-end py-lg-4 py-md-4 mb-lg-3 mb-md-3 ">
                        ...
                        <div class="d-flex">
                            ...
                            @if (!$proposal->signature && $proposal->status == 'waiting')
                                <x-forms.link-secondary link="javascript:;" class="mr-3" icon="times" data-toggle="modal" data-target="#decline-modal">@lang('app.decline')
                                </x-forms.link-secondary>

                                <x-forms.link-primary link="javascript:;" icon="check" data-toggle="modal" data-target="#signature-modal">@lang('app.accept')
