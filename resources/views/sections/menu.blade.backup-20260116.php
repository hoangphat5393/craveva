<ul>
    ...
    @if ($companyMenuMode)
        <x-menu-item icon="star" :text="__('Craveva AI')" :link="'#'">
            ...
            <x-menu-item icon="cash-coin" :text="__('app.menu.finance')">
                ...
                <div class="accordionItemContent">
                    ...
                    @if (in_array('admin', array_map('strtolower', user_roles() ?? [])) && in_array('discount', user_modules()))
                        <x-sub-menu-item :link="route('discount.index')" :text="__('Discount Rules')" />
                    @endif
        ...
        @includeIf('asset::sections.sidebar')
        ...
        @includeIf('servermanager::sections.sidebar')
        @includeIf('qrcode::sections.sidebar')
        @includeIf('biolinks::sections.sidebar')
        @includeIf('biometric::sections.sidebar')
        @includeIf('webhooks::sections.sidebar')
        @includeIf('zoom::sections.sidebar')
    @endif
    ...
    @if (!$companyMenuMode)
        ...
        <!-- NAV ITEM - PRICING -->
        @if (in_array('pricing', user_modules()))
            <x-menu-item icon="tag" :text="__('pricing::app.menu.pricing')">
                <x-slot name="iconPath">
                    <path d="M6 4.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm-1 0a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0z" />
                    <path d="M2 1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 1 6.586V2a1 1 0 0 1 1-1zm0 5.586 7 7L13.586 9l-7-7H2v4.586z" />
                </x-slot>
                <div class="accordionItemContent">
                    <x-sub-menu-item :link="route('pricing.tiers.index')" :text="__('pricing::app.menu.tiers')" />
                    <x-sub-menu-item :link="route('pricing.client_tiers.index')" :text="__('pricing::app.menu.clientTiers')" />
                    <x-sub-menu-item :link="route('pricing.client_pricing.index')" :text="__('pricing::app.menu.clientPricing')" />
                    <x-sub-menu-item :link="route('pricing.import.index')" :text="__('app.importExcel')" />
                </div>
            </x-menu-item>
        @endif
