<ul>
    @php $companyMenuMode = true; @endphp

    @if ($companyMenuMode)

        {{-- AI Workspace --}}
        <x-menu-item id="ai-workspace-menu-item" icon="star" :text="__('app.menu.aiWorkspace')" :link="'javascript:void(0);'">
        ...
        {{-- Home --}}
        @if (in_array('admin', array_map('strtolower', user_roles() ?? [])) ||
            ...
            <x-menu-item icon="house" :text="__('app.menu.home')">
                <x-slot name="iconPath">
        ...
        @else
            <x-menu-item icon="house" :text="__('app.menu.home')" :link="route('dashboard')">
                <x-slot name="iconPath">
                    <path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
                    <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z" />
                </x-slot>
        ...
        @if (
            ...
            <x-menu-item icon="briefcase" :text="__('app.menu.workManagement')">
                <x-slot name="iconPath">
                    <path
                ...
                <div class="accordionItemContent">
                    ...
                    @endif
                    @if (in_array('tasks', user_modules()) || in_array('events', user_modules()) || in_array('holidays', user_modules()) || in_array('tickets', user_modules()) || in_array('leaves', user_modules()))
                        <x-sub-menu-item :link="route('my-calendar.index')" :text="__('app.menu.myCalendar')" />
                    @endif
                    ...
                    @if (in_array('messages', user_modules()))
                        <x-sub-menu-item :link="route('messages.index')" :text="__('app.menu.messages')" />
                    @endif
        ...
        @if (!in_array('client', user_roles()) && in_array('leads', user_modules()) && (($sidebarUserPermissions['view_lead'] != 5 && $sidebarUserPermissions['view_lead'] != 'none') || ($sidebarUserPermissions['view_deals'] != 5 && $sidebarUserPermissions['view_deals'] != 'none')))
            <x-menu-item icon="person" :text="__('app.menu.sales')">
                <x-slot name="iconPath">
                ...
                <div class="accordionItemContent ">
                    ...
                    @if (in_array('estimates', user_modules()) && $sidebarUserPermissions['view_estimates'] != 5 && $sidebarUserPermissions['view_estimates'] != 'none')
                        <x-sub-menu-item :link="route('estimates.index')" :text="__('app.menu.quotation')" />
                    @endif
                </div>
            </x-menu-item>
        @endif
        ...
        @if (in_array('orders', user_modules()) && $sidebarUserPermissions['view_order'] != 5 && $sidebarUserPermissions['view_order'] != 'none' && false)
        ...
        {{-- Finance --}}
        @if (
            (in_array('invoices', user_modules()) || in_array('payments', user_modules()) || in_array('expenses', user_modules()) || in_array('bankaccount', user_modules())) &&
                ($sidebarUserPermissions['view_invoices'] != 5 || $sidebarUserPermissions['view_payments'] != 5 || $sidebarUserPermissions['view_expenses'] != 5 || $sidebarUserPermissions['view_bankaccount'] != 5) &&
                ($sidebarUserPermissions['view_invoices'] != 'none' || $sidebarUserPermissions['view_payments'] != 'none' || $sidebarUserPermissions['view_expenses'] != 'none' || $sidebarUserPermissions['view_bankaccount'] != 'none'))
            <x-menu-item icon="cash-coin" :text="__('app.menu.finance')">
                <x-slot name="iconPath">
                    <path
                ...
                <div class="accordionItemContent">
                    ...
                    @endif
                    @if (in_array('admin', array_map('strtolower', user_roles() ?? [])) && in_array('discount', user_modules()))
                        <x-sub-menu-item :link="route('discount.index')" :text="__('app.menu.discountRules')" />
                    @endif
        ...
        @if (
            !in_array('client', user_roles()) &&
                ...
                ($sidebarUserPermissions['view_employees'] != 'none' || $sidebarUserPermissions['view_leave'] != 'none' || $sidebarUserPermissions['view_attendance'] != 'none' || $sidebarUserPermissions['view_holiday'] != 'none' || $sidebarUserPermissions['view_shift_roster'] != 'none'))
            <x-menu-item icon="people" :text="__('app.menu.people')">
                <x-slot name="iconPath">
                    <path
        ...
        @if (in_array('reports', user_modules()))
            <x-menu-item icon="graph-up" :text="__('app.menu.reports')">
                ...
                <div class="accordionItemContent">
                    ...
                    @endif
                    @if ($sidebarUserPermissions['view_time_log_report'] == 4 && $sidebarUserPermissions['view_time_log_report'] != 'none' && in_array('timelogs', user_modules()))
                        <x-sub-menu-item :link="route('time-log-weekly-report.index')" :text="__('app.menu.weeklyTimehsheet')" />
                    @endif
        ...
        @if ((in_array('tasks', user_modules()) || in_array('events', user_modules()) || in_array('holidays', user_modules()) || in_array('tickets', user_modules()) || in_array('leaves', user_modules())) && false)
        ...
        @if (in_array('events', user_modules()) && $sidebarUserPermissions['view_events'] != 5 && $sidebarUserPermissions['view_events'] != 'none' && false)
        ...
        @if (in_array('messages', user_modules()) && false)
            <x-menu-item class="message-menu" icon="chat-left-text" :text="__('app.menu.messages')" :link="route('messages.index')" :count="$unreadMessagesCount">
                <x-slot name="iconPath">
        ...
        @includeIf('letter::sections.sidebar')

        @if (false)
            @includeIf('policy::sections.sidebar')
        @endif

        @if (false)
            @includeIf('performance::sections.sidebar')
        @endif

        @if (false)
            @includeIf('payroll::sections.sidebar')
        @endif

        @includeIf('recruit::sections.sidebar')

        @php
            $canManageCompanySetting = isset($sidebarUserPermissions['manage_company_setting']) && $sidebarUserPermissions['manage_company_setting'] == 4;
            $isAdminRole = in_array('admin', user_roles());

            $canViewAsset = !in_array('client', user_roles()) && user()->permission('view_asset') != 'none' && in_array(\Modules\Asset\Entities\AssetSetting::MODULE_NAME, user_modules());

            $canViewPolicy = user()->permission('view_policy') != 'none' && in_array(\Modules\Policy\Entities\PolicySetting::MODULE_NAME, user_modules());

            $canViewQrCode = !in_array('client', user_roles()) && user()->permission('view_qrcode') != 'none' && in_array(\Modules\QRCode\Entities\QRCodeSetting::MODULE_NAME, user_modules());

            $canViewBiolinks = in_array(\Modules\Biolinks\Entities\BiolinksGlobalSetting::MODULE_NAME, user_modules()) && user()->permission('view_biolinks') != 'none';

            $canViewBiometric = in_array(\Modules\Biometric\Entities\BiometricGlobalSetting::MODULE_NAME, user_modules()) && user()->permission('manage_biometric_settings') != 'none';

            $canViewWebhooks = in_array(\Modules\Webhooks\Entities\WebhooksGlobalSetting::MODULE_NAME, user_modules()) && (user()->permission('view_webhooks') == 'all' || user()->permission('view_webhooks_logs') == 'all');
            ...
            $canViewServerManager = !in_array('client', user_roles()) && in_array(\Modules\ServerManager\Entities\ServerSetting::MODULE_NAME, user_modules()) && ($hostingViewPermission != 'none' || $domainViewPermission != 'none' || $providerViewPermission != 'none');

            $viewZoomPermission = user()->permission('view_zoom_meetings');
            $canViewZoom = in_array(\Modules\Zoom\Entities\ZoomSetting::MODULE_NAME, user_modules()) && in_array($viewZoomPermission, ['all', 'added', 'owned', 'both']);

            $showAdminIt = $canManageCompanySetting || $isAdminRole || $canViewAsset || $canViewPolicy || $canViewQrCode || $canViewBiolinks || $canViewBiometric || $canViewWebhooks || $canViewServerManager || $canViewZoom;
        @endphp
        ...
        @if ($showAdminIt)
            <x-menu-item icon="gear" :text="__('app.menu.adminIt')">
                <x-slot name="iconPath">
                ...
                <div class="accordionItemContent">
                    @if (false && ($canManageCompanySetting || $isAdminRole))
        ...
        @if (false && ($canManageCompanySetting || $isAdminRole))
            <x-menu-item icon="gear" :text="__('app.menu.accountSettings')" :link="$canManageCompanySetting ? route('company-settings.index') : route('profile-settings.index')">
                <x-slot name="iconPath">
                    <path d="M8 4.754a3.246 3.246 0 1 0 0 6.492 3.246 3.246 0 0 0 0-6.492zM5.754 8a2.246 2.246 0 1 1 4.492 0 2.246 2.246 0 0 1-4.492 0z" />
                    <path
                        d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52l-.094-.319z" />
        ...
        @if ((in_array('knowledgebase', user_modules()) && isset($sidebarUserPermissions['view_knowledgebase']) && $sidebarUserPermissions['view_knowledgebase'] != 5) || (isCraveva() && in_array('admin', user_roles())) || (in_array('tickets', user_modules()) && $sidebarUserPermissions['view_tickets'] != 5 && $sidebarUserPermissions['view_tickets'] != 'none'))
            <x-menu-item icon="question" :text="__('app.menu.helpSupport')">
                <x-slot name="iconPath">
                ...
                <div class="accordionItemContent">
                    @if (in_array('knowledgebase', user_modules()) && isset($sidebarUserPermissions['view_knowledgebase']) && $sidebarUserPermissions['view_knowledgebase'] != 5)
                        <x-sub-menu-item :link="route('knowledgebase.index')" :text="__('app.menu.knowledgebase')" />
                    @endif

                    @if (in_array('tickets', user_modules()) && $sidebarUserPermissions['view_tickets'] != 5 && $sidebarUserPermissions['view_tickets'] != 'none')
                        <x-sub-menu-item :link="route('tickets.index')" :text="__('app.menu.tickets')" />
                    @endif

                    @if (isCraveva() && in_array('admin', user_roles()))
                        <x-sub-menu-item :link="route('superadmin.faqs.index')" :text="__('app.menu.help')" />
                    @endif
                </div>
            </x-menu-item>
        @endif
    ...
    @if (!$companyMenuMode)
        ...
        @if (in_array('admin', user_roles()) || $sidebarUserPermissions['view_overview_dashboard'] == 4 || $sidebarUserPermissions['view_project_dashboard'] == 4 || $sidebarUserPermissions['view_client_dashboard'] == 4 || $sidebarUserPermissions['view_hr_dashboard'] == 4 || $sidebarUserPermissions['view_ticket_dashboard'] == 4 || $sidebarUserPermissions['view_finance_dashboard'] == 4)
        ...
        @if (
            (in_array('estimates', user_modules()) || in_array('invoices', user_modules()) || in_array('payments', user_modules()) || in_array('expenses', user_modules()) || in_array('bankaccount', user_modules())) &&
                ($sidebarUserPermissions['view_estimates'] != 5 || $sidebarUserPermissions['view_invoices'] != 5 || $sidebarUserPermissions['view_payments'] != 5 || $sidebarUserPermissions['view_expenses'] != 5 || $sidebarUserPermissions['view_lead_proposals'] != 5 || $sidebarUserPermissions['view_bankaccount'] != 5) &&
                ($sidebarUserPermissions['view_estimates'] != 'none' || $sidebarUserPermissions['view_invoices'] != 'none' || $sidebarUserPermissions['view_payments'] != 'none' || $sidebarUserPermissions['view_expenses'] != 'none' || $sidebarUserPermissions['view_lead_proposals'] != 'none' || $sidebarUserPermissions['view_bankaccount'] != 'none'))
        ...
        @if (!user()->is_superadmin && in_array('pricing', user_modules()))
            <x-menu-item icon="tag" :text="__('pricing::app.menu.pricing')" :active="request()->routeIs('pricing.*')">
                ...
                <div class="accordionItemContent">
                    <x-sub-menu-item :link="route('pricing.tiers.index')" :text="__('pricing::app.menu.tiers')" :active="request()->routeIs('pricing.tiers.*')" />
                    <x-sub-menu-item :link="route('pricing.client_tiers.index')" :text="__('pricing::app.menu.clientTiers')" :active="request()->routeIs('pricing.client_tiers.*')" />
                    <x-sub-menu-item :link="route('pricing.client_pricing.index')" :text="__('pricing::app.menu.contractPricing')" :active="request()->routeIs('pricing.client_pricing.*')" />
                    <x-sub-menu-item :link="route('pricing.company_pricing.index')" :text="__('pricing::app.menu.companyPricing')" :active="request()->routeIs('pricing.company_pricing.*')" />
                    <x-sub-menu-item :link="route('pricing.volume_rules.index')" :text="__('pricing::app.menu.volumeDiscounts')" :active="request()->routeIs('pricing.volume_rules.*')" />
                    <x-sub-menu-item :link="route('pricing.import.index')" :text="__('app.importExcel')" :active="request()->routeIs('pricing.import.*')" />
                </div>
            </x-menu-item>
        @endif
        ...
        @if (in_array('messages', user_modules()))
            @if ((message_setting()->allow_client_admin == 'yes' || message_setting()->allow_client_employee == 'yes') && in_array('client', user_roles()))
                <x-menu-item class="message-menu" icon="chat-left-text" :text="__('app.menu.messages')" :count="$unreadMessagesCount" :link="route('messages.index')">
                    <x-slot name="iconPath">
                        <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
                        <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6zm0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z" />
                    </x-slot>
        ...
        @if (in_array('reports', user_modules()) &&
                ($sidebarUserPermissions['view_task_report'] == 4 ||
                    ...
                    (isset($sidebarUserPermissions['view_expense_report']) && $sidebarUserPermissions['view_expense_report'] == 4) ||
        ...
        <!-- NAV ITEM - SETTINGS -->
        <x-menu-item icon="gear" :text="__('app.menu.settings')" :link="$sidebarUserPermissions['manage_company_setting'] == 4 ? route('company-settings.index') : route('profile-settings.index')">
            <x-slot name="iconPath">
                <path d="M8 4.754a3.246 3.246 0 1 0 0 6.492 3.246 3.246 0 0 0 0-6.492zM5.754 8a2.246 2.246 0 1 1 4.492 0 2.246 2.246 0 0 1-4.492 0z" />
                <path
        ...
        @php
            $canManageCompanySettingMobile = isset($sidebarUserPermissions['manage_company_setting']) && $sidebarUserPermissions['manage_company_setting'] == 4;
            $isAdminMobile = in_array('admin', user_roles());
            $settingsLinkMobile = $canManageCompanySettingMobile ? route('company-settings.index') : route('profile-settings.index');
        @endphp

        @if ($canManageCompanySettingMobile || $isAdminMobile)
            <div class="d-block d-lg-none d-xl-none">
                <x-menu-item icon="gear" :text="__('app.menu.settings')" :link="$settingsLinkMobile">
                    <x-slot name="iconPath">
                        <path d="M8 4.754a3.246 3.246 0 1 0 0 6.492 3.246 3.246 0 0 0 0-6.492zM5.754 8a2.246 2.246 0 1 1 4.492 0 2.246 2.246 0 0 1-4.492 0z" />
                        <path
                            d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52l-.094-.319z" />
