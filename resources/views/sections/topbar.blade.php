...
<header class="main-header clearfix bg-white" id="header">
    ...
    <div class="navbar-left float-left d-flex align-items-center">
        ...
        @if (in_array('admin', user_roles()) && $checkListCompleted < $checkListTotal && isNonCraveva())
    ...
    <div class="page-header-right float-right d-flex align-items-center justify-content-end flex-nowrap">
        ...
        {{-- Quick Language Change (Additive Change) --}}
        <div class="language-dropdown dropdown mr-2">
            @php
                $activeLang = $languageSettings->where('language_code', user()->locale)->first();
            @endphp
