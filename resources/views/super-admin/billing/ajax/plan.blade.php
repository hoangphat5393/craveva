    ...
    @if (!checkCompanyPackageIsValid(user()->company_id))
        <div class="d-lg-flex justify-content-between">
            ...
            <div class="align-self-center ml-3 mb-3" id="manageEmployee">
                <a href="{{ route('employees.index') }}" class="btn btn-sm btn-primary rounded f-12 px-2 py-1" id="manageEmployees">
        ...
        <div class="card-body">
            <div class="d-lg-flex justify-content-between">
                <div class="align-self-center">
                    ...
                    <h3 class="heading-h3 mt-2 text-primary">{{ $company->package->name }} @if ($company->package->default != 'trial' && $company->package->default != 'lifetime')
                            @lang('superadmin.' . $company->package_type)
                        @endif
                    </h3>
