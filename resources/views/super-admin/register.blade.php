    ...
    <form id="login-form" action="{{ route('login') }}" class="ajax-form" method="POST">
        ...
        @else
            ...
            <div class="form-group text-left">
                ...
                <input type="text" tabindex="1" name="company_name" class="form-control height-50 f-14 light_text" placeholder="@lang('placeholders.company')" id="company_name" autofocus>
            </div>
            ...
            @if (module_enabled('Subdomain'))
                <div class="form-group text-left">
                    ...
                    <div class="input-group">
                        <input type="text" tabindex="2" class="form-control height-50 f-15 light_text" placeholder="subdomain" name="sub_domain" id="sub_domain">
            ...
            <div class="form-group text-left">
                ...
                <input type="text" tabindex="3" name="name" class="form-control height-50 f-15 light_text" placeholder="@lang('placeholders.name')" id="name">
            </div>

            <div class="form-group text-left">
                <label for="email">@lang('auth.email') <sup class="f-14 mr-1">*</sup></label>
                <input tabindex="4" type="email" name="email" class="form-control height-50 f-15 light_text" placeholder="@lang('placeholders.email')" id="email">
            </div>
            ...
            @if ($globalSetting->sign_up_phone_field == 'yes')
                <div class="form-group text-left">
                    ...
                    <input tabindex="5" type="text" name="phone" class="form-control height-50 f-15 light_text" placeholder="@lang('placeholders.phone')" id="phone">
                </div>
            @endif
            ...
            <div class="form-group text-left">
                ...
                <x-forms.input-group>
                    <input type="password" name="password" id="password" placeholder="@lang('placeholders.password')" tabindex="{{ $globalSetting->sign_up_phone_field == 'yes' ? '6' : '5' }}" class="form-control height-50 f-15 light_text">
                    <x-slot name="append">
                        <button type="button" tabindex="{{ $globalSetting->sign_up_phone_field == 'yes' ? '7' : '6' }}" data-toggle="tooltip" data-original-title="@lang('app.viewPassword')" class="btn btn-outline-secondary border-grey height-50 toggle-password">
            ...
            @if ($globalSetting->sign_up_terms == 'yes')
                <div class="form-group text-left">
                    ...
                    <label for="read_agreement">@lang('superadmin.superadmin.acceptTerms') <a href="{{ $globalSetting->terms_link }}" target="_blank" id="terms_link">@lang('superadmin.superadmin.termsAndCondition')</a></label>
                </div>
            @endif

            <button type="button" id="submit-register" class="btn-primary f-w-500 rounded w-100 height-50 f-18">
                @lang('app.signUp') <i class="fa fa-arrow-right pl-1"></i>
            </button>


            <a href="{{ route('login') }}" class="btn-secondary f-w-500 rounded w-100 height-50 f-15 mt-3">
                @lang('app.login')
            </a>
