<ul>
    @if (user()->is_superadmin)
        ...
        @if ($sidebarSuperadminPermissions['manage_superadmin_front_settings'] != 5 && $sidebarSuperadminPermissions['manage_superadmin_front_settings'] != 'none')
            <x-menu-item icon="front" :text="__('superadmin.menu.frontendSettings')" :link="route('superadmin.front-settings.front_theme_settings')">
                <x-slot name="iconPath">
        ...
        <x-menu-item icon="front" :text="__('superadmin.menu.setting')" :link="user()->permission('manage_superadmin_app_settings') == 'all' ? route('app-settings.index') : route('superadmin.settings.super-admin-profile.index')">
