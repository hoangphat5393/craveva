    ...
    <div class="modal-body">
        <div class="portlet-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <x-forms.text :fieldLabel="__('app.name')" fieldName="column_name" fieldId="column_name" fieldRequired="true"/>
                </div>
                ...
                <div class="col-sm-6">
                    <div id="colorpicker" class="input-group">
                        <div class="form-group my-3 text-left">
                            ...
                            <x-forms.input-group>
                                <input type="text" name="label_color" id="statusColorSelector" value="#16813D"
