                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link f-15 active general"
                               href="{{ route('task-settings.index') }}" role="tab"
                               aria-controls="nav-general" aria-selected="true">@lang($pageTitle)
                            </a>

                            <a class="nav-item nav-link f-15 status"
                               href="{{ route('task-settings.index') }}?tab=status" role="tab"
                               aria-controls="nav-status"
                               aria-selected="true">@lang('app.status')
                            </a>
                        </div>
                    </nav>
                </div>
