    ...
    <x-filters.filter-box>
        ...
        <x-filters.more-filter-box>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="assignedTo" id="assignedTo" data-live-search="true"
                                data-size="10">
                            <option value="all">@lang('app.all')</option>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" name="billable_task" id="billable_task" data-live-search="true" data-container="body" data-size="10">
                            <option value="all">@lang('app.all')</option>
...
@push('scripts')
    ...
    <script>
        ...
        var getEventDetail = function(id) {
            ...
            $(RIGHT_MODAL).find('.is-invalid').removeClass('is-invalid');
            $(RIGHT_MODAL).find('.invalid-feedback').remove();
            $(RIGHT_MODAL).find('#alert').html('');
            historyPush(url);
