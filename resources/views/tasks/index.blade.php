...
@php
    ...
    $customFieldGroups = $taskModel->getCustomFieldGroupsWithFields();
    $customFields = $customFieldGroups ? $customFieldGroups->fields : collect([]);
@endphp
    ...
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status">
                <select class="form-control select-picker" name="status" id="status" data-live-search="true" data-size="10">
                    ...
                    @foreach ($taskBoardStatus as $status)
                        <option value="{{ $status->id }}">
                            {{ $status->slug == 'completed' || $status->slug == 'incomplete' ? __('app.' . $status->slug) : $status->column_name }}
                        </option>
                    @endforeach
                </select>
            </div>
        ...
        <x-filters.more-filter-box>
                ...
                <div class="more-filter-items">
                    ...
                    <div class="select-filter mb-4">
                        <div class="select-others">
                            <select class="form-control select-picker" name="project_id_filter" id="project_id_filter" data-live-search="true" data-container="body" data-size="10">
                                <option value="all">@lang('app.all')</option>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="clientID" data-live-search="true" data-container="body" data-size="10">
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="assignedTo" data-live-search="true" data-container="body" data-size="10">
                            <option value="all">@lang('app.all')</option>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="assignedBY" data-live-search="true" data-container="body" data-size="10">
                            <option value="all">@lang('app.all')</option>
                            @foreach ($employees as $employee)
                                <x-user-option :user="$employee" />
                            @endforeach
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="label" data-live-search="true" data-container="body" data-size="10">
                            <option value="all">@lang('app.all')</option>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="priority" data-live-search="true" data-container="body" data-size="10">
                            <option value="all">@lang('app.all')</option>
                            <option data-content="<i class='fa fa-circle mr-2' style='color: #dd0000'></i> @lang('modules.tasks.high')" value="high">@lang('modules.tasks.high')</option>
                            <option value="medium" data-content="<i class='fa fa-circle mr-2' style='color: #ffc202'></i> @lang('modules.tasks.medium')">
                                @lang('modules.tasks.medium')</option>
                            <option data-content="<i class='fa fa-circle mr-2' style='color: #0a8a1f'></i> @lang('modules.tasks.low')" value="low">@lang('modules.tasks.low')</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 " for="usr">@lang('modules.taskCategory.taskCategory')</label>
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="category_id" data-live-search="true" data-container="body" data-size="10">
                            <option value="all">@lang('app.all')</option>
            ...
            <div class="more-filter-items">
                ...
                <div class="select-filter mb-4">
                    <div class="select-others">
                        <select class="form-control select-picker" id="billable_task" data-live-search="true" data-container="body" data-size="10">
                            <option value="all">@lang('app.all')</option>
            ...
            @if (in_array('projects', user_modules()))
                <div class="more-filter-items">
                    ...
                    <div class="select-filter mb-4">
                        <div class="select-others">
                            <select class="form-control select-picker" id="milestone_id" data-live-search="true" data-container="body" data-size="10">
                                <option value="all">@lang('app.all')</option>
                                @foreach ($milestones as $milestone)
                                    <option value="{{ $milestone->id }}">
                                        {{ $milestone->milestone_title . ($milestone->project->project_short_code ? ' (' . $milestone->project->project_short_code . ')' : '') }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
            ...
            @foreach ($customFields as $field)
                <div class="more-filter-items">
                    <label class="f-14 text-dark-grey mb-12 " for="custom_field_{{ $field->id }}">{{ $field->label }}</label>
                    <div class="select-filter mb-4">
                        <div class="select-others">
                            @if ($field->type == 'text' || $field->type == 'password' || $field->type == 'number' || $field->type == 'readonly')
                                <input type="text" class="form-control custom-filter" name="custom_fields_data[{{ $field->name }}_{{ $field->id }}]" id="custom_field_{{ $field->id }}" placeholder="{{ $field->label }}">
                            @elseif ($field->type == 'select' || $field->type == 'radio')
                                <select class="form-control select-picker custom-filter" name="custom_fields_data[{{ $field->name }}_{{ $field->id }}]" id="custom_field_{{ $field->id }}" data-live-search="true" data-container="body" data-size="10">
                                    <option value="all">@lang('app.all')</option>
                            ...
                            @elseif ($field->type == 'date')
                                <input type="text" class="form-control custom-date-filter date-picker" name="custom_fields_data[{{ $field->name }}_{{ $field->id }}]" id="custom_field_{{ $field->id }}" placeholder="@lang('placeholders.date')">
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                @if ($recurringTaskPermission == 'all')
                    <x-forms.link-secondary :link="route('recurring-task.index')" class="mr-3 float-left" icon="sync">
                        @lang('app.menu.taskRecurring')
                    </x-forms.link-secondary>
                @endif

                @if ($viewPermission == 'all')
                    <div class="select-status mr-3 float-left">
                        <select class="form-control select-picker" id="quick_assigned_to" data-live-search="true" data-container="body" data-size="10">
                            <option value="all">@lang('app.all')</option>
                            @foreach ($employees as $employee)
            ...
            <x-datatable.actions>
                <div class="select-status mr-3 pl-lg-3">
                    <select name="action_type" class="form-control select-picker border border-secondary" id="quick-action-type" disabled>
                ...
                <div class="select-status mr-3 d-none quick-action-field" id="change-status-action">
                    <select name="status" class="form-control select-picker border border-secondary">
                        @foreach ($taskBoardStatus as $status)
                            <option value="{{ $status->id }}">
                                {{ $status->slug == 'completed' || $status->slug == 'incomplete' ? __('app.' . $status->slug) : $status->column_name }}
                            </option>
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="{{ route('tasks.index') }}" class="btn btn-secondary f-14 btn-active task" data-toggle="tooltip" data-original-title="@lang('app.menu.tasks')"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="{{ route('taskboards.index') }}" class="btn btn-secondary f-14" data-toggle="tooltip" data-original-title="@lang('modules.tasks.taskBoard')"><i class="side-icon bi bi-kanban"></i></a>

                <a href="{{ route('task-calendar.index') }}" class="btn btn-secondary f-14" data-toggle="tooltip" data-original-title="@lang('app.menu.calendar')"><i class="side-icon bi bi-calendar"></i></a>

                <a href="javascript:;" class="btn btn-secondary f-14 show-pinned" data-toggle="tooltip" data-original-title="@lang('app.pinned')"><i class="side-icon bi bi-pin-angle"></i></a>

                @if (in_array('admin', user_roles()) || in_array('employee', user_roles()))
                    <a href="{{ route('tasks.waiting-approval') }}" class="btn btn-secondary f-14 show-waiting-approval-task" data-toggle="tooltip" data-original-title="@lang('app.menu.waiting-approval')">
                        <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#000000" width="18" height="18">
                            ...
                            <g id="SVGRepo_iconCarrier">
                                ...
                                <path
                                    ...
                                    class="warning" fill="#ff7800"></path>
                            </g>
                        </svg>
                        @if ($waitingApprovalCount > 0)
                            <span class="badge badge-pill badge-danger position-absolute">{{ $waitingApprovalCount }}</span>
                        @endif
                    </a>
                @endif
            </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(() => {
            ...
            if ($('#quick_assigned_to').length) {
                $('#quick_assigned_to').val($('.filter-box #assignedTo').val());
                $('#quick_assigned_to').selectpicker('refresh');
            }
        });
        ...
        $('#allTasks-table').on('preXhr.dt', function(e, settings, data) {
            ...
            $('.custom-filter').each(function() {
                if ($(this).val() != '' && $(this).val() != 'all') {
                    customFields[$(this).attr('id').replace('custom_field_', '')] = $(this).val();
                }
            });
            $('.custom-date-filter').each(function() {
                if ($(this).val() != '') {
                    customFields[$(this).attr('id').replace('custom_field_', '')] = $(this).val();
                }
            });
        ...
        $('#project_id_filter, #clientID, #assignedBY, #assignedTo, #status, #label, #category_id, #billable_task, #milestone_id, #priority, #date_filter_on, #pinned, .custom-filter, .custom-date-filter').on('change keyup',
            function() {
                if ($('#project_id_filter').val() != "all") {
                    ...
                    $('#reset-filters').removeClass('d-none');
                    showTable();
                } else if ($('#status').val() != "not finished") {
                    $('#reset-filters').removeClass('d-none');
                    showTable();
                    ...
                    var customFieldsActive = false;
                    $('.custom-filter').each(function() {
                        if ($(this).val() != '' && $(this).val() != 'all') {
                            customFieldsActive = true;
                        }
                    });
                    $('.custom-date-filter').each(function() {
                        if ($(this).val() != '') {
        ...
        (function() {
            ...
            $('#search-text-field').on('keypress', function(e) {
                if (e.which === 13) {
                    clearTimeout(t);
                    trigger();
                }
        ...
        $('#reset-filters,#reset-filters-2').click(function() {
            ...
            $('.custom-filter').val('all');
            $('.custom-date-filter').val('');
            $('.custom-filter').selectpicker('refresh');
            if ($('#quick_assigned_to').length) {
                $('#quick_assigned_to').val('all');
                $('#quick_assigned_to').selectpicker('refresh');
            }
            $('#reset-filters').addClass('d-none');
            showTable();
        ...
        $('#allTasks-table').on('change', '.change-status', function() {
            ...
            var roles = @json(user()->roles); // Parse JSON string to JavaScript object
        ...
        $('#quick_assigned_to').on('change', function() {
            $('.filter-box #assignedTo').val($(this).val());
            $('.filter-box .select-picker').selectpicker('refresh');
            $('#reset-filters').removeClass('d-none');
            showTable();
        });
        ...
        $('#assignedTo').on('change', function() {
            if ($('#quick_assigned_to').length) {
                $('#quick_assigned_to').val($(this).val());
                $('#quick_assigned_to').selectpicker('refresh');
            }
        });
