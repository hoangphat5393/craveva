...
<html>
<head>
    <title>Craveva - Not installed</title>
...
if (file_exists(storage_path('installed'))) {
    print view('vendor.craveva.db_error')->render();
    exit();
}
...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-center mb-8">
            <img src="{{ asset('img/craveva-logo.png') }}" class="h-12 hover:scale-105 transition-transform duration-300" alt="Home"/>
        </div>
