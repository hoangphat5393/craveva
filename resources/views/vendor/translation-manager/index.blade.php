    ...
    <div class="container-fluid">
        ...
        <fieldset>
            ...
            @if (!\Illuminate\Support\Facades\File::exists(base_path() . '/resources/lang/en'))
                <form class="form-create-en-locale" method="POST" action="{{ route('language_settings.create_en_locale') }}" data-remote="true" role="form" data-confirm="Are you sure you want to create en locale?">
                    <div class="form-group">
                        @csrf
