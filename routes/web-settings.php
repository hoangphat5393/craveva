...
Route::group(['middleware' => 'auth', 'prefix' => 'account/settings'], function () {
    ...
    Route::post('custom-fields/order', [CustomFieldController::class, 'changeOrder'])->name('custom-fields.order');
    Route::post('custom-fields/update-label/{id}', [CustomFieldController::class, 'ajaxUpdateLabel'])->name('custom-fields.ajax_update_label');
    ...
    // Task Settings
    Route::resource('task-settings', TaskSettingController::class);
    Route::post('task-settings/store-status', [TaskSettingController::class, 'storeStatus'])->name('task-settings.storeStatus');
    Route::post('task-settings/status-update/{id}', [TaskSettingController::class, 'statusUpdate'])->name('task-settings.statusUpdate');
    Route::post('task-settings/set-default/{id}', [TaskSettingController::class, 'setDefault'])->name('task-settings.setDefault');
    Route::delete('task-settings/destroy-status/{id}', [TaskSettingController::class, 'destroyStatus'])->name('task-settings.destroyStatus');
