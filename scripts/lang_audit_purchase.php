 ...
 *   php scripts/lang_audit_purchase.php                    # report only
 *   php scripts/lang_audit_purchase.php --apply            # apply glossary replacements (vi + en)
 *   php scripts/lang_audit_purchase.php --apply --locale=vi
 *   php scripts/lang_audit_purchase.php --csv=out/report.csv
 *   php scripts/lang_audit_purchase.php --patterns-only    # scan bad_patterns regex only
 *
 * Workflow (also wrapped by scripts/lang_purchase_erp.ps1):
 *   1. php scripts/lang_audit_purchase.php --apply
 ...
 *
 * Glossary: docs/GLOSSARY_PURCHASE_ERP_VI.json
 */
...
if (isset($options['help'])) {
    echo <<<'HELP'
lang_audit_purchase.php — LanguagePack Purchase ERP wording
...
$glossaryPath = $options['glossary'] ?? $projectRoot.'/docs/GLOSSARY_'.strtoupper($module).'_ERP_VI.json';
