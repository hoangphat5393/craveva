...
#
# From project root:
#   powershell -ExecutionPolicy Bypass -File scripts/lang_purchase_erp.ps1
#   powershell -ExecutionPolicy Bypass -File scripts/lang_purchase_erp.ps1 -Apply -Publish
#   powershell -ExecutionPolicy Bypass -File scripts/lang_purchase_erp.ps1 -Apply -SyncKeys -Publish
#
# Glossary: docs/GLOSSARY_PURCHASE_ERP_VI.json
# Audit script: scripts/lang_audit_purchase.php
#
...
php (Join-Path $repoRoot 'scripts/lang_audit_purchase.php') @auditArgs
