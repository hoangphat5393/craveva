...
#
#   ./scripts/lang_purchase_erp.sh
#   ./scripts/lang_purchase_erp.sh --apply --publish
#   ./scripts/lang_purchase_erp.sh --apply --sync-keys --publish
#
set -euo pipefail
...
php scripts/lang_audit_purchase.php "${ARGS[@]}"
