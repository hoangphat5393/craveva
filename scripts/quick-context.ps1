...
if ($BiomixingOnly) {
    Show-FileQuick -Path "PROJECT BIOMIXING/BIOMIXING_PRODUCTION_IMPLEMENTATION_PLAYBOOK_PHASE0_1_VI.md" -Head 120
...
Show-FileQuick -Path "FUNC_TEST/01_BIOMIXING_PROPOSAL_TEST_CASE_MATRIX_VI.md" -Head 160
Show-FileQuick -Path "FUNC_IMPROVE/10_UX_UI_IMPROVEMENT_BACKLOG.md" -Head 120
Show-FileQuick -Path "PROJECT BIOMIXING/BIOMIXING_PRODUCTION_IMPLEMENTATION_PLAYBOOK_PHASE0_1_VI.md" -Head 80
