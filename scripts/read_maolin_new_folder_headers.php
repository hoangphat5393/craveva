...
/**
 * Read row1 headers from PROJECT MAOLIN New/*.xlsx (first 5 rows only).
 * Run: php scripts/read_maolin_new_folder_headers.php
 */
...
foreach ($files as $path) {
    ...
    try {
        ...
        if (!$any) {
            echo "  (row 1 empty — may be title sheet; use peek script)\n";
        }
        echo "\n";
    } catch (Throwable $e) {
