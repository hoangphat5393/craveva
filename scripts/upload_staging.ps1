...
# 2. Define files and directories to copy (Synced with Hub)
$FilesToCopy = @(
...
# exit 0
Write-Host "Uploading zip package to staging directory (~/$ZipFile)..."
scp $ZipFile "${StagingHost}:deploy_staging.zip"
